...
{
    /// <summary>
    /// GetListedAssetsBodyInputV2
    /// </summary>
    public partial class GetListedAssetsBodyInputV2 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetListedAssetsBodyInputV2" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public GetListedAssetsBodyInputV2(Option<List<string>?> assetAddresses = default, Option<decimal?> chainId = default, Option<string?> continuation = default, Option<int?> limit = default, Option<SortByEnum?> sortBy = default, Option<SortDirectionEnum?> sortDirection = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetListedAssetsBodyInputV2 {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="GetListedAssetsBodyInputV2" />
    /// </summary>
    public class GetListedAssetsBodyInputV2JsonConverter : JsonConverter<GetListedAssetsBodyInputV2>
    {
        /// <summary>
        /// Deserializes json to <see cref="GetListedAssetsBodyInputV2" />
        /// </summary>
        ...
        public override GetListedAssetsBodyInputV2 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<GetListedAssetsBodyInputV2.SortByEnum?> sortBy = default;
            Option<GetListedAssetsBodyInputV2.SortDirectionEnum?> sortDirection = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "sortBy":
                            ...
                            if (sortByRawValue != null)
                                sortBy = new Option<GetListedAssetsBodyInputV2.SortByEnum?>(GetListedAssetsBodyInputV2.SortByEnumFromStringOrDefault(sortByRawValue));
                            break;
                        case "sortDirection":
                            string? sortDirectionRawValue = utf8JsonReader.GetString();
                            if (sortDirectionRawValue != null)
                                sortDirection = new Option<GetListedAssetsBodyInputV2.SortDirectionEnum?>(GetListedAssetsBodyInputV2.SortDirectionEnumFromStringOrDefault(sortDirectionRawValue));
                            break;
                        default:
                            break;
                    }
            ...
            if (chainId.IsSet && chainId.Value == null)
                throw new ArgumentNullException(nameof(chainId), "Property is not nullable for class GetListedAssetsBodyInputV2.");

            if (limit.IsSet && limit.Value == null)
                throw new ArgumentNullException(nameof(limit), "Property is not nullable for class GetListedAssetsBodyInputV2.");

            if (sortBy.IsSet && sortBy.Value == null)
                throw new ArgumentNullException(nameof(sortBy), "Property is not nullable for class GetListedAssetsBodyInputV2.");

            if (sortDirection.IsSet && sortDirection.Value == null)
                throw new ArgumentNullException(nameof(sortDirection), "Property is not nullable for class GetListedAssetsBodyInputV2.");

            return new GetListedAssetsBodyInputV2(assetAddresses, chainId, continuation, limit, sortBy, sortDirection);
        }

        /// <summary>
        /// Serializes a <see cref="GetListedAssetsBodyInputV2" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getListedAssetsBodyInputV2"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GetListedAssetsBodyInputV2 getListedAssetsBodyInputV2, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(ref writer, getListedAssetsBodyInputV2, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GetListedAssetsBodyInputV2" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getListedAssetsBodyInputV2"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(ref Utf8JsonWriter writer, GetListedAssetsBodyInputV2 getListedAssetsBodyInputV2, JsonSerializerOptions jsonSerializerOptions)
        {
            if (getListedAssetsBodyInputV2.AssetAddressesOption.IsSet)
                if (getListedAssetsBodyInputV2.AssetAddressesOption.Value != null)
                {
                    writer.WritePropertyName("assetAddresses");
                    JsonSerializer.Serialize(writer, getListedAssetsBodyInputV2.AssetAddresses, jsonSerializerOptions);
                }
                else
                    writer.WriteNull("assetAddresses");
            if (getListedAssetsBodyInputV2.ChainIdOption.IsSet)
                writer.WriteNumber("chainId", getListedAssetsBodyInputV2.ChainIdOption.Value!.Value);

            if (getListedAssetsBodyInputV2.ContinuationOption.IsSet)
                if (getListedAssetsBodyInputV2.ContinuationOption.Value != null)
                    writer.WriteString("continuation", getListedAssetsBodyInputV2.Continuation);
                else
                    writer.WriteNull("continuation");

            if (getListedAssetsBodyInputV2.LimitOption.IsSet)
                writer.WriteNumber("limit", getListedAssetsBodyInputV2.LimitOption.Value!.Value);

            var sortByRawValue = GetListedAssetsBodyInputV2.SortByEnumToJsonValue(getListedAssetsBodyInputV2.SortByOption.Value!.Value);
            writer.WriteString("sortBy", sortByRawValue);
            var sortDirectionRawValue = GetListedAssetsBodyInputV2.SortDirectionEnumToJsonValue(getListedAssetsBodyInputV2.SortDirectionOption.Value!.Value);
