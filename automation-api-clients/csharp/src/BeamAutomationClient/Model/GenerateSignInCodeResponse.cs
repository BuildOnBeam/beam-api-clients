...
namespace BeamAutomationClient.Model
{
    ...
    /// </summary>
    public partial class GenerateSignInCodeResponse : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public GenerateSignInCodeResponse(string challenge)
        {
            Challenge = challenge;
            OnCreated();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="GenerateSignInCodeResponse" />
    /// </summary>
    public class GenerateSignInCodeResponseJsonConverter : JsonConverter<GenerateSignInCodeResponse>
    {
        /// <summary>
        /// Deserializes json to <see cref="GenerateSignInCodeResponse" />
        /// </summary>
        ...
        public override GenerateSignInCodeResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
        ...
        /// <summary>
        /// Serializes a <see cref="GenerateSignInCodeResponse" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="generateSignInCodeResponse"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GenerateSignInCodeResponse generateSignInCodeResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(ref writer, generateSignInCodeResponse, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GenerateSignInCodeResponse" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="generateSignInCodeResponse"></param>
        /// <param name="jsonSerializerOptions"></param>
