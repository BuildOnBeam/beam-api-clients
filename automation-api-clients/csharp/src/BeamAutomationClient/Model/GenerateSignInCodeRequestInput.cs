...
namespace BeamAutomationClient.Model
{
    ...
    /// </summary>
    public partial class GenerateSignInCodeRequestInput : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public GenerateSignInCodeRequestInput(Option<string?> callbackUrl = default)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="GenerateSignInCodeRequestInput" />
    /// </summary>
    public class GenerateSignInCodeRequestInputJsonConverter : JsonConverter<GenerateSignInCodeRequestInput>
    {
        /// <summary>
        /// Deserializes json to <see cref="GenerateSignInCodeRequestInput" />
        /// </summary>
        ...
        public override GenerateSignInCodeRequestInput Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
        ...
        /// <summary>
        /// Serializes a <see cref="GenerateSignInCodeRequestInput" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="generateSignInCodeRequestInput"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GenerateSignInCodeRequestInput generateSignInCodeRequestInput, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(ref writer, generateSignInCodeRequestInput, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GenerateSignInCodeRequestInput" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="generateSignInCodeRequestInput"></param>
        /// <param name="jsonSerializerOptions"></param>
