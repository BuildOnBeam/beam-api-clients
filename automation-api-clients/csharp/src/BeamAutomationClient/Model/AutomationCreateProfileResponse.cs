...
namespace BeamAutomationClient.Model
{
    ...
    public partial class AutomationCreateProfileResponse : IValidatableObject
    {
        ...
        [JsonConstructor]
        public AutomationCreateProfileResponse(DateTime createdAt, string externalEntityId, string externalId, string gameId, string id, DateTime updatedAt, List<AutomationCreateProfileResponseWalletsInner> wallets, Option<DateTime?> userConnectionCreatedAt = default, string? userId = default)
        {
            CreatedAt = createdAt;
    ...
    public class AutomationCreateProfileResponseJsonConverter : JsonConverter<AutomationCreateProfileResponse>
    {
        ...
        public override AutomationCreateProfileResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new AutomationCreateProfileResponse(createdAt.Value!.Value!, externalEntityId.Value!, externalId.Value!, gameId.Value!, id.Value!, updatedAt.Value!.Value!, wallets.Value!, userConnectionCreatedAt, userId.Value!);
        }
        ...
        public override void Write(Utf8JsonWriter writer, AutomationCreateProfileResponse automationCreateProfileResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(ref writer, automationCreateProfileResponse, jsonSerializerOptions);
        ...
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(ref Utf8JsonWriter writer, AutomationCreateProfileResponse automationCreateProfileResponse, JsonSerializerOptions jsonSerializerOptions)
        {
