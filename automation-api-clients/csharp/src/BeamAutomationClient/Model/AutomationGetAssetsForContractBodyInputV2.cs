...
namespace BeamAutomationClient.Model
{
    ...
    public class AutomationGetAssetsForContractBodyInputV2JsonConverter : JsonConverter<AutomationGetAssetsForContractBodyInputV2>
    {
        ...
        public override AutomationGetAssetsForContractBodyInputV2 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new AutomationGetAssetsForContractBodyInputV2(attributes, chainId, continuation, includeAttributes, limit, maxFloorAskPrice, maxRarityRank, minFloorAskPrice, minRarityRank, sortBy, sortDirection);
        }
        ...
        public override void Write(Utf8JsonWriter writer, AutomationGetAssetsForContractBodyInputV2 automationGetAssetsForContractBodyInputV2, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(ref writer, automationGetAssetsForContractBodyInputV2, jsonSerializerOptions);
        ...
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(ref Utf8JsonWriter writer, AutomationGetAssetsForContractBodyInputV2 automationGetAssetsForContractBodyInputV2, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var sortByRawValue = AutomationGetAssetsForContractBodyInputV2.SortByEnumToJsonValue(automationGetAssetsForContractBodyInputV2.SortByOption.Value!.Value);
            writer.WriteString("sortBy", sortByRawValue);
            var sortDirectionRawValue = AutomationGetAssetsForContractBodyInputV2.SortDirectionEnumToJsonValue(automationGetAssetsForContractBodyInputV2.SortDirectionOption.Value!.Value);
