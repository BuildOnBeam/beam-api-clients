...
namespace BeamAutomationClient.Model
{
    ...
    /// </summary>
    public partial class AutomationGetAssetsForContractBodyInputV2 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AutomationGetAssetsForContractBodyInputV2" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public AutomationGetAssetsForContractBodyInputV2(Option<string> continuation = default, Option<long?> chainId = default, Option<int?> minRarityRank = default, Option<int?> maxRarityRank = default, Option<decimal?> minFloorAskPrice = default, Option<decimal?> maxFloorAskPrice = default, Option<bool?> includeAttributes = default, Option<List<AutomationGetAssetsForContractBodyInputV2AttributesInner>> attributes = default, Option<SortDirectionEnum?> sortDirection = default, Option<SortByEnum?> sortBy = default, Option<decimal?> limit = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AutomationGetAssetsForContractBodyInputV2 {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="AutomationGetAssetsForContractBodyInputV2" />
    /// </summary>
    public class AutomationGetAssetsForContractBodyInputV2JsonConverter : JsonConverter<AutomationGetAssetsForContractBodyInputV2>
    {
        /// <summary>
        /// Deserializes json to <see cref="AutomationGetAssetsForContractBodyInputV2" />
        /// </summary>
        ...
        public override AutomationGetAssetsForContractBodyInputV2 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<AutomationGetAssetsForContractBodyInputV2.SortDirectionEnum?> sortDirection = default;
            Option<AutomationGetAssetsForContractBodyInputV2.SortByEnum?> sortBy = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "sortDirection":
                            ...
                            if (sortDirectionRawValue != null)
                                sortDirection = new Option<AutomationGetAssetsForContractBodyInputV2.SortDirectionEnum?>(AutomationGetAssetsForContractBodyInputV2.SortDirectionEnumFromStringOrDefault(sortDirectionRawValue));
                            break;
                        case "sortBy":
                            string sortByRawValue = utf8JsonReader.GetString();
                            if (sortByRawValue != null)
                                sortBy = new Option<AutomationGetAssetsForContractBodyInputV2.SortByEnum?>(AutomationGetAssetsForContractBodyInputV2.SortByEnumFromStringOrDefault(sortByRawValue));
                            break;
                        case "limit":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
            ...
            if (chainId.IsSet && chainId.Value == null)
                throw new ArgumentNullException(nameof(chainId), "Property is not nullable for class AutomationGetAssetsForContractBodyInputV2.");

            if (sortDirection.IsSet && sortDirection.Value == null)
                throw new ArgumentNullException(nameof(sortDirection), "Property is not nullable for class AutomationGetAssetsForContractBodyInputV2.");

            if (sortBy.IsSet && sortBy.Value == null)
                throw new ArgumentNullException(nameof(sortBy), "Property is not nullable for class AutomationGetAssetsForContractBodyInputV2.");

            if (limit.IsSet && limit.Value == null)
                throw new ArgumentNullException(nameof(limit), "Property is not nullable for class AutomationGetAssetsForContractBodyInputV2.");

            return new AutomationGetAssetsForContractBodyInputV2(continuation, chainId, minRarityRank, maxRarityRank, minFloorAskPrice, maxFloorAskPrice, includeAttributes, attributes, sortDirection, sortBy, limit);
        }

        /// <summary>
        /// Serializes a <see cref="AutomationGetAssetsForContractBodyInputV2" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="automationGetAssetsForContractBodyInputV2"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, AutomationGetAssetsForContractBodyInputV2 automationGetAssetsForContractBodyInputV2, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, automationGetAssetsForContractBodyInputV2, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="AutomationGetAssetsForContractBodyInputV2" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="automationGetAssetsForContractBodyInputV2"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, AutomationGetAssetsForContractBodyInputV2 automationGetAssetsForContractBodyInputV2, JsonSerializerOptions jsonSerializerOptions)
        {
            if (automationGetAssetsForContractBodyInputV2.ContinuationOption.IsSet)
            {
                if (automationGetAssetsForContractBodyInputV2.ContinuationOption.Value != null)
                {
                    writer.WriteString("continuation", automationGetAssetsForContractBodyInputV2.Continuation);
                }
                else
                {
            ...
            if (automationGetAssetsForContractBodyInputV2.ChainIdOption.IsSet)
            {
                writer.WriteNumber("chainId", automationGetAssetsForContractBodyInputV2.ChainIdOption.Value.Value);
            }

            if (automationGetAssetsForContractBodyInputV2.MinRarityRankOption.IsSet)
            {
                if (automationGetAssetsForContractBodyInputV2.MinRarityRankOption.Value != null)
                {
                    writer.WriteNumber("minRarityRank", automationGetAssetsForContractBodyInputV2.MinRarityRankOption.Value.Value);
                }
                else
                {
            ...
            if (automationGetAssetsForContractBodyInputV2.MaxRarityRankOption.IsSet)
            {
                if (automationGetAssetsForContractBodyInputV2.MaxRarityRankOption.Value != null)
                {
                    writer.WriteNumber("maxRarityRank", automationGetAssetsForContractBodyInputV2.MaxRarityRankOption.Value.Value);
                }
                else
                {
            ...
            if (automationGetAssetsForContractBodyInputV2.MinFloorAskPriceOption.IsSet)
            {
                if (automationGetAssetsForContractBodyInputV2.MinFloorAskPriceOption.Value != null)
                {
                    writer.WriteNumber("minFloorAskPrice", automationGetAssetsForContractBodyInputV2.MinFloorAskPriceOption.Value.Value);
                }
                else
                {
            ...
            if (automationGetAssetsForContractBodyInputV2.MaxFloorAskPriceOption.IsSet)
            {
                if (automationGetAssetsForContractBodyInputV2.MaxFloorAskPriceOption.Value != null)
                {
                    writer.WriteNumber("maxFloorAskPrice", automationGetAssetsForContractBodyInputV2.MaxFloorAskPriceOption.Value.Value);
                }
                else
                {
            ...
            if (automationGetAssetsForContractBodyInputV2.IncludeAttributesOption.IsSet)
            {
                if (automationGetAssetsForContractBodyInputV2.IncludeAttributesOption.Value != null)
                {
                    writer.WriteBoolean("includeAttributes", automationGetAssetsForContractBodyInputV2.IncludeAttributesOption.Value.Value);
                }
                else
                {
            ...
            if (automationGetAssetsForContractBodyInputV2.AttributesOption.IsSet)
                if (automationGetAssetsForContractBodyInputV2.AttributesOption.Value != null)
                {
                    writer.WritePropertyName("attributes");
                    JsonSerializer.Serialize(writer, automationGetAssetsForContractBodyInputV2.Attributes, jsonSerializerOptions);
                }
                else
                    writer.WriteNull("attributes");
            var sortDirectionRawValue = AutomationGetAssetsForContractBodyInputV2.SortDirectionEnumToJsonValue(automationGetAssetsForContractBodyInputV2.SortDirectionOption.Value);
            if (sortDirectionRawValue != null)
                writer.WriteString("sortDirection", sortDirectionRawValue);
            var sortByRawValue = AutomationGetAssetsForContractBodyInputV2.SortByEnumToJsonValue(automationGetAssetsForContractBodyInputV2.SortByOption.Value);
            if (sortByRawValue != null)
                writer.WriteString("sortBy", sortByRawValue);
            if (automationGetAssetsForContractBodyInputV2.LimitOption.IsSet)
            {
                writer.WriteNumber("limit", automationGetAssetsForContractBodyInputV2.LimitOption.Value.Value);
            }
        }
    }
}