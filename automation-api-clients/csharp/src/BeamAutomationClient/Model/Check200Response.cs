...
namespace BeamAutomationClient.Model
{
    ...
    public partial class Check200Response : IValidatableObject
    {
        ...
        [JsonConstructor]
        public Check200Response(Option<string> status = default, Option<Dictionary<string, Check200ResponseInfoValue>> info = default, Option<Dictionary<string, Check200ResponseInfoValue>> error = default, Option<Dictionary<string, Check200ResponseInfoValue>> details = default)
        {
            StatusOption = status;
            InfoOption = info;
            ErrorOption = error;
    ...
    public class Check200ResponseJsonConverter : JsonConverter<Check200Response>
    {
        ...
        public override Check200Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new Check200Response(status, info, error, details);
        }
        ...
        public override void Write(Utf8JsonWriter writer, Check200Response check200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, check200Response, jsonSerializerOptions);
        ...
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, Check200Response check200Response, JsonSerializerOptions jsonSerializerOptions)
        {
