...
namespace BeamAutomationClient.Model
{
    ...
    public partial class AutomationCommonUserActivityRequestInput : IValidatableObject
    {
        ...
        [JsonConstructor]
        public AutomationCommonUserActivityRequestInput(Option<long?> chainId = default, Option<string?> continuation = default, Option<decimal?> limit = default, Option<List<AutomationCommonUserActivityRequestInput.TypesEnum>?> types = default)
        {
