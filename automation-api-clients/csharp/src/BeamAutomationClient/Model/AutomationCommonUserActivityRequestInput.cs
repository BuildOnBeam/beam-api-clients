...
namespace BeamAutomationClient.Model
{
    ...
    public partial class AutomationCommonUserActivityRequestInput : IValidatableObject
    {
        ...
        [JsonConstructor]
        public AutomationCommonUserActivityRequestInput(Option<decimal?> limit = default, Option<List<AutomationCommonUserActivityRequestInput.TypesEnum>> types = default, Option<long?> chainId = default, Option<string> continuation = default)
        {
            LimitOption = limit;
            TypesOption = types;
    ...
    public class AutomationCommonUserActivityRequestInputJsonConverter : JsonConverter<AutomationCommonUserActivityRequestInput>
    {
        ...
        public override AutomationCommonUserActivityRequestInput Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new AutomationCommonUserActivityRequestInput(limit, types, chainId, continuation);
        }
        ...
        public override void Write(Utf8JsonWriter writer, AutomationCommonUserActivityRequestInput automationCommonUserActivityRequestInput, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, automationCommonUserActivityRequestInput, jsonSerializerOptions);
        ...
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, AutomationCommonUserActivityRequestInput automationCommonUserActivityRequestInput, JsonSerializerOptions jsonSerializerOptions)
        {
