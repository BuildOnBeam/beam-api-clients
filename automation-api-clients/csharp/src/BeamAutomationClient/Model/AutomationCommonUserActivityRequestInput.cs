...
namespace BeamAutomationClient.Model
{
    ...
    /// </summary>
    public partial class AutomationCommonUserActivityRequestInput : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AutomationCommonUserActivityRequestInput" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public AutomationCommonUserActivityRequestInput(Option<decimal?> chainId = default, Option<string?> continuation = default, Option<decimal?> limit = default, Option<List<AutomationCommonUserActivityRequestInput.TypesEnum>?> types = default)
        {
        ...
        [JsonIgnore]
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<AutomationCommonUserActivityRequestInput.TypesEnum>?> TypesOption { get; private set; }

        /// <summary>
        /// Gets or Sets Types
        /// </summary>
        [JsonPropertyName("types")]
        public List<AutomationCommonUserActivityRequestInput.TypesEnum>? Types { get { return this. TypesOption; } set { this.TypesOption = new(value); } }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AutomationCommonUserActivityRequestInput {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="AutomationCommonUserActivityRequestInput" />
    /// </summary>
    public class AutomationCommonUserActivityRequestInputJsonConverter : JsonConverter<AutomationCommonUserActivityRequestInput>
    {
        /// <summary>
        /// Deserializes json to <see cref="AutomationCommonUserActivityRequestInput" />
        /// </summary>
        ...
        public override AutomationCommonUserActivityRequestInput Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<AutomationCommonUserActivityRequestInput.TypesEnum>?> types = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "types":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                types = new Option<List<AutomationCommonUserActivityRequestInput.TypesEnum>?>(JsonSerializer.Deserialize<List<AutomationCommonUserActivityRequestInput.TypesEnum>>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        default:
                            break;
                    }
            ...
            if (chainId.IsSet && chainId.Value == null)
                throw new ArgumentNullException(nameof(chainId), "Property is not nullable for class AutomationCommonUserActivityRequestInput.");

            if (limit.IsSet && limit.Value == null)
                throw new ArgumentNullException(nameof(limit), "Property is not nullable for class AutomationCommonUserActivityRequestInput.");

            return new AutomationCommonUserActivityRequestInput(chainId, continuation, limit, types);
        }

        /// <summary>
        /// Serializes a <see cref="AutomationCommonUserActivityRequestInput" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="automationCommonUserActivityRequestInput"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, AutomationCommonUserActivityRequestInput automationCommonUserActivityRequestInput, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(ref writer, automationCommonUserActivityRequestInput, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="AutomationCommonUserActivityRequestInput" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="automationCommonUserActivityRequestInput"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(ref Utf8JsonWriter writer, AutomationCommonUserActivityRequestInput automationCommonUserActivityRequestInput, JsonSerializerOptions jsonSerializerOptions)
        {
            if (automationCommonUserActivityRequestInput.ChainIdOption.IsSet)
                writer.WriteNumber("chainId", automationCommonUserActivityRequestInput.ChainIdOption.Value!.Value);

            if (automationCommonUserActivityRequestInput.ContinuationOption.IsSet)
                if (automationCommonUserActivityRequestInput.ContinuationOption.Value != null)
                    writer.WriteString("continuation", automationCommonUserActivityRequestInput.Continuation);
                else
                    writer.WriteNull("continuation");

            if (automationCommonUserActivityRequestInput.LimitOption.IsSet)
                writer.WriteNumber("limit", automationCommonUserActivityRequestInput.LimitOption.Value!.Value);

            if (automationCommonUserActivityRequestInput.TypesOption.IsSet)
                if (automationCommonUserActivityRequestInput.TypesOption.Value != null)
                {
                    writer.WritePropertyName("types");
                    JsonSerializer.Serialize(writer, automationCommonUserActivityRequestInput.Types, jsonSerializerOptions);
                }
                else
