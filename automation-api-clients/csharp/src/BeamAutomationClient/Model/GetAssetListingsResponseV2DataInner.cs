...
namespace BeamAutomationClient.Model
{
    ...
    public partial class GetAssetListingsResponseV2DataInner : IValidatableObject
    {
        ...
        [JsonConstructor]
        public GetAssetListingsResponseV2DataInner(string assetAddress, string assetId, string contractKind, string id, string maker, string side, Option<DateTime?> createdAt = default, Option<DateTime?> expiresAt = default, Option<GetAssetListingsResponseV2DataInnerPrice?> price = default, Option<decimal?> quantityFilled = default, Option<decimal?> quantityRemaining = default, Option<StatusEnum?> status = default, Option<DateTime?> updatedAt = default, Option<DateTime?> validFrom = default, Option<DateTime?> validUntil = default)
        {
        ...
        public void WriteProperties(ref Utf8JsonWriter writer, GetAssetListingsResponseV2DataInner getAssetListingsResponseV2DataInner, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (getAssetListingsResponseV2DataInner.CreatedAtOption.IsSet)
                if (getAssetListingsResponseV2DataInner.CreatedAtOption.Value != null)
                    writer.WriteString("createdAt", getAssetListingsResponseV2DataInner.CreatedAtOption.Value!.Value.ToString(CreatedAtFormat));
                else
            ...
            if (getAssetListingsResponseV2DataInner.ExpiresAtOption.IsSet)
                if (getAssetListingsResponseV2DataInner.ExpiresAtOption.Value != null)
                    writer.WriteString("expiresAt", getAssetListingsResponseV2DataInner.ExpiresAtOption.Value!.Value.ToString(ExpiresAtFormat));
                else
            ...
            if (getAssetListingsResponseV2DataInner.UpdatedAtOption.IsSet)
                if (getAssetListingsResponseV2DataInner.UpdatedAtOption.Value != null)
                    writer.WriteString("updatedAt", getAssetListingsResponseV2DataInner.UpdatedAtOption.Value!.Value.ToString(UpdatedAtFormat));
                else
            ...
            if (getAssetListingsResponseV2DataInner.ValidFromOption.IsSet)
                if (getAssetListingsResponseV2DataInner.ValidFromOption.Value != null)
                    writer.WriteString("validFrom", getAssetListingsResponseV2DataInner.ValidFromOption.Value!.Value.ToString(ValidFromFormat));
                else
            ...
            if (getAssetListingsResponseV2DataInner.ValidUntilOption.IsSet)
                if (getAssetListingsResponseV2DataInner.ValidUntilOption.Value != null)
                    writer.WriteString("validUntil", getAssetListingsResponseV2DataInner.ValidUntilOption.Value!.Value.ToString(ValidUntilFormat));
                else
