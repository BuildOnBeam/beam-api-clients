...
namespace BeamAutomationClient.Model
{
    ...
    public partial class AutomationBeamErrorResponse : IValidatableObject
    {
        ...
        [JsonConstructor]
        public AutomationBeamErrorResponse(string path, int status, DateTime timestamp, Option<string?> error = default, Option<string?> message = default, Option<string?> traceId = default, Option<string?> type = default, Option<List<Object>?> validation = default)
        {
            Path = path;
            Status = status;
            Timestamp = timestamp;
    ...
    public class AutomationBeamErrorResponseJsonConverter : JsonConverter<AutomationBeamErrorResponse>
    {
        ...
        public override AutomationBeamErrorResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new AutomationBeamErrorResponse(path.Value!, status.Value!.Value!, timestamp.Value!.Value!, error, message, traceId, type, validation);
        }
        ...
        public override void Write(Utf8JsonWriter writer, AutomationBeamErrorResponse automationBeamErrorResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(ref writer, automationBeamErrorResponse, jsonSerializerOptions);
        ...
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(ref Utf8JsonWriter writer, AutomationBeamErrorResponse automationBeamErrorResponse, JsonSerializerOptions jsonSerializerOptions)
        {
