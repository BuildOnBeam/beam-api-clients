...
namespace BeamAutomationClient.Model
{
    ...
    public partial class AutomationGetAssetListingsResponseV2DataInnerPriceAmount : IValidatableObject
    {
        ...
        [JsonConstructor]
        public AutomationGetAssetListingsResponseV2DataInnerPriceAmount(decimal varDecimal, decimal native, string raw, decimal usd)
        {
    ...
    public class AutomationGetAssetListingsResponseV2DataInnerPriceAmountJsonConverter : JsonConverter<AutomationGetAssetListingsResponseV2DataInnerPriceAmount>
    {
        ...
        public override AutomationGetAssetListingsResponseV2DataInnerPriceAmount Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new AutomationGetAssetListingsResponseV2DataInnerPriceAmount(varDecimal.Value!.Value!, native.Value!.Value!, raw.Value!, usd.Value!.Value!);
        }
        ...
        public override void Write(Utf8JsonWriter writer, AutomationGetAssetListingsResponseV2DataInnerPriceAmount automationGetAssetListingsResponseV2DataInnerPriceAmount, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(ref writer, automationGetAssetListingsResponseV2DataInnerPriceAmount, jsonSerializerOptions);
        ...
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(ref Utf8JsonWriter writer, AutomationGetAssetListingsResponseV2DataInnerPriceAmount automationGetAssetListingsResponseV2DataInnerPriceAmount, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            writer.WriteNumber("decimal", automationGetAssetListingsResponseV2DataInnerPriceAmount.VarDecimal);
