...
namespace BeamAutomationClient.Model
{
    ...
    public partial class AutomationUnwrappingTokenInput : IValidatableObject
    {
        ...
        [JsonConstructor]
        public AutomationUnwrappingTokenInput(string amount, Option<long?> chainId = default, Option<bool?> optimistic = default, Option<string?> policyId = default, Option<bool?> sponsor = default)
        {
            Amount = amount;
