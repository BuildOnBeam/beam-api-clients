...
namespace BeamAutomationClient.Model
{
    ...
    public partial class AutomationUnwrappingTokenInput : IValidatableObject
    {
        ...
        [JsonConstructor]
        public AutomationUnwrappingTokenInput(string amount, Option<decimal?> chainId = default, Option<bool?> optimistic = default, Option<string?> policyId = default, Option<bool?> sponsor = default)
        {
            Amount = amount;
    ...
    public class AutomationUnwrappingTokenInputJsonConverter : JsonConverter<AutomationUnwrappingTokenInput>
    {
        ...
        public override AutomationUnwrappingTokenInput Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new AutomationUnwrappingTokenInput(amount.Value!, chainId, optimistic, policyId, sponsor);
        }
        ...
        public override void Write(Utf8JsonWriter writer, AutomationUnwrappingTokenInput automationUnwrappingTokenInput, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(ref writer, automationUnwrappingTokenInput, jsonSerializerOptions);
        ...
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(ref Utf8JsonWriter writer, AutomationUnwrappingTokenInput automationUnwrappingTokenInput, JsonSerializerOptions jsonSerializerOptions)
        {
