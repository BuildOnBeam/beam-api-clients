...
{
    /// <summary>
    /// GetAssetsForProfileBodyInputV2
    /// </summary>
    public partial class GetAssetsForProfileBodyInputV2 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAssetsForProfileBodyInputV2" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public GetAssetsForProfileBodyInputV2(Option<decimal?> chainId = default, Option<string?> continuation = default, Option<string?> contract = default, Option<bool?> includeAttributes = default, Option<decimal?> limit = default, Option<SortByEnum?> sortBy = default, Option<SortDirectionEnum?> sortDirection = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetAssetsForProfileBodyInputV2 {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="GetAssetsForProfileBodyInputV2" />
    /// </summary>
    public class GetAssetsForProfileBodyInputV2JsonConverter : JsonConverter<GetAssetsForProfileBodyInputV2>
    {
        /// <summary>
        /// Deserializes json to <see cref="GetAssetsForProfileBodyInputV2" />
        /// </summary>
        ...
        public override GetAssetsForProfileBodyInputV2 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<GetAssetsForProfileBodyInputV2.SortByEnum?> sortBy = default;
            Option<GetAssetsForProfileBodyInputV2.SortDirectionEnum?> sortDirection = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "sortBy":
                            ...
                            if (sortByRawValue != null)
                                sortBy = new Option<GetAssetsForProfileBodyInputV2.SortByEnum?>(GetAssetsForProfileBodyInputV2.SortByEnumFromStringOrDefault(sortByRawValue));
                            break;
                        case "sortDirection":
                            string? sortDirectionRawValue = utf8JsonReader.GetString();
                            if (sortDirectionRawValue != null)
                                sortDirection = new Option<GetAssetsForProfileBodyInputV2.SortDirectionEnum?>(GetAssetsForProfileBodyInputV2.SortDirectionEnumFromStringOrDefault(sortDirectionRawValue));
                            break;
                        default:
                            break;
                    }
            ...
            if (chainId.IsSet && chainId.Value == null)
                throw new ArgumentNullException(nameof(chainId), "Property is not nullable for class GetAssetsForProfileBodyInputV2.");

            if (limit.IsSet && limit.Value == null)
                throw new ArgumentNullException(nameof(limit), "Property is not nullable for class GetAssetsForProfileBodyInputV2.");

            if (sortBy.IsSet && sortBy.Value == null)
                throw new ArgumentNullException(nameof(sortBy), "Property is not nullable for class GetAssetsForProfileBodyInputV2.");

            if (sortDirection.IsSet && sortDirection.Value == null)
                throw new ArgumentNullException(nameof(sortDirection), "Property is not nullable for class GetAssetsForProfileBodyInputV2.");

            return new GetAssetsForProfileBodyInputV2(chainId, continuation, contract, includeAttributes, limit, sortBy, sortDirection);
        }

        /// <summary>
        /// Serializes a <see cref="GetAssetsForProfileBodyInputV2" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getAssetsForProfileBodyInputV2"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GetAssetsForProfileBodyInputV2 getAssetsForProfileBodyInputV2, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(ref writer, getAssetsForProfileBodyInputV2, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GetAssetsForProfileBodyInputV2" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getAssetsForProfileBodyInputV2"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(ref Utf8JsonWriter writer, GetAssetsForProfileBodyInputV2 getAssetsForProfileBodyInputV2, JsonSerializerOptions jsonSerializerOptions)
        {
            if (getAssetsForProfileBodyInputV2.ChainIdOption.IsSet)
                writer.WriteNumber("chainId", getAssetsForProfileBodyInputV2.ChainIdOption.Value!.Value);

            if (getAssetsForProfileBodyInputV2.ContinuationOption.IsSet)
                if (getAssetsForProfileBodyInputV2.ContinuationOption.Value != null)
                    writer.WriteString("continuation", getAssetsForProfileBodyInputV2.Continuation);
                else
                    writer.WriteNull("continuation");

            if (getAssetsForProfileBodyInputV2.ContractOption.IsSet)
                if (getAssetsForProfileBodyInputV2.ContractOption.Value != null)
                    writer.WriteString("contract", getAssetsForProfileBodyInputV2.Contract);
                else
                    writer.WriteNull("contract");

            if (getAssetsForProfileBodyInputV2.IncludeAttributesOption.IsSet)
                if (getAssetsForProfileBodyInputV2.IncludeAttributesOption.Value != null)
                    writer.WriteBoolean("includeAttributes", getAssetsForProfileBodyInputV2.IncludeAttributesOption.Value!.Value);
                else
                    writer.WriteNull("includeAttributes");

            if (getAssetsForProfileBodyInputV2.LimitOption.IsSet)
                writer.WriteNumber("limit", getAssetsForProfileBodyInputV2.LimitOption.Value!.Value);

            var sortByRawValue = GetAssetsForProfileBodyInputV2.SortByEnumToJsonValue(getAssetsForProfileBodyInputV2.SortByOption.Value!.Value);
            writer.WriteString("sortBy", sortByRawValue);
            var sortDirectionRawValue = GetAssetsForProfileBodyInputV2.SortDirectionEnumToJsonValue(getAssetsForProfileBodyInputV2.SortDirectionOption.Value!.Value);
