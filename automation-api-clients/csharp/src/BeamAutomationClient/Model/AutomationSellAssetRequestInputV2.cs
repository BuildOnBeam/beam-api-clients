...
namespace BeamAutomationClient.Model
{
    ...
    public partial class AutomationSellAssetRequestInputV2 : IValidatableObject
    {
        ...
        [JsonConstructor]
        public AutomationSellAssetRequestInputV2(string assetAddress, string assetId, decimal quantity, string price, SellTypeEnum sellType, Option<string> startTime = default, Option<string> endTime = default, Option<CurrencyEnum?> currency = default, Option<bool?> sponsor = default, Option<string> policyId = default, Option<long?> chainId = default)
        {
    ...
    public class AutomationSellAssetRequestInputV2JsonConverter : JsonConverter<AutomationSellAssetRequestInputV2>
    {
        ...
        public override AutomationSellAssetRequestInputV2 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new AutomationSellAssetRequestInputV2(assetAddress.Value, assetId.Value, quantity.Value.Value, price.Value, sellType.Value.Value, startTime, endTime, currency, sponsor, policyId, chainId);
        }
        ...
        public override void Write(Utf8JsonWriter writer, AutomationSellAssetRequestInputV2 automationSellAssetRequestInputV2, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, automationSellAssetRequestInputV2, jsonSerializerOptions);
        ...
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, AutomationSellAssetRequestInputV2 automationSellAssetRequestInputV2, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var currencyRawValue = AutomationSellAssetRequestInputV2.CurrencyEnumToJsonValue(automationSellAssetRequestInputV2.CurrencyOption.Value);
            if (currencyRawValue != null)
