...
namespace BeamAutomationClient.Model
{
    ...
    public partial class AutomationCommonContractActivityRequestInput : IValidatableObject
    {
        ...
        [JsonConstructor]
        public AutomationCommonContractActivityRequestInput(Option<long?> chainId = default, Option<string?> continuation = default, Option<decimal?> limit = default, Option<List<AutomationCommonContractActivityRequestInput.TypesEnum>?> types = default)
        {
