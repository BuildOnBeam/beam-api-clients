...
namespace BeamAutomationClient.Model
{
    ...
    public partial class AutomationCommonContractActivityRequestInput : IValidatableObject
    {
        ...
        [JsonConstructor]
        public AutomationCommonContractActivityRequestInput(Option<decimal?> limit = default, Option<List<AutomationCommonContractActivityRequestInput.TypesEnum>> types = default, Option<long?> chainId = default, Option<string> continuation = default)
        {
            LimitOption = limit;
            TypesOption = types;
    ...
    public class AutomationCommonContractActivityRequestInputJsonConverter : JsonConverter<AutomationCommonContractActivityRequestInput>
    {
        ...
        public override AutomationCommonContractActivityRequestInput Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new AutomationCommonContractActivityRequestInput(limit, types, chainId, continuation);
        }
        ...
        public override void Write(Utf8JsonWriter writer, AutomationCommonContractActivityRequestInput automationCommonContractActivityRequestInput, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, automationCommonContractActivityRequestInput, jsonSerializerOptions);
        ...
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, AutomationCommonContractActivityRequestInput automationCommonContractActivityRequestInput, JsonSerializerOptions jsonSerializerOptions)
        {
