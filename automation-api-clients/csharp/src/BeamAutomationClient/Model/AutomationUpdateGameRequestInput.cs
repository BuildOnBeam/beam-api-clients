...
{
    /// <summary>
    /// AutomationUpdateGameRequestInput
    /// </summary>
    public partial class AutomationUpdateGameRequestInput : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AutomationUpdateGameRequestInput" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public AutomationUpdateGameRequestInput(Option<string?> backgroundImageUrl = default, Option<string?> coverImageUrl = default, Option<string?> description = default, Option<string?> logoImageUrl = default, Option<string?> name = default, Option<List<AutomationUpdateGameRequestInput.PegiContentEnum>?> pegiContent = default, Option<PegiRatingEnum?> pegiRating = default)
        {
        ...
        [JsonIgnore]
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<AutomationUpdateGameRequestInput.PegiContentEnum>?> PegiContentOption { get; private set; }

        /// <summary>
        /// Gets or Sets PegiContent
        /// </summary>
        [JsonPropertyName("pegiContent")]
        public List<AutomationUpdateGameRequestInput.PegiContentEnum>? PegiContent { get { return this. PegiContentOption; } set { this.PegiContentOption = new(value); } }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AutomationUpdateGameRequestInput {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="AutomationUpdateGameRequestInput" />
    /// </summary>
    public class AutomationUpdateGameRequestInputJsonConverter : JsonConverter<AutomationUpdateGameRequestInput>
    {
        /// <summary>
        /// Deserializes json to <see cref="AutomationUpdateGameRequestInput" />
        /// </summary>
        ...
        public override AutomationUpdateGameRequestInput Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<AutomationUpdateGameRequestInput.PegiContentEnum>?> pegiContent = default;
            Option<AutomationUpdateGameRequestInput.PegiRatingEnum?> pegiRating = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "pegiContent":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                pegiContent = new Option<List<AutomationUpdateGameRequestInput.PegiContentEnum>?>(JsonSerializer.Deserialize<List<AutomationUpdateGameRequestInput.PegiContentEnum>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "pegiRating":
                            string? pegiRatingRawValue = utf8JsonReader.GetString();
                            if (pegiRatingRawValue != null)
                                pegiRating = new Option<AutomationUpdateGameRequestInput.PegiRatingEnum?>(AutomationUpdateGameRequestInput.PegiRatingEnumFromStringOrDefault(pegiRatingRawValue));
                            break;
                        default:
                            break;
                    }
            ...
            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class AutomationUpdateGameRequestInput.");

            if (pegiContent.IsSet && pegiContent.Value == null)
                throw new ArgumentNullException(nameof(pegiContent), "Property is not nullable for class AutomationUpdateGameRequestInput.");

            return new AutomationUpdateGameRequestInput(backgroundImageUrl, coverImageUrl, description, logoImageUrl, name, pegiContent, pegiRating);
        }

        /// <summary>
        /// Serializes a <see cref="AutomationUpdateGameRequestInput" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="automationUpdateGameRequestInput"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, AutomationUpdateGameRequestInput automationUpdateGameRequestInput, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(ref writer, automationUpdateGameRequestInput, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="AutomationUpdateGameRequestInput" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="automationUpdateGameRequestInput"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(ref Utf8JsonWriter writer, AutomationUpdateGameRequestInput automationUpdateGameRequestInput, JsonSerializerOptions jsonSerializerOptions)
        {
            if (automationUpdateGameRequestInput.NameOption.IsSet && automationUpdateGameRequestInput.Name == null)
                throw new ArgumentNullException(nameof(automationUpdateGameRequestInput.Name), "Property is required for class AutomationUpdateGameRequestInput.");

            if (automationUpdateGameRequestInput.PegiContentOption.IsSet && automationUpdateGameRequestInput.PegiContent == null)
                throw new ArgumentNullException(nameof(automationUpdateGameRequestInput.PegiContent), "Property is required for class AutomationUpdateGameRequestInput.");

            if (automationUpdateGameRequestInput.BackgroundImageUrlOption.IsSet)
                if (automationUpdateGameRequestInput.BackgroundImageUrlOption.Value != null)
                    writer.WriteString("backgroundImageUrl", automationUpdateGameRequestInput.BackgroundImageUrl);
                else
                    writer.WriteNull("backgroundImageUrl");

            if (automationUpdateGameRequestInput.CoverImageUrlOption.IsSet)
                if (automationUpdateGameRequestInput.CoverImageUrlOption.Value != null)
                    writer.WriteString("coverImageUrl", automationUpdateGameRequestInput.CoverImageUrl);
                else
                    writer.WriteNull("coverImageUrl");

            if (automationUpdateGameRequestInput.DescriptionOption.IsSet)
                if (automationUpdateGameRequestInput.DescriptionOption.Value != null)
                    writer.WriteString("description", automationUpdateGameRequestInput.Description);
                else
                    writer.WriteNull("description");

            if (automationUpdateGameRequestInput.LogoImageUrlOption.IsSet)
                if (automationUpdateGameRequestInput.LogoImageUrlOption.Value != null)
                    writer.WriteString("logoImageUrl", automationUpdateGameRequestInput.LogoImageUrl);
                else
                    writer.WriteNull("logoImageUrl");

            if (automationUpdateGameRequestInput.NameOption.IsSet)
                writer.WriteString("name", automationUpdateGameRequestInput.Name);

            if (automationUpdateGameRequestInput.PegiContentOption.IsSet)
            {
                writer.WritePropertyName("pegiContent");
                JsonSerializer.Serialize(writer, automationUpdateGameRequestInput.PegiContent, jsonSerializerOptions);
            }
            var pegiRatingRawValue = AutomationUpdateGameRequestInput.PegiRatingEnumToJsonValue(automationUpdateGameRequestInput.PegiRatingOption.Value!.Value);
            if (pegiRatingRawValue != null)
