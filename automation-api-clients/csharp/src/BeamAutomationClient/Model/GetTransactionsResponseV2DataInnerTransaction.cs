...
namespace BeamAutomationClient.Model
{
    ...
    public partial class GetTransactionsResponseV2DataInnerTransaction : IValidatableObject
    {
        ...
        [JsonConstructor]
        public GetTransactionsResponseV2DataInnerTransaction(DateTime createdAt, Option<decimal?> blockNumber = default, Option<string?> gasFee = default, Option<string?> gasUsed = default, Option<string?> hash = default, Option<List<GetTransactionsResponseV2DataInnerTransactionLogsInner>?> logs = default, Option<decimal?> status = default)
        {
            CreatedAt = createdAt;
    ...
    public class GetTransactionsResponseV2DataInnerTransactionJsonConverter : JsonConverter<GetTransactionsResponseV2DataInnerTransaction>
    {
        ...
        public override GetTransactionsResponseV2DataInnerTransaction Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (createdAt.IsSet && createdAt.Value == null)
                throw new ArgumentNullException(nameof(createdAt), "Property is not nullable for class GetTransactionsResponseV2DataInnerTransaction.");
            ...
            return new GetTransactionsResponseV2DataInnerTransaction(createdAt.Value!.Value!, blockNumber, gasFee, gasUsed, hash, logs, status);
        }
        ...
        public void WriteProperties(ref Utf8JsonWriter writer, GetTransactionsResponseV2DataInnerTransaction getTransactionsResponseV2DataInnerTransaction, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            writer.WriteString("createdAt", getTransactionsResponseV2DataInnerTransaction.CreatedAt.ToString(CreatedAtFormat));
