...
namespace BeamAutomationClient.Model
{
    ...
    public partial class AutomationUpdateProfileResponse : IValidatableObject
    {
        ...
        [JsonConstructor]
        public AutomationUpdateProfileResponse(DateTime createdAt, string externalEntityId, string externalId, string gameId, string id, DateTime updatedAt, List<AutomationCreateProfileResponseWalletsInner> wallets, Option<DateTime?> userConnectionCreatedAt = default, string? userId = default)
        {
            CreatedAt = createdAt;
    ...
    public class AutomationUpdateProfileResponseJsonConverter : JsonConverter<AutomationUpdateProfileResponse>
    {
        ...
        public override AutomationUpdateProfileResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new AutomationUpdateProfileResponse(createdAt.Value!.Value!, externalEntityId.Value!, externalId.Value!, gameId.Value!, id.Value!, updatedAt.Value!.Value!, wallets.Value!, userConnectionCreatedAt, userId.Value!);
        }
        ...
        public override void Write(Utf8JsonWriter writer, AutomationUpdateProfileResponse automationUpdateProfileResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(ref writer, automationUpdateProfileResponse, jsonSerializerOptions);
        ...
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(ref Utf8JsonWriter writer, AutomationUpdateProfileResponse automationUpdateProfileResponse, JsonSerializerOptions jsonSerializerOptions)
        {
