...
namespace BeamAutomationClient.Model
{
    ...
    public partial class AutomationAcceptAssetOfferRequestInputV2 : IValidatableObject
    {
        ...
        [JsonConstructor]
        public AutomationAcceptAssetOfferRequestInputV2(string offerId, decimal quantity, Option<decimal?> chainId = default, Option<bool?> optimistic = default, Option<string?> policyId = default, Option<bool?> sponsor = default)
        {
            OfferId = offerId;
            Quantity = quantity;
