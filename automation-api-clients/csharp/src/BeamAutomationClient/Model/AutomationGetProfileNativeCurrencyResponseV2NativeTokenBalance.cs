...
namespace BeamAutomationClient.Model
{
    ...
    public partial class AutomationGetProfileNativeCurrencyResponseV2NativeTokenBalance : IValidatableObject
    {
        ...
        [JsonConstructor]
        public AutomationGetProfileNativeCurrencyResponseV2NativeTokenBalance(string balance, long chainId, decimal decimals, string name, string symbol, Option<string?> logoUri = default)
        {
            Balance = balance;
            ChainId = chainId;
            Decimals = decimals;
