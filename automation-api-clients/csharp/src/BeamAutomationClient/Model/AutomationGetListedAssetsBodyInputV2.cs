...
namespace BeamAutomationClient.Model
{
    ...
    public partial class AutomationGetListedAssetsBodyInputV2 : IValidatableObject
    {
        ...
        [JsonConstructor]
        public AutomationGetListedAssetsBodyInputV2(Option<List<string>?> assetAddresses = default, Option<decimal?> chainId = default, Option<string?> continuation = default, Option<int?> limit = default, Option<SortByEnum?> sortBy = default, Option<SortDirectionEnum?> sortDirection = default)
        {
    ...
    public class AutomationGetListedAssetsBodyInputV2JsonConverter : JsonConverter<AutomationGetListedAssetsBodyInputV2>
    {
        ...
        public override AutomationGetListedAssetsBodyInputV2 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new AutomationGetListedAssetsBodyInputV2(assetAddresses, chainId, continuation, limit, sortBy, sortDirection);
        }
        ...
        public override void Write(Utf8JsonWriter writer, AutomationGetListedAssetsBodyInputV2 automationGetListedAssetsBodyInputV2, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(ref writer, automationGetListedAssetsBodyInputV2, jsonSerializerOptions);
        ...
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(ref Utf8JsonWriter writer, AutomationGetListedAssetsBodyInputV2 automationGetListedAssetsBodyInputV2, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var sortByRawValue = AutomationGetListedAssetsBodyInputV2.SortByEnumToJsonValue(automationGetListedAssetsBodyInputV2.SortByOption.Value!.Value);
            writer.WriteString("sortBy", sortByRawValue);
            var sortDirectionRawValue = AutomationGetListedAssetsBodyInputV2.SortDirectionEnumToJsonValue(automationGetListedAssetsBodyInputV2.SortDirectionOption.Value!.Value);
