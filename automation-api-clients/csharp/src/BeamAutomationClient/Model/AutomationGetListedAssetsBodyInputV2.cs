...
namespace BeamAutomationClient.Model
{
    ...
    public partial class AutomationGetListedAssetsBodyInputV2 : IValidatableObject
    {
        ...
        [JsonConstructor]
        public AutomationGetListedAssetsBodyInputV2(Option<List<string>?> assetAddresses = default, Option<long?> chainId = default, Option<string?> continuation = default, Option<int?> limit = default, Option<SortByEnum?> sortBy = default, Option<SortDirectionEnum?> sortDirection = default)
        {
