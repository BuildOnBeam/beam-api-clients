...
namespace BeamAutomationClient.Model
{
    ...
    public partial class AutomationCommonActivityResponseDataInner : IValidatableObject
    {
        ...
        [JsonConstructor]
        public AutomationCommonActivityResponseDataInner(AutomationCommonActivityResponseDataInnerAsset asset, AutomationCommonActivityResponseDataInnerContract contract, AutomationCommonActivityResponseDataInnerTransaction transaction, Option<string?> createdAt = default, Option<AutomationCommonActivityResponseDataInnerOrder?> order = default, Option<TypeEnum?> type = default)
        {
            Asset = asset;
            Contract = contract;
    ...
    public class AutomationCommonActivityResponseDataInnerJsonConverter : JsonConverter<AutomationCommonActivityResponseDataInner>
    {
        ...
        public override AutomationCommonActivityResponseDataInner Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new AutomationCommonActivityResponseDataInner(asset.Value!, contract.Value!, transaction.Value!, createdAt, order, type);
        }
        ...
        public override void Write(Utf8JsonWriter writer, AutomationCommonActivityResponseDataInner automationCommonActivityResponseDataInner, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(ref writer, automationCommonActivityResponseDataInner, jsonSerializerOptions);
        ...
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(ref Utf8JsonWriter writer, AutomationCommonActivityResponseDataInner automationCommonActivityResponseDataInner, JsonSerializerOptions jsonSerializerOptions)
        {
