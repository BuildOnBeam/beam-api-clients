...
namespace BeamAutomationClient.Api
{
    ...
    /// </summary>
    public interface ICreatePolicyApiResponse : BeamAutomationClient.Client.IApiResponse, ICreated<BeamAutomationClient.Model.AutomationCommonAddPolicyResponse>, IHttpStatusCode4XX<BeamAutomationClient.Model.AutomationBeamErrorResponse>, IHttpStatusCode5XX<BeamAutomationClient.Model.AutomationBeamErrorResponse>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IDeletePolicyApiResponse : BeamAutomationClient.Client.IApiResponse, IOk<BeamAutomationClient.Model.AutomationCommonRemovePolicyResponse>, IHttpStatusCode4XX<BeamAutomationClient.Model.AutomationBeamErrorResponse>, IHttpStatusCode5XX<BeamAutomationClient.Model.AutomationBeamErrorResponse>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IGetPoliciesApiResponse : BeamAutomationClient.Client.IApiResponse, IOk<BeamAutomationClient.Model.AutomationCommonGetPoliciesResponse>, IHttpStatusCode4XX<BeamAutomationClient.Model.AutomationBeamErrorResponse>, IHttpStatusCode5XX<BeamAutomationClient.Model.AutomationBeamErrorResponse>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    public sealed partial class AutomationPolicyApi : IAutomationPolicyApi
    {
        ...
        /// <param name="automationCommonAddPolicyRequestInput"></param>
        private void OnErrorCreatePolicyDefaultImplementation(Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, AutomationCommonAddPolicyRequestInput automationCommonAddPolicyRequestInput)
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorCreatePolicy(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, automationCommonAddPolicyRequestInput);
        ...
        /// <param name="pathLocalVar"></param>
        /// <param name="automationCommonAddPolicyRequestInput"></param>
        partial void OnErrorCreatePolicy(ref bool suppressDefaultLogLocalVar, Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, AutomationCommonAddPolicyRequestInput automationCommonAddPolicyRequestInput);
        ...
        /// <param name="pathLocalVar"></param>
        /// <param name="policyId"></param>
        private void OnErrorDeletePolicyDefaultImplementation(Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, string policyId)
        {
            bool suppressDefaultLogLocalVar = false;
        ...
        /// <param name="pathLocalVar"></param>
        /// <param name="policyId"></param>
        partial void OnErrorDeletePolicy(ref bool suppressDefaultLogLocalVar, Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, string policyId);
        ...
        /// <param name="pathFormatLocalVar"></param>
        /// <param name="pathLocalVar"></param>
        private void OnErrorGetPoliciesDefaultImplementation(Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar)
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorGetPolicies(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        /// <param name="pathFormatLocalVar"></param>
        /// <param name="pathLocalVar"></param>
        partial void OnErrorGetPolicies(ref bool suppressDefaultLogLocalVar, Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar);
