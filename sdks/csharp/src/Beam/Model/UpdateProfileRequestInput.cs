...
namespace Beam.Model
{
    ...
    /// </summary>
    public partial class UpdateProfileRequestInput : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public UpdateProfileRequestInput(string newEntityId)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="UpdateProfileRequestInput" />
    /// </summary>
    public class UpdateProfileRequestInputJsonConverter : JsonConverter<UpdateProfileRequestInput>
    {
        /// <summary>
        /// Deserializes json to <see cref="UpdateProfileRequestInput" />
        /// </summary>
        ...
        public override UpdateProfileRequestInput Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
        ...
        /// <summary>
        /// Serializes a <see cref="UpdateProfileRequestInput" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="updateProfileRequestInput"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, UpdateProfileRequestInput updateProfileRequestInput, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(ref writer, updateProfileRequestInput, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="UpdateProfileRequestInput" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="updateProfileRequestInput"></param>
        /// <param name="jsonSerializerOptions"></param>
