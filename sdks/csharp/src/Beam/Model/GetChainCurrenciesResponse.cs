...
namespace Beam.Model
{
    ...
    public partial class GetChainCurrenciesResponse : IEquatable<GetChainCurrenciesResponse>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as GetChainCurrenciesResponse);
        }

        /// <summary>
        /// Returns true if GetChainCurrenciesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GetChainCurrenciesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetChainCurrenciesResponse input)
        {
            if (input == null)
            {
                return false;
