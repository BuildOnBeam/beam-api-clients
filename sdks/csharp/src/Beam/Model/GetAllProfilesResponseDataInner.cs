...
namespace Beam.Model
{
    ...
    public partial class GetAllProfilesResponseDataInner : IEquatable<GetAllProfilesResponseDataInner>, IValidatableObject
    {
        ...
        public GetAllProfilesResponseDataInner(string id = default(string), Object createdAt = default(Object), Object updatedAt = default(Object), string externalId = default(string), string externalEntityId = default(string), string gameId = default(string), string userId = default(string), Object userConnectionCreatedAt = default(Object), List<CreateProfileResponseWalletsInner> wallets = default(List<CreateProfileResponseWalletsInner>))
        {
            ...
            if (createdAt == null)
            {
                throw new ArgumentNullException("createdAt is a required property for GetAllProfilesResponseDataInner and cannot be null");
            }
            this.CreatedAt = createdAt;
            // to ensure "updatedAt" is required (not null)
            if (updatedAt == null)
            {
                throw new ArgumentNullException("updatedAt is a required property for GetAllProfilesResponseDataInner and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("externalEntityId is a required property for GetAllProfilesResponseDataInner and cannot be null");
            }
