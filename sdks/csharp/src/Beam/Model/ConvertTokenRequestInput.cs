...
namespace Beam.Model
{
    ...
    public partial class ConvertTokenRequestInput : IEquatable<ConvertTokenRequestInput>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ConvertTokenRequestInput);
        }

        /// <summary>
        /// Returns true if ConvertTokenRequestInput instances are equal
        /// </summary>
        /// <param name="input">Instance of ConvertTokenRequestInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConvertTokenRequestInput input)
        {
            if (input == null)
            {
                return false;
