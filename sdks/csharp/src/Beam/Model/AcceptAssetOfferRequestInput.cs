...
namespace Beam.Model
{
    ...
    public partial class AcceptAssetOfferRequestInput : IValidatableObject
    {
        ...
        [JsonConstructor]
        public AcceptAssetOfferRequestInput(string policyId, decimal quantity, bool optimistic = false, bool sponsor = true)
        {
            PolicyId = policyId;
            Quantity = quantity;
    ...
    public class AcceptAssetOfferRequestInputJsonConverter : JsonConverter<AcceptAssetOfferRequestInput>
    {
        ...
        public override AcceptAssetOfferRequestInput Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (policyId == null)
                throw new ArgumentNullException(nameof(policyId), "Property is required for class AcceptAssetOfferRequestInput.");

            if (quantity == null)
                throw new ArgumentNullException(nameof(quantity), "Property is required for class AcceptAssetOfferRequestInput.");

            if (optimistic == null)
                throw new ArgumentNullException(nameof(optimistic), "Property is required for class AcceptAssetOfferRequestInput.");

            if (sponsor == null)
                throw new ArgumentNullException(nameof(sponsor), "Property is required for class AcceptAssetOfferRequestInput.");

            return new AcceptAssetOfferRequestInput(policyId, quantity.Value, optimistic.Value, sponsor.Value);
        }
        ...
        public void WriteProperties(ref Utf8JsonWriter writer, AcceptAssetOfferRequestInput acceptAssetOfferRequestInput, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            writer.WriteBoolean("optimistic", acceptAssetOfferRequestInput.Optimistic);
            writer.WriteBoolean("sponsor", acceptAssetOfferRequestInput.Sponsor);
        }
    }
}
