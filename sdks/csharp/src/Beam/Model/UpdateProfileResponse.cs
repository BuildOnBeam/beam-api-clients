...
namespace Beam.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateProfileResponse")]
    public partial class UpdateProfileResponse : IEquatable<UpdateProfileResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateProfileResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateProfileResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateProfileResponse" /> class.
        /// </summary>
        ...
        public UpdateProfileResponse(string id = default(string), Object createdAt = default(Object), Object updatedAt = default(Object), string externalId = default(string), string externalEntityId = default(string), string gameId = default(string), string userId = default(string), Object userConnectionCreatedAt = default(Object), List<CreateProfileResponseWalletsInner> wallets = default(List<CreateProfileResponseWalletsInner>))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for UpdateProfileResponse and cannot be null");
            }
            this.Id = id;
            // to ensure "createdAt" is required (not null)
            if (createdAt == null)
            {
                throw new ArgumentNullException("createdAt is a required property for UpdateProfileResponse and cannot be null");
            }
            this.CreatedAt = createdAt;
            // to ensure "updatedAt" is required (not null)
            if (updatedAt == null)
            {
                throw new ArgumentNullException("updatedAt is a required property for UpdateProfileResponse and cannot be null");
            }
            this.UpdatedAt = updatedAt;
            // to ensure "externalId" is required (not null)
            if (externalId == null)
            {
                throw new ArgumentNullException("externalId is a required property for UpdateProfileResponse and cannot be null");
            }
            this.ExternalId = externalId;
            // to ensure "externalEntityId" is required (not null)
            if (externalEntityId == null)
            {
                throw new ArgumentNullException("externalEntityId is a required property for UpdateProfileResponse and cannot be null");
            }
            this.ExternalEntityId = externalEntityId;
            // to ensure "gameId" is required (not null)
            if (gameId == null)
            {
                throw new ArgumentNullException("gameId is a required property for UpdateProfileResponse and cannot be null");
            }
            this.GameId = gameId;
            // to ensure "userId" is required (not null)
            if (userId == null)
            {
                throw new ArgumentNullException("userId is a required property for UpdateProfileResponse and cannot be null");
            }
            this.UserId = userId;
            // to ensure "userConnectionCreatedAt" is required (not null)
            if (userConnectionCreatedAt == null)
            {
                throw new ArgumentNullException("userConnectionCreatedAt is a required property for UpdateProfileResponse and cannot be null");
            }
            this.UserConnectionCreatedAt = userConnectionCreatedAt;
            // to ensure "wallets" is required (not null)
            if (wallets == null)
            {
                throw new ArgumentNullException("wallets is a required property for UpdateProfileResponse and cannot be null");
            }
        ...
        {
            return this.Equals(input as UpdateProfileResponse);
        }

        /// <summary>
        /// Returns true if UpdateProfileResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateProfileResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateProfileResponse input)
        {
            if (input == null)
            {
                return false;
