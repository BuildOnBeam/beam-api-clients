...
namespace Beam.Model
{
    ...
    public partial class GetTransactionsResponseDataInner : IEquatable<GetTransactionsResponseDataInner>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as GetTransactionsResponseDataInner);
        }

        /// <summary>
        /// Returns true if GetTransactionsResponseDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of GetTransactionsResponseDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetTransactionsResponseDataInner input)
        {
            if (input == null)
            {
                return false;
