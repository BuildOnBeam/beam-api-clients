...
namespace Beam.Model
{
    ...
    public class AddContractResponseJsonConverter : JsonConverter<AddContractResponse>
    {
        ...
        public override AddContractResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            string id = default;
            AddContractResponse.TypeEnum? type = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "type":
                            ...
                            type = typeRawValue == null
                                ? null
                                : AddContractResponse.TypeEnumFromStringOrDefault(typeRawValue);
                            break;
                        case "createdAt":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
            ...
            if (address == null)
                throw new ArgumentNullException(nameof(address), "Property is required for class AddContractResponse.");

            if (chainId == null)
                throw new ArgumentNullException(nameof(chainId), "Property is required for class AddContractResponse.");

            if (externalId == null)
                throw new ArgumentNullException(nameof(externalId), "Property is required for class AddContractResponse.");

            if (id == null)
                throw new ArgumentNullException(nameof(id), "Property is required for class AddContractResponse.");

            if (type == null)
                throw new ArgumentNullException(nameof(type), "Property is required for class AddContractResponse.");

            return new AddContractResponse(address, chainId.Value, externalId, id, type.Value, createdAt, gameId, name, updatedAt);
        }
