...
namespace Beam.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateProfileResponse")]
    public partial class CreateProfileResponse : IEquatable<CreateProfileResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public CreateProfileResponse(string id = default(string), Object createdAt = default(Object), Object updatedAt = default(Object), string externalId = default(string), string externalEntityId = default(string), string gameId = default(string), string userId = default(string), Object userConnectionCreatedAt = default(Object), List<CreateProfileResponseWalletsInner> wallets = default(List<CreateProfileResponseWalletsInner>))
        {
            ...
            if (userId == null)
            {
                throw new ArgumentNullException("userId is a required property for CreateProfileResponse and cannot be null");
            }
            this.UserId = userId;
            // to ensure "userConnectionCreatedAt" is required (not null)
            if (userConnectionCreatedAt == null)
            {
                throw new ArgumentNullException("userConnectionCreatedAt is a required property for CreateProfileResponse and cannot be null");
            }
            this.UserConnectionCreatedAt = userConnectionCreatedAt;
            // to ensure "wallets" is required (not null)
            if (wallets == null)
            {
                throw new ArgumentNullException("wallets is a required property for CreateProfileResponse and cannot be null");
            }
        ...
        {
            return this.Equals(input as CreateProfileResponse);
        }

        /// <summary>
        /// Returns true if CreateProfileResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateProfileResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateProfileResponse input)
        {
            if (input == null)
            {
                return false;
