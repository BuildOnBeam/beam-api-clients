...
{
    /// <summary>
    /// GetAllGasUsageResponseDataInnerDataInnerPolicy
    /// </summary>
    public partial class GetAllGasUsageResponseDataInnerDataInnerPolicy : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAllGasUsageResponseDataInnerDataInnerPolicy" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public GetAllGasUsageResponseDataInnerDataInnerPolicy(int chainId, string id, ModelEnum model, string name)
        {
            ChainId = chainId;
            Id = id;
            Model = model;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetAllGasUsageResponseDataInnerDataInnerPolicy {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="GetAllGasUsageResponseDataInnerDataInnerPolicy" />
    /// </summary>
    public class GetAllGasUsageResponseDataInnerDataInnerPolicyJsonConverter : JsonConverter<GetAllGasUsageResponseDataInnerDataInnerPolicy>
    {
        /// <summary>
        /// Deserializes json to <see cref="GetAllGasUsageResponseDataInnerDataInnerPolicy" />
        /// </summary>
        ...
        public override GetAllGasUsageResponseDataInnerDataInnerPolicy Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
        ...
        /// <summary>
        /// Serializes a <see cref="GetAllGasUsageResponseDataInnerDataInnerPolicy" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getAllGasUsageResponseDataInnerDataInnerPolicy"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GetAllGasUsageResponseDataInnerDataInnerPolicy getAllGasUsageResponseDataInnerDataInnerPolicy, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(ref writer, getAllGasUsageResponseDataInnerDataInnerPolicy, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GetAllGasUsageResponseDataInnerDataInnerPolicy" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getAllGasUsageResponseDataInnerDataInnerPolicy"></param>
        /// <param name="jsonSerializerOptions"></param>
        ...
        public void WriteProperties(ref Utf8JsonWriter writer, GetAllGasUsageResponseDataInnerDataInnerPolicy getAllGasUsageResponseDataInnerDataInnerPolicy, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            writer.WriteString("name", getAllGasUsageResponseDataInnerDataInnerPolicy.Name);
        }
    }
}
