...
namespace Beam.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TransferAssetResponse")]
    public partial class TransferAssetResponse : IEquatable<TransferAssetResponse>, IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        protected TransferAssetResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransferAssetResponse" /> class.
        /// </summary>
        ...
        public TransferAssetResponse(StatusEnum status = default(StatusEnum), TypeEnum type = default(TypeEnum), string payloadToSign = default(string), string transactionHash = default(string), string explorerUrl = default(string))
        {
            this.Status = status;
            this.Type = type;
        ...
        {
            return this.Equals(input as TransferAssetResponse);
        }

        /// <summary>
        /// Returns true if TransferAssetResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TransferAssetResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransferAssetResponse input)
        {
            if (input == null)
            {
                return false;
