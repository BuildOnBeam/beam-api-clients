...
namespace Beam.Model
{
    ...
    public partial class AcceptOfferResponse : IValidatableObject
    {
        ...
        [JsonConstructor]
        public AcceptOfferResponse(string explorerUrl, bool success, string transactionHash)
        {
    ...
    public class AcceptOfferResponseJsonConverter : JsonConverter<AcceptOfferResponse>
    {
        ...
        public override AcceptOfferResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (explorerUrl == null)
                throw new ArgumentNullException(nameof(explorerUrl), "Property is required for class AcceptOfferResponse.");

            if (success == null)
                throw new ArgumentNullException(nameof(success), "Property is required for class AcceptOfferResponse.");

            if (transactionHash == null)
                throw new ArgumentNullException(nameof(transactionHash), "Property is required for class AcceptOfferResponse.");

            return new AcceptOfferResponse(explorerUrl, success.Value, transactionHash);
        }
