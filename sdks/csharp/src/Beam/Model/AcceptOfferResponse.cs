...
namespace Beam.Model
{
    ...
    /// AcceptOfferResponse
    /// </summary>
    [DataContract(Name = "AcceptOfferResponse")]
    public partial class AcceptOfferResponse : IEquatable<AcceptOfferResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AcceptOfferResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AcceptOfferResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AcceptOfferResponse" /> class.
        /// </summary>
        ...
        public AcceptOfferResponse(bool success = default(bool), string transactionHash = default(string), string explorerUrl = default(string))
        {
        ...
        {
            return this.Equals(input as AcceptOfferResponse);
        }

        /// <summary>
        /// Returns true if AcceptOfferResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of AcceptOfferResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AcceptOfferResponse input)
        {
            if (input == null)
            {
                return false;
