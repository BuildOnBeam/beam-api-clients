...
namespace Beam.Api
{
    ...
    /// </summary>
    public interface IAddContractToGameApiResponse : Beam.Client.IApiResponse, ICreated<Beam.Model.AddContractResponse>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IRegenerateApiKeysApiResponse : Beam.Client.IApiResponse, ICreated<Beam.Model.RegenerateGameApiKeysResponse>
    {
        /// <summary>
        /// Returns true if the response is 201 Created
        /// </summary>
    ...
    public sealed partial class GameApi : IGameApi
    {
        ...
        /// </summary>
        public partial class AddContractToGameApiResponse : Beam.Client.ApiResponse, IAddContractToGameApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public Beam.Model.AddContractResponse Created()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsCreated
                    ? System.Text.Json.JsonSerializer.Deserialize<Beam.Model.AddContractResponse>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <returns></returns>
            public bool TryCreated([NotNullWhen(true)]out Beam.Model.AddContractResponse result)
            {
                result = null;
        ...
        /// </summary>
        public partial class GetGameApiResponse : Beam.Client.ApiResponse, IGetGameApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class RegenerateApiKeysApiResponse : Beam.Client.ApiResponse, IRegenerateApiKeysApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public Beam.Model.RegenerateGameApiKeysResponse Created()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsCreated
                    ? System.Text.Json.JsonSerializer.Deserialize<Beam.Model.RegenerateGameApiKeysResponse>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryCreated([NotNullWhen(true)]out Beam.Model.RegenerateGameApiKeysResponse result)
            {
                result = null;
        ...
        /// </summary>
        public partial class RemoveContractFromGameApiResponse : Beam.Client.ApiResponse, IRemoveContractFromGameApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class UpdateGameApiResponse : Beam.Client.ApiResponse, IUpdateGameApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
