...
namespace Beam.Api
{
    ...
    /// </summary>
    public interface ICheckApiResponse : Beam.Client.IApiResponse, IOk<Beam.Model.Check200Response>, IServiceUnavailable<Beam.Model.Check503Response>
    {
        /// <summary>
    ...
    public sealed partial class HealthApi : IHealthApi
    {
        ...
        /// </summary>
        public partial class CheckApiResponse : Beam.Client.ApiResponse, ICheckApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public Beam.Model.Check200Response Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<Beam.Model.Check200Response>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out Beam.Model.Check200Response result)
            {
                result = null;
            ...
            /// </summary>
            /// <returns></returns>
            public Beam.Model.Check503Response ServiceUnavailable()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsServiceUnavailable
                    ? System.Text.Json.JsonSerializer.Deserialize<Beam.Model.Check503Response>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryServiceUnavailable([NotNullWhen(true)]out Beam.Model.Check503Response result)
            {
                result = null;
