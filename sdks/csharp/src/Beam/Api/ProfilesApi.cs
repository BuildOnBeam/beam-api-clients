...
namespace Beam.Api
{
    ...
    /// </summary>
    public interface ICreateProfileApiResponse : Beam.Client.IApiResponse, ICreated<Beam.Model.CreateProfileResponse>
    {
        /// <summary>
        /// Returns true if the response is 201 Created
        /// </summary>
    ...
    public sealed partial class ProfilesApi : IProfilesApi
    {
        ...
        public partial class CreateProfileApiResponse : Beam.Client.ApiResponse, ICreateProfileApiResponse
        {
            ...
            /// </summary>
            /// <returns></returns>
            public Beam.Model.CreateProfileResponse Created()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsCreated
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryCreated([NotNullWhen(true)]out Beam.Model.CreateProfileResponse result)
            {
                result = null;
