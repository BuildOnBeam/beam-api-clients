...
namespace Beam.Api
{
    ...
    /// </summary>
    public interface IConvertInputApiResponse : Beam.Client.IApiResponse, IOk<Beam.Model.ConvertTokenResponse>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IConvertToOutputApiResponse : Beam.Client.IApiResponse, IOk<Beam.Model.ConvertTokenResponse>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IGetQuoteForInputApiResponse : Beam.Client.IApiResponse, IOk<Beam.Model.GetQuoteResponse>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IGetQuoteForOutputApiResponse : Beam.Client.IApiResponse, IOk<Beam.Model.GetQuoteResponse>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    public sealed partial class ExchangeApi : IExchangeApi
    {
        ...
        /// </summary>
        public partial class ConvertInputApiResponse : Beam.Client.ApiResponse, IConvertInputApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public Beam.Model.ConvertTokenResponse Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<Beam.Model.ConvertTokenResponse>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out Beam.Model.ConvertTokenResponse result)
            {
                result = null;
        ...
        /// </summary>
        public partial class ConvertToOutputApiResponse : Beam.Client.ApiResponse, IConvertToOutputApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class GetQuoteForInputApiResponse : Beam.Client.ApiResponse, IGetQuoteForInputApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public Beam.Model.GetQuoteResponse Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<Beam.Model.GetQuoteResponse>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out Beam.Model.GetQuoteResponse result)
            {
                result = null;
        ...
        /// </summary>
        public partial class GetQuoteForOutputApiResponse : Beam.Client.ApiResponse, IGetQuoteForOutputApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
