...
namespace Beam.Api
{
    ...
    /// </summary>
    public interface IGetTotalGameUsageApiResponse : Beam.Client.IApiResponse, IOk<Beam.Model.GetAllGasUsageResponse>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    public sealed partial class ReportingApi : IReportingApi
    {
        ...
        /// </summary>
        public partial class GetPolicyUsageApiResponse : Beam.Client.ApiResponse, IGetPolicyUsageApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class GetTotalGameUsageApiResponse : Beam.Client.ApiResponse, IGetTotalGameUsageApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public Beam.Model.GetAllGasUsageResponse Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<Beam.Model.GetAllGasUsageResponse>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out Beam.Model.GetAllGasUsageResponse result)
            {
                result = null;
