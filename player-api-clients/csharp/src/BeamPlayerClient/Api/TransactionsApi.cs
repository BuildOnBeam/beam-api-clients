...
namespace BeamPlayerClient.Api
{
    ...
    public interface IPlayerTransactionsApi : IPlayerApi
    {
        ...
        Task<ICreateUserTransactionApiResponse> CreateUserTransactionAsync(string entityId, PlayerCreateTransactionRequestInput playerCreateTransactionRequestInput, System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="ICreateUserTransactionApiResponse"/>&gt;</returns>
        Task<ICreateUserTransactionApiResponse> CreateUserTransactionOrDefaultAsync(string entityId, PlayerCreateTransactionRequestInput playerCreateTransactionRequestInput, System.Threading.CancellationToken cancellationToken = default);
    ...
    /// </summary>
    public interface ICreateUserTransactionApiResponse : BeamPlayerClient.Client.IApiResponse, ICreated<BeamPlayerClient.Model.PlayerPlayerOperationResponse>, IHttpStatusCode4XX<BeamPlayerClient.Model.PlayerBeamErrorResponse>, IHttpStatusCode5XX<BeamPlayerClient.Model.PlayerBeamErrorResponse>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IGetTransactionApiResponse : BeamPlayerClient.Client.IApiResponse, IOk<BeamPlayerClient.Model.PlayerGetTransactionResponse>, IHttpStatusCode4XX<BeamPlayerClient.Model.PlayerBeamErrorResponse>, IHttpStatusCode5XX<BeamPlayerClient.Model.PlayerBeamErrorResponse>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IGetTransactionsApiResponse : BeamPlayerClient.Client.IApiResponse, IOk<BeamPlayerClient.Model.PlayerGetTransactionsResponse>, IHttpStatusCode4XX<BeamPlayerClient.Model.PlayerBeamErrorResponse>, IHttpStatusCode5XX<BeamPlayerClient.Model.PlayerBeamErrorResponse>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IGetUserTransactionsApiResponse : BeamPlayerClient.Client.IApiResponse, IOk<BeamPlayerClient.Model.PlayerGetTransactionsResponse>, IHttpStatusCode4XX<BeamPlayerClient.Model.PlayerBeamErrorResponse>, IHttpStatusCode5XX<BeamPlayerClient.Model.PlayerBeamErrorResponse>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    public sealed partial class PlayerTransactionsApi : IPlayerTransactionsApi
    {
        ...
        partial void FormatCreateUserTransaction(ref string entityId, PlayerCreateTransactionRequestInput playerCreateTransactionRequestInput);
        ...
        /// <param name="playerCreateTransactionRequestInput"></param>
        /// <returns></returns>
        private void ValidateCreateUserTransaction(string entityId, PlayerCreateTransactionRequestInput playerCreateTransactionRequestInput)
        {
            if (entityId == null)
        ...
        /// <param name="entityId"></param>
        /// <param name="playerCreateTransactionRequestInput"></param>
        private void AfterCreateUserTransactionDefaultImplementation(ICreateUserTransactionApiResponse apiResponseLocalVar, string entityId, PlayerCreateTransactionRequestInput playerCreateTransactionRequestInput)
        {
            bool suppressDefaultLog = false;
            AfterCreateUserTransaction(ref suppressDefaultLog, apiResponseLocalVar, entityId, playerCreateTransactionRequestInput);
        ...
        /// <param name="entityId"></param>
        /// <param name="playerCreateTransactionRequestInput"></param>
        partial void AfterCreateUserTransaction(ref bool suppressDefaultLog, ICreateUserTransactionApiResponse apiResponseLocalVar, string entityId, PlayerCreateTransactionRequestInput playerCreateTransactionRequestInput);
        ...
        /// <param name="entityId"></param>
        /// <param name="playerCreateTransactionRequestInput"></param>
        private void OnErrorCreateUserTransactionDefaultImplementation(Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, string entityId, PlayerCreateTransactionRequestInput playerCreateTransactionRequestInput)
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorCreateUserTransaction(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, entityId, playerCreateTransactionRequestInput);
        ...
        /// <param name="entityId"></param>
        /// <param name="playerCreateTransactionRequestInput"></param>
        partial void OnErrorCreateUserTransaction(ref bool suppressDefaultLogLocalVar, Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, string entityId, PlayerCreateTransactionRequestInput playerCreateTransactionRequestInput);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="ICreateUserTransactionApiResponse"/>&gt;</returns>
        public async Task<ICreateUserTransactionApiResponse> CreateUserTransactionOrDefaultAsync(string entityId, PlayerCreateTransactionRequestInput playerCreateTransactionRequestInput, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await CreateUserTransactionAsync(entityId, playerCreateTransactionRequestInput, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="ICreateUserTransactionApiResponse"/>&gt;</returns>
        public async Task<ICreateUserTransactionApiResponse> CreateUserTransactionAsync(string entityId, PlayerCreateTransactionRequestInput playerCreateTransactionRequestInput, System.Threading.CancellationToken cancellationToken = default)
        {
            UriBuilder uriBuilderLocalVar = new UriBuilder();

            try
            {
                ValidateCreateUserTransaction(entityId, playerCreateTransactionRequestInput);

                FormatCreateUserTransaction(ref entityId, playerCreateTransactionRequestInput);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        AfterCreateUserTransactionDefaultImplementation(apiResponseLocalVar, entityId, playerCreateTransactionRequestInput);
            ...
            {
                OnErrorCreateUserTransactionDefaultImplementation(e, "/v1/player/transactions/users/{entityId}", uriBuilderLocalVar.Path, entityId, playerCreateTransactionRequestInput);
        ...
        /// <param name="limit"></param>
        /// <param name="offset"></param>
        private void OnErrorGetTransactionsDefaultImplementation(Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, Option<decimal> limit, Option<decimal> offset)
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorGetTransactions(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, limit, offset);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        /// <param name="limit"></param>
        /// <param name="offset"></param>
        partial void OnErrorGetTransactions(ref bool suppressDefaultLogLocalVar, Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, Option<decimal> limit, Option<decimal> offset);
        ...
        /// <param name="limit"></param>
        /// <param name="offset"></param>
        private void OnErrorGetUserTransactionsDefaultImplementation(Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, string entityId, Option<decimal> limit, Option<decimal> offset)
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorGetUserTransactions(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, entityId, limit, offset);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        /// <param name="limit"></param>
        /// <param name="offset"></param>
        partial void OnErrorGetUserTransactions(ref bool suppressDefaultLogLocalVar, Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, string entityId, Option<decimal> limit, Option<decimal> offset);
