...
namespace BeamPlayerClient.Api
{
    ...
    public interface IPlayerUsersApi : IPlayerApi
    {
        ...
        Task<IUpdateUserApiResponse> UpdateUserAsync(PlayerUpdateUserRequest playerUpdateUserRequest, string entityId, System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IUpdateUserApiResponse"/>?&gt;</returns>
        Task<IUpdateUserApiResponse?> UpdateUserOrDefaultAsync(PlayerUpdateUserRequest playerUpdateUserRequest, string entityId, System.Threading.CancellationToken cancellationToken = default);
    }

    /// <summary>
    /// The <see cref="IGetAllUsersApiResponse"/>
    /// </summary>
    public interface IGetAllUsersApiResponse : BeamPlayerClient.Client.IApiResponse, IOk<BeamPlayerClient.Model.PlayerGetAllUsersResponse?>, ICustomHttpStatusCode4xx<BeamPlayerClient.Model.PlayerBeamErrorResponse?>, ICustomHttpStatusCode5xx<BeamPlayerClient.Model.PlayerBeamErrorResponse?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IGetUserApiResponse : BeamPlayerClient.Client.IApiResponse, IOk<BeamPlayerClient.Model.PlayerGetUserResponse?>, ICustomHttpStatusCode4xx<BeamPlayerClient.Model.PlayerBeamErrorResponse?>, ICustomHttpStatusCode5xx<BeamPlayerClient.Model.PlayerBeamErrorResponse?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IUnlinkUserApiResponse : BeamPlayerClient.Client.IApiResponse, IOk<BeamPlayerClient.Model.PlayerGetUserResponse?>, ICustomHttpStatusCode4xx<BeamPlayerClient.Model.PlayerBeamErrorResponse?>, ICustomHttpStatusCode5xx<BeamPlayerClient.Model.PlayerBeamErrorResponse?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IUpdateUserApiResponse : BeamPlayerClient.Client.IApiResponse, IOk<BeamPlayerClient.Model.PlayerGetUserResponse?>, ICustomHttpStatusCode4xx<BeamPlayerClient.Model.PlayerBeamErrorResponse?>, ICustomHttpStatusCode5xx<BeamPlayerClient.Model.PlayerBeamErrorResponse?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    public sealed partial class PlayerUsersApi : IPlayerUsersApi
    {
        ...
        partial void FormatUpdateUser(PlayerUpdateUserRequest playerUpdateUserRequest, ref string entityId);
        ...
        /// <param name="entityId"></param>
        /// <returns></returns>
        private void ValidateUpdateUser(PlayerUpdateUserRequest playerUpdateUserRequest, string entityId)
        {
        ...
        /// <param name="playerUpdateUserRequest"></param>
        /// <param name="entityId"></param>
        private void AfterUpdateUserDefaultImplementation(IUpdateUserApiResponse apiResponseLocalVar, PlayerUpdateUserRequest playerUpdateUserRequest, string entityId)
        {
            bool suppressDefaultLog = false;
            AfterUpdateUser(ref suppressDefaultLog, apiResponseLocalVar, playerUpdateUserRequest, entityId);
            if (!suppressDefaultLog)
                Logger.LogInformation("{0,-9} | {1} | {3}", (apiResponseLocalVar.DownloadedAt - apiResponseLocalVar.RequestedAt).TotalSeconds, apiResponseLocalVar.StatusCode, apiResponseLocalVar.Path);
        }
        ...
        /// <param name="playerUpdateUserRequest"></param>
        /// <param name="entityId"></param>
        partial void AfterUpdateUser(ref bool suppressDefaultLog, IUpdateUserApiResponse apiResponseLocalVar, PlayerUpdateUserRequest playerUpdateUserRequest, string entityId);
        ...
        /// <param name="playerUpdateUserRequest"></param>
        /// <param name="entityId"></param>
        private void OnErrorUpdateUserDefaultImplementation(Exception exception, string pathFormat, string path, PlayerUpdateUserRequest playerUpdateUserRequest, string entityId)
        {
            bool suppressDefaultLog = false;
            OnErrorUpdateUser(ref suppressDefaultLog, exception, pathFormat, path, playerUpdateUserRequest, entityId);
            if (!suppressDefaultLog)
                Logger.LogError(exception, "An error occurred while sending the request to the server.");
        }
        ...
        /// <param name="playerUpdateUserRequest"></param>
        /// <param name="entityId"></param>
        partial void OnErrorUpdateUser(ref bool suppressDefaultLog, Exception exception, string pathFormat, string path, PlayerUpdateUserRequest playerUpdateUserRequest, string entityId);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IUpdateUserApiResponse"/>&gt;</returns>
        public async Task<IUpdateUserApiResponse?> UpdateUserOrDefaultAsync(PlayerUpdateUserRequest playerUpdateUserRequest, string entityId, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await UpdateUserAsync(playerUpdateUserRequest, entityId, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IUpdateUserApiResponse"/>&gt;</returns>
        public async Task<IUpdateUserApiResponse> UpdateUserAsync(PlayerUpdateUserRequest playerUpdateUserRequest, string entityId, System.Threading.CancellationToken cancellationToken = default)
        {
            UriBuilder uriBuilderLocalVar = new UriBuilder();

            try
            {
                ValidateUpdateUser(playerUpdateUserRequest, entityId);

                FormatUpdateUser(playerUpdateUserRequest, ref entityId);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        AfterUpdateUserDefaultImplementation(apiResponseLocalVar, playerUpdateUserRequest, entityId);
            ...
            {
                OnErrorUpdateUserDefaultImplementation(e, "/v1/player/users/{entityId}", uriBuilderLocalVar.Path, playerUpdateUserRequest, entityId);
