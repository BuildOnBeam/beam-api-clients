...
namespace BeamPlayerClient.Model
{
    ...
    public partial class PlayerGetAssetListingsResponseDataInner : IValidatableObject
    {
        ...
        [JsonConstructor]
        public PlayerGetAssetListingsResponseDataInner(string assetAddress, string assetId, string contractKind, string id, string maker, string side, Option<DateTime?> createdAt = default, Option<DateTime?> expiresAt = default, Option<PlayerGetAssetListingsResponseDataInnerPrice?> price = default, Option<decimal?> quantityFilled = default, Option<decimal?> quantityRemaining = default, Option<StatusEnum?> status = default, Option<DateTime?> updatedAt = default, Option<DateTime?> validFrom = default, Option<DateTime?> validUntil = default)
        {
    ...
    public class PlayerGetAssetListingsResponseDataInnerJsonConverter : JsonConverter<PlayerGetAssetListingsResponseDataInner>
    {
        ...
        public override PlayerGetAssetListingsResponseDataInner Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new PlayerGetAssetListingsResponseDataInner(assetAddress.Value!, assetId.Value!, contractKind.Value!, id.Value!, maker.Value!, side.Value!, createdAt, expiresAt, price, quantityFilled, quantityRemaining, status, updatedAt, validFrom, validUntil);
        }
        ...
        public override void Write(Utf8JsonWriter writer, PlayerGetAssetListingsResponseDataInner playerGetAssetListingsResponseDataInner, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(ref writer, playerGetAssetListingsResponseDataInner, jsonSerializerOptions);
        ...
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(ref Utf8JsonWriter writer, PlayerGetAssetListingsResponseDataInner playerGetAssetListingsResponseDataInner, JsonSerializerOptions jsonSerializerOptions)
        {
