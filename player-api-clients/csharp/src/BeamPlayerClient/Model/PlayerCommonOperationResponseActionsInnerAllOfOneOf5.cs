...
{
    /// <summary>
    /// PlayerCommonOperationResponseActionsInnerAllOfOneOf5
    /// </summary>
    public partial class PlayerCommonOperationResponseActionsInnerAllOfOneOf5 : IValidatableObject
    {
        /// <summary>
    ...
    /// <summary>
    /// A Json converter for type <see cref="PlayerCommonOperationResponseActionsInnerAllOfOneOf5" />
    /// </summary>
    public class PlayerCommonOperationResponseActionsInnerAllOfOneOf5JsonConverter : JsonConverter<PlayerCommonOperationResponseActionsInnerAllOfOneOf5>
    {
        /// <summary>
        /// Deserializes json to <see cref="PlayerCommonOperationResponseActionsInnerAllOfOneOf5" />
        /// </summary>
        ...
        public override PlayerCommonOperationResponseActionsInnerAllOfOneOf5 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "type":
                            ...
                            if (typeRawValue != null)
                                type = new Option<PlayerCommonOperationResponseActionsInnerAllOfOneOf5.TypeEnum?>(PlayerCommonOperationResponseActionsInnerAllOfOneOf5.TypeEnumFromStringOrDefault(typeRawValue));
                            break;
                        default:
                            break;
                    }
        ...
        /// <summary>
        /// Serializes a <see cref="PlayerCommonOperationResponseActionsInnerAllOfOneOf5" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="playerCommonOperationResponseActionsInnerAllOfOneOf5"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, PlayerCommonOperationResponseActionsInnerAllOfOneOf5 playerCommonOperationResponseActionsInnerAllOfOneOf5, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(ref writer, playerCommonOperationResponseActionsInnerAllOfOneOf5, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="PlayerCommonOperationResponseActionsInnerAllOfOneOf5" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="playerCommonOperationResponseActionsInnerAllOfOneOf5"></param>
        /// <param name="jsonSerializerOptions"></param>
