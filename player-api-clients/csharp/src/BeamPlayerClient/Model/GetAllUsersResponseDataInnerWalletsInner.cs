...
namespace BeamPlayerClient.Model
{
    ...
    /// </summary>
    public partial class GetAllUsersResponseDataInnerWalletsInner : IValidatableObject
    {
        /// <summary>
    ...
    /// <summary>
    /// A Json converter for type <see cref="GetAllUsersResponseDataInnerWalletsInner" />
    /// </summary>
    public class GetAllUsersResponseDataInnerWalletsInnerJsonConverter : JsonConverter<GetAllUsersResponseDataInnerWalletsInner>
    {
        ...
        public override GetAllUsersResponseDataInnerWalletsInner Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!address.IsSet)
                throw new ArgumentException("Property is required for class GetAllUsersResponseDataInnerWalletsInner.", nameof(address));
            ...
            if (address.IsSet && address.Value == null)
                throw new ArgumentNullException(nameof(address), "Property is not nullable for class GetAllUsersResponseDataInnerWalletsInner.");
        ...
        /// <summary>
        /// Serializes a <see cref="GetAllUsersResponseDataInnerWalletsInner" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getAllUsersResponseDataInnerWalletsInner"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GetAllUsersResponseDataInnerWalletsInner getAllUsersResponseDataInnerWalletsInner, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(ref writer, getAllUsersResponseDataInnerWalletsInner, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GetAllUsersResponseDataInnerWalletsInner" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getAllUsersResponseDataInnerWalletsInner"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(ref Utf8JsonWriter writer, GetAllUsersResponseDataInnerWalletsInner getAllUsersResponseDataInnerWalletsInner, JsonSerializerOptions jsonSerializerOptions)
        {
            if (getAllUsersResponseDataInnerWalletsInner.Address == null)
                throw new ArgumentNullException(nameof(getAllUsersResponseDataInnerWalletsInner.Address), "Property is required for class GetAllUsersResponseDataInnerWalletsInner.");

            if (getAllUsersResponseDataInnerWalletsInner.ExternalId == null)
                throw new ArgumentNullException(nameof(getAllUsersResponseDataInnerWalletsInner.ExternalId), "Property is required for class GetAllUsersResponseDataInnerWalletsInner.");

            if (getAllUsersResponseDataInnerWalletsInner.Id == null)
                throw new ArgumentNullException(nameof(getAllUsersResponseDataInnerWalletsInner.Id), "Property is required for class GetAllUsersResponseDataInnerWalletsInner.");

            writer.WriteString("address", getAllUsersResponseDataInnerWalletsInner.Address);
