...
namespace BeamPlayerClient.Model
{
    ...
    /// </summary>
    public partial class GetAssetsForContractBodyInput : IValidatableObject
    {
        /// <summary>
    ...
    /// <summary>
    /// A Json converter for type <see cref="GetAssetsForContractBodyInput" />
    /// </summary>
    public class GetAssetsForContractBodyInputJsonConverter : JsonConverter<GetAssetsForContractBodyInput>
    {
        /// <summary>
        /// Deserializes json to <see cref="GetAssetsForContractBodyInput" />
        /// </summary>
        ...
        public override GetAssetsForContractBodyInput Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<GetAssetsForContractBodyInput.SortByEnum?> sortBy = default;
            Option<GetAssetsForContractBodyInput.SortDirectionEnum?> sortDirection = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "sortBy":
                            ...
                            if (sortByRawValue != null)
                                sortBy = new Option<GetAssetsForContractBodyInput.SortByEnum?>(GetAssetsForContractBodyInput.SortByEnumFromStringOrDefault(sortByRawValue));
                            break;
                        case "sortDirection":
                            string? sortDirectionRawValue = utf8JsonReader.GetString();
                            if (sortDirectionRawValue != null)
                                sortDirection = new Option<GetAssetsForContractBodyInput.SortDirectionEnum?>(GetAssetsForContractBodyInput.SortDirectionEnumFromStringOrDefault(sortDirectionRawValue));
                            break;
                        default:
                            break;
                    }
            ...
            if (chainId.IsSet && chainId.Value == null)
                throw new ArgumentNullException(nameof(chainId), "Property is not nullable for class GetAssetsForContractBodyInput.");

            if (limit.IsSet && limit.Value == null)
                throw new ArgumentNullException(nameof(limit), "Property is not nullable for class GetAssetsForContractBodyInput.");

            if (sortBy.IsSet && sortBy.Value == null)
                throw new ArgumentNullException(nameof(sortBy), "Property is not nullable for class GetAssetsForContractBodyInput.");

            if (sortDirection.IsSet && sortDirection.Value == null)
                throw new ArgumentNullException(nameof(sortDirection), "Property is not nullable for class GetAssetsForContractBodyInput.");

            return new GetAssetsForContractBodyInput(attributes, chainId, continuation, includeAttributes, limit, maxFloorAskPrice, maxRarityRank, minFloorAskPrice, minRarityRank, sortBy, sortDirection);
        }

        /// <summary>
        /// Serializes a <see cref="GetAssetsForContractBodyInput" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getAssetsForContractBodyInput"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GetAssetsForContractBodyInput getAssetsForContractBodyInput, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(ref writer, getAssetsForContractBodyInput, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GetAssetsForContractBodyInput" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getAssetsForContractBodyInput"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(ref Utf8JsonWriter writer, GetAssetsForContractBodyInput getAssetsForContractBodyInput, JsonSerializerOptions jsonSerializerOptions)
        {
            if (getAssetsForContractBodyInput.AttributesOption.IsSet)
                if (getAssetsForContractBodyInput.AttributesOption.Value != null)
                {
                    writer.WritePropertyName("attributes");
                    JsonSerializer.Serialize(writer, getAssetsForContractBodyInput.Attributes, jsonSerializerOptions);
                }
                else
                    writer.WriteNull("attributes");
            if (getAssetsForContractBodyInput.ChainIdOption.IsSet)
                writer.WriteNumber("chainId", getAssetsForContractBodyInput.ChainIdOption.Value!.Value);

            if (getAssetsForContractBodyInput.ContinuationOption.IsSet)
                if (getAssetsForContractBodyInput.ContinuationOption.Value != null)
                    writer.WriteString("continuation", getAssetsForContractBodyInput.Continuation);
                else
                    writer.WriteNull("continuation");

            if (getAssetsForContractBodyInput.IncludeAttributesOption.IsSet)
                if (getAssetsForContractBodyInput.IncludeAttributesOption.Value != null)
                    writer.WriteBoolean("includeAttributes", getAssetsForContractBodyInput.IncludeAttributesOption.Value!.Value);
                else
                    writer.WriteNull("includeAttributes");

            if (getAssetsForContractBodyInput.LimitOption.IsSet)
                writer.WriteNumber("limit", getAssetsForContractBodyInput.LimitOption.Value!.Value);

            if (getAssetsForContractBodyInput.MaxFloorAskPriceOption.IsSet)
                if (getAssetsForContractBodyInput.MaxFloorAskPriceOption.Value != null)
                    writer.WriteNumber("maxFloorAskPrice", getAssetsForContractBodyInput.MaxFloorAskPriceOption.Value!.Value);
                else
                    writer.WriteNull("maxFloorAskPrice");

            if (getAssetsForContractBodyInput.MaxRarityRankOption.IsSet)
                if (getAssetsForContractBodyInput.MaxRarityRankOption.Value != null)
                    writer.WriteNumber("maxRarityRank", getAssetsForContractBodyInput.MaxRarityRankOption.Value!.Value);
                else
                    writer.WriteNull("maxRarityRank");

            if (getAssetsForContractBodyInput.MinFloorAskPriceOption.IsSet)
                if (getAssetsForContractBodyInput.MinFloorAskPriceOption.Value != null)
                    writer.WriteNumber("minFloorAskPrice", getAssetsForContractBodyInput.MinFloorAskPriceOption.Value!.Value);
                else
                    writer.WriteNull("minFloorAskPrice");

            if (getAssetsForContractBodyInput.MinRarityRankOption.IsSet)
                if (getAssetsForContractBodyInput.MinRarityRankOption.Value != null)
                    writer.WriteNumber("minRarityRank", getAssetsForContractBodyInput.MinRarityRankOption.Value!.Value);
                else
                    writer.WriteNull("minRarityRank");

            var sortByRawValue = GetAssetsForContractBodyInput.SortByEnumToJsonValue(getAssetsForContractBodyInput.SortByOption.Value!.Value);
            writer.WriteString("sortBy", sortByRawValue);
            var sortDirectionRawValue = GetAssetsForContractBodyInput.SortDirectionEnumToJsonValue(getAssetsForContractBodyInput.SortDirectionOption.Value!.Value);
