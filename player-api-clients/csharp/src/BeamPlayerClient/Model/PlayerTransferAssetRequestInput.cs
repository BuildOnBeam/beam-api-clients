...
namespace BeamPlayerClient.Model
{
    ...
    public partial class PlayerTransferAssetRequestInput : IValidatableObject
    {
        ...
        [JsonConstructor]
        public PlayerTransferAssetRequestInput(List<PlayerTransferAssetRequestInputAssetsInner> assets, Option<long?> chainId = default, Option<OperationProcessingEnum?> operationProcessing = default, Option<bool?> optimistic = default, Option<string?> policyId = default, Option<bool?> sponsor = default)
        {
            Assets = assets;
    ...
    public class PlayerTransferAssetRequestInputJsonConverter : JsonConverter<PlayerTransferAssetRequestInput>
    {
        ...
        public override PlayerTransferAssetRequestInput Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new PlayerTransferAssetRequestInput(assets.Value!, chainId, operationProcessing, optimistic, policyId, sponsor);
        }
