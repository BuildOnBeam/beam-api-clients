...
namespace BeamPlayerClient.Model
{
    ...
    public class PlayerTransferAssetRequestInputJsonConverter : JsonConverter<PlayerTransferAssetRequestInput>
    {
        ...
        public override PlayerTransferAssetRequestInput Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new PlayerTransferAssetRequestInput(assets.Value, optimistic, sponsor, policyId, chainId, operationProcessing, authProvider);
        }
        ...
        public override void Write(Utf8JsonWriter writer, PlayerTransferAssetRequestInput playerTransferAssetRequestInput, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, playerTransferAssetRequestInput, jsonSerializerOptions);
        ...
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, PlayerTransferAssetRequestInput playerTransferAssetRequestInput, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var operationProcessingRawValue = PlayerTransferAssetRequestInput.OperationProcessingEnumToJsonValue(playerTransferAssetRequestInput.OperationProcessingOption.Value);
            if (operationProcessingRawValue != null)
