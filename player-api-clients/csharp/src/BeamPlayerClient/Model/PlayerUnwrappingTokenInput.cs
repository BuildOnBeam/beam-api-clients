...
namespace BeamPlayerClient.Model
{
    ...
    public partial class PlayerUnwrappingTokenInput : IValidatableObject
    {
        ...
        [JsonConstructor]
        public PlayerUnwrappingTokenInput(string amount, Option<long?> chainId = default, Option<string?> operationId = default, Option<OperationProcessingEnum?> operationProcessing = default, Option<bool?> optimistic = default, Option<string?> policyId = default, Option<bool?> sponsor = default)
        {
            Amount = amount;
