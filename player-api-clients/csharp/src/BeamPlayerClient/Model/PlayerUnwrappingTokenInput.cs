...
namespace BeamPlayerClient.Model
{
    ...
    public partial class PlayerUnwrappingTokenInput : IValidatableObject
    {
        ...
        [JsonConstructor]
        public PlayerUnwrappingTokenInput(string amount, Option<long?> chainId = default, Option<OperationProcessingEnum?> operationProcessing = default, Option<bool?> optimistic = default, Option<string?> policyId = default, Option<bool?> sponsor = default)
        {
            Amount = amount;
    ...
    public class PlayerUnwrappingTokenInputJsonConverter : JsonConverter<PlayerUnwrappingTokenInput>
    {
        ...
        public override PlayerUnwrappingTokenInput Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new PlayerUnwrappingTokenInput(amount.Value!, chainId, operationProcessing, optimistic, policyId, sponsor);
        }
