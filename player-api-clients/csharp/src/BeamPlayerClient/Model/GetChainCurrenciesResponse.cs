...
namespace BeamPlayerClient.Model
{
    ...
    /// </summary>
    public partial class GetChainCurrenciesResponse : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public GetChainCurrenciesResponse(List<GetChainCurrenciesResponseDataInner> data)
        {
            Data = data;
            OnCreated();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="GetChainCurrenciesResponse" />
    /// </summary>
    public class GetChainCurrenciesResponseJsonConverter : JsonConverter<GetChainCurrenciesResponse>
    {
        /// <summary>
        /// Deserializes json to <see cref="GetChainCurrenciesResponse" />
        /// </summary>
        ...
        public override GetChainCurrenciesResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
        ...
        /// <summary>
        /// Serializes a <see cref="GetChainCurrenciesResponse" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getChainCurrenciesResponse"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GetChainCurrenciesResponse getChainCurrenciesResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(ref writer, getChainCurrenciesResponse, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GetChainCurrenciesResponse" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getChainCurrenciesResponse"></param>
        /// <param name="jsonSerializerOptions"></param>
