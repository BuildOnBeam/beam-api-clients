...
namespace BeamPlayerClient.Model
{
    ...
    public partial class PlayerCommonUserActivityRequestInput : IValidatableObject
    {
        ...
        [JsonConstructor]
        public PlayerCommonUserActivityRequestInput(Option<long?> chainId = default, Option<string?> continuation = default, Option<decimal?> limit = default, Option<List<PlayerCommonUserActivityRequestInput.TypesEnum>?> types = default)
        {
