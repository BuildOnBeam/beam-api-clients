...
namespace BeamPlayerClient.Model
{
    ...
    public partial class PlayerCommonActivityResponseDataInnerTransaction : IValidatableObject
    {
        ...
        [JsonConstructor]
        public PlayerCommonActivityResponseDataInnerTransaction(Option<string?> from = default, Option<string?> hash = default, Option<decimal?> timestamp = default, Option<string?> to = default)
        {
            FromOption = from;
            HashOption = hash;
    ...
    public class PlayerCommonActivityResponseDataInnerTransactionJsonConverter : JsonConverter<PlayerCommonActivityResponseDataInnerTransaction>
    {
        ...
        public override PlayerCommonActivityResponseDataInnerTransaction Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new PlayerCommonActivityResponseDataInnerTransaction(from, hash, timestamp, to);
        }
        ...
        public override void Write(Utf8JsonWriter writer, PlayerCommonActivityResponseDataInnerTransaction playerCommonActivityResponseDataInnerTransaction, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(ref writer, playerCommonActivityResponseDataInnerTransaction, jsonSerializerOptions);
        ...
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(ref Utf8JsonWriter writer, PlayerCommonActivityResponseDataInnerTransaction playerCommonActivityResponseDataInnerTransaction, JsonSerializerOptions jsonSerializerOptions)
        {
