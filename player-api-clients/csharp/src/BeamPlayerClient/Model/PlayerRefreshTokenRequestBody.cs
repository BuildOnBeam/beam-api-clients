...
namespace BeamPlayerClient.Model
{
    ...
    public partial class PlayerRefreshTokenRequestBody : IValidatableObject
    {
        ...
        [JsonConstructor]
        public PlayerRefreshTokenRequestBody(string assetAddress, string tokenId, Option<long?> chainId = default)
        {
    ...
    public class PlayerRefreshTokenRequestBodyJsonConverter : JsonConverter<PlayerRefreshTokenRequestBody>
    {
        ...
        public override void Write(Utf8JsonWriter writer, PlayerRefreshTokenRequestBody playerRefreshTokenRequestBody, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, playerRefreshTokenRequestBody, jsonSerializerOptions);
        ...
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, PlayerRefreshTokenRequestBody playerRefreshTokenRequestBody, JsonSerializerOptions jsonSerializerOptions)
        {
