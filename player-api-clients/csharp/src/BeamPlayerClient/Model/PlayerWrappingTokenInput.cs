...
namespace BeamPlayerClient.Model
{
    ...
    public partial class PlayerWrappingTokenInput : IValidatableObject
    {
        ...
        [JsonConstructor]
        public PlayerWrappingTokenInput(string amount, Option<long?> chainId = default, Option<OperationProcessingEnum?> operationProcessing = default, Option<bool?> optimistic = default, Option<string?> policyId = default, Option<bool?> sponsor = default)
        {
            Amount = amount;
    ...
    public class PlayerWrappingTokenInputJsonConverter : JsonConverter<PlayerWrappingTokenInput>
    {
        ...
        public override PlayerWrappingTokenInput Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new PlayerWrappingTokenInput(amount.Value!, chainId, operationProcessing, optimistic, policyId, sponsor);
        }
