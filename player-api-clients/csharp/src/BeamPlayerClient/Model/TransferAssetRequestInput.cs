...
namespace BeamPlayerClient.Model
{
    ...
    public partial class TransferAssetRequestInput : IValidatableObject
    {
        ...
        [JsonConstructor]
        public TransferAssetRequestInput(List<TransferAssetRequestInputAssetsInner> assets, Option<decimal?> chainId = default, Option<string?> operationId = default, Option<bool?> optimistic = default, Option<string?> policyId = default, Option<bool?> sponsor = default)
        {
            Assets = assets;
    ...
    public class TransferAssetRequestInputJsonConverter : JsonConverter<TransferAssetRequestInput>
    {
        ...
        public override TransferAssetRequestInput Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new TransferAssetRequestInput(assets.Value!, chainId, operationId, optimistic, policyId, sponsor);
        }
