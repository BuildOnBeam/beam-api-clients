...
namespace BeamPlayerClient.Model
{
    ...
    public partial class TransferAssetRequestInput : IValidatableObject
    {
        ...
        [JsonConstructor]
        public TransferAssetRequestInput(List<TransferAssetRequestInputAssetsInner> assets, Option<decimal?> chainId = default, Option<string?> operationId = default, Option<OperationProcessingEnum?> operationProcessing = default, Option<bool?> optimistic = default, Option<string?> policyId = default, Option<bool?> sponsor = default)
        {
            Assets = assets;
    ...
    public class TransferAssetRequestInputJsonConverter : JsonConverter<TransferAssetRequestInput>
    {
        ...
        public override TransferAssetRequestInput Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<TransferAssetRequestInput.OperationProcessingEnum?> operationProcessing = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "operationProcessing":
                            ...
                            if (operationProcessingRawValue != null)
                                operationProcessing = new Option<TransferAssetRequestInput.OperationProcessingEnum?>(TransferAssetRequestInput.OperationProcessingEnumFromStringOrDefault(operationProcessingRawValue));
                            break;
                        case "optimistic":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
            ...
            if (operationProcessing.IsSet && operationProcessing.Value == null)
                throw new ArgumentNullException(nameof(operationProcessing), "Property is not nullable for class TransferAssetRequestInput.");
            ...
            return new TransferAssetRequestInput(assets.Value!, chainId, operationId, operationProcessing, optimistic, policyId, sponsor);
        }
        ...
        public void WriteProperties(ref Utf8JsonWriter writer, TransferAssetRequestInput transferAssetRequestInput, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (transferAssetRequestInput.OperationIdOption.IsSet)
                if (transferAssetRequestInput.OperationIdOption.Value != null)
                    writer.WriteString("operationId", transferAssetRequestInput.OperationId);
                else
                    writer.WriteNull("operationId");

            var operationProcessingRawValue = TransferAssetRequestInput.OperationProcessingEnumToJsonValue(transferAssetRequestInput.OperationProcessingOption.Value!.Value);
