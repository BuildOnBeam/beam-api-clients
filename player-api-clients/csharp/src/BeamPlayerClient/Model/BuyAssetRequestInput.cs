...
namespace BeamPlayerClient.Model
{
    ...
    public partial class BuyAssetRequestInput : IValidatableObject
    {
        ...
        [JsonConstructor]
        public BuyAssetRequestInput(decimal quantity, Option<decimal?> chainId = default, Option<string?> operationId = default, Option<bool?> optimistic = default, Option<string?> policyId = default, Option<bool?> sponsor = default)
        {
            Quantity = quantity;
    ...
    public class BuyAssetRequestInputJsonConverter : JsonConverter<BuyAssetRequestInput>
    {
        ...
        public override BuyAssetRequestInput Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new BuyAssetRequestInput(quantity.Value!.Value!, chainId, operationId, optimistic, policyId, sponsor);
        }
