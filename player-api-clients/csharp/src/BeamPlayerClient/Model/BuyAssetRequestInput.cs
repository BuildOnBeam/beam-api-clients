...
namespace BeamPlayerClient.Model
{
    ...
    /// </summary>
    public partial class BuyAssetRequestInput : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public BuyAssetRequestInput(decimal quantity, Option<decimal?> chainId = default, Option<string?> operationId = default, Option<OperationProcessingEnum?> operationProcessing = default, Option<bool?> optimistic = default, Option<string?> policyId = default, Option<bool?> sponsor = default)
        {
            Quantity = quantity;
    ...
    /// <summary>
    /// A Json converter for type <see cref="BuyAssetRequestInput" />
    /// </summary>
    public class BuyAssetRequestInputJsonConverter : JsonConverter<BuyAssetRequestInput>
    {
        /// <summary>
        /// Deserializes json to <see cref="BuyAssetRequestInput" />
        /// </summary>
        ...
        public override BuyAssetRequestInput Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<BuyAssetRequestInput.OperationProcessingEnum?> operationProcessing = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "operationProcessing":
                            ...
                            if (operationProcessingRawValue != null)
                                operationProcessing = new Option<BuyAssetRequestInput.OperationProcessingEnum?>(BuyAssetRequestInput.OperationProcessingEnumFromStringOrDefault(operationProcessingRawValue));
                            break;
                        case "optimistic":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
            ...
            if (!quantity.IsSet)
                throw new ArgumentException("Property is required for class BuyAssetRequestInput.", nameof(quantity));

            if (quantity.IsSet && quantity.Value == null)
                throw new ArgumentNullException(nameof(quantity), "Property is not nullable for class BuyAssetRequestInput.");

            if (chainId.IsSet && chainId.Value == null)
                throw new ArgumentNullException(nameof(chainId), "Property is not nullable for class BuyAssetRequestInput.");

            if (operationProcessing.IsSet && operationProcessing.Value == null)
                throw new ArgumentNullException(nameof(operationProcessing), "Property is not nullable for class BuyAssetRequestInput.");
            ...
            return new BuyAssetRequestInput(quantity.Value!.Value!, chainId, operationId, operationProcessing, optimistic, policyId, sponsor);
        }

        /// <summary>
        /// Serializes a <see cref="BuyAssetRequestInput" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="buyAssetRequestInput"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, BuyAssetRequestInput buyAssetRequestInput, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(ref writer, buyAssetRequestInput, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="BuyAssetRequestInput" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="buyAssetRequestInput"></param>
        /// <param name="jsonSerializerOptions"></param>
        ...
        public void WriteProperties(ref Utf8JsonWriter writer, BuyAssetRequestInput buyAssetRequestInput, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (buyAssetRequestInput.ChainIdOption.IsSet)
                writer.WriteNumber("chainId", buyAssetRequestInput.ChainIdOption.Value!.Value);

            if (buyAssetRequestInput.OperationIdOption.IsSet)
                if (buyAssetRequestInput.OperationIdOption.Value != null)
                    writer.WriteString("operationId", buyAssetRequestInput.OperationId);
                else
                    writer.WriteNull("operationId");

            var operationProcessingRawValue = BuyAssetRequestInput.OperationProcessingEnumToJsonValue(buyAssetRequestInput.OperationProcessingOption.Value!.Value);
