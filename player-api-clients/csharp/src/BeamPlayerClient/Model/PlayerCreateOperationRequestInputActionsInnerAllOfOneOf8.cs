...
{
    /// <summary>
    /// PlayerCreateOperationRequestInputActionsInnerAllOfOneOf8
    /// </summary>
    public partial class PlayerCreateOperationRequestInputActionsInnerAllOfOneOf8 : IValidatableObject
    {
        /// <summary>
    ...
    /// <summary>
    /// A Json converter for type <see cref="PlayerCreateOperationRequestInputActionsInnerAllOfOneOf8" />
    /// </summary>
    public class PlayerCreateOperationRequestInputActionsInnerAllOfOneOf8JsonConverter : JsonConverter<PlayerCreateOperationRequestInputActionsInnerAllOfOneOf8>
    {
        /// <summary>
        /// Deserializes json to <see cref="PlayerCreateOperationRequestInputActionsInnerAllOfOneOf8" />
        /// </summary>
        ...
        public override PlayerCreateOperationRequestInputActionsInnerAllOfOneOf8 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "type":
                            ...
                            if (typeRawValue != null)
                                type = new Option<PlayerCreateOperationRequestInputActionsInnerAllOfOneOf8.TypeEnum?>(PlayerCreateOperationRequestInputActionsInnerAllOfOneOf8.TypeEnumFromStringOrDefault(typeRawValue));
                            break;
                        default:
                            break;
                    }
            ...
            if (!transaction.IsSet)
                throw new ArgumentException("Property is required for class PlayerCreateOperationRequestInputActionsInnerAllOfOneOf8.", nameof(transaction));
            ...
            if (transaction.IsSet && transaction.Value == null)
                throw new ArgumentNullException(nameof(transaction), "Property is not nullable for class PlayerCreateOperationRequestInputActionsInnerAllOfOneOf8.");
        ...
        /// <summary>
        /// Serializes a <see cref="PlayerCreateOperationRequestInputActionsInnerAllOfOneOf8" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="playerCreateOperationRequestInputActionsInnerAllOfOneOf8"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, PlayerCreateOperationRequestInputActionsInnerAllOfOneOf8 playerCreateOperationRequestInputActionsInnerAllOfOneOf8, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(ref writer, playerCreateOperationRequestInputActionsInnerAllOfOneOf8, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="PlayerCreateOperationRequestInputActionsInnerAllOfOneOf8" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="playerCreateOperationRequestInputActionsInnerAllOfOneOf8"></param>
        /// <param name="jsonSerializerOptions"></param>
        ...
        public void WriteProperties(ref Utf8JsonWriter writer, PlayerCreateOperationRequestInputActionsInnerAllOfOneOf8 playerCreateOperationRequestInputActionsInnerAllOfOneOf8, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            JsonSerializer.Serialize(writer, playerCreateOperationRequestInputActionsInnerAllOfOneOf8.Transaction, jsonSerializerOptions);
            var typeRawValue = PlayerCreateOperationRequestInputActionsInnerAllOfOneOf8.TypeEnumToJsonValue(playerCreateOperationRequestInputActionsInnerAllOfOneOf8.Type);
