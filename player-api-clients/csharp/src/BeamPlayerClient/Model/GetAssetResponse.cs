...
namespace BeamPlayerClient.Model
{
    ...
    public partial class GetAssetResponse : IValidatableObject
    {
        ...
        [JsonConstructor]
        public GetAssetResponse(string assetAddress, string assetId, string assetType, string imageUrl, string name, decimal supply, Option<List<GetAssetsForUserResponseDataInnerAttributesInner>?> attributes = default, Option<decimal?> chainId = default, List<GetAssetResponseOwnersInner>? owners = default, Option<RarityEnum?> rarity = default, Option<decimal?> rarityScore = default)
        {
    ...
    public class GetAssetResponseJsonConverter : JsonConverter<GetAssetResponse>
    {
        ...
        public override GetAssetResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<GetAssetResponseOwnersInner>?> owners = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "owners":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                owners = new Option<List<GetAssetResponseOwnersInner>?>(JsonSerializer.Deserialize<List<GetAssetResponseOwnersInner>>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "rarity":
            ...
            if (!assetAddress.IsSet)
                throw new ArgumentException("Property is required for class GetAssetResponse.", nameof(assetAddress));

            if (!assetId.IsSet)
                throw new ArgumentException("Property is required for class GetAssetResponse.", nameof(assetId));

            if (!assetType.IsSet)
                throw new ArgumentException("Property is required for class GetAssetResponse.", nameof(assetType));

            if (!imageUrl.IsSet)
                throw new ArgumentException("Property is required for class GetAssetResponse.", nameof(imageUrl));

            if (!name.IsSet)
                throw new ArgumentException("Property is required for class GetAssetResponse.", nameof(name));

            if (!supply.IsSet)
                throw new ArgumentException("Property is required for class GetAssetResponse.", nameof(supply));

            if (!owners.IsSet)
                throw new ArgumentException("Property is required for class GetAssetResponse.", nameof(owners));

            if (assetAddress.IsSet && assetAddress.Value == null)
                throw new ArgumentNullException(nameof(assetAddress), "Property is not nullable for class GetAssetResponse.");

            if (assetId.IsSet && assetId.Value == null)
                throw new ArgumentNullException(nameof(assetId), "Property is not nullable for class GetAssetResponse.");

            if (assetType.IsSet && assetType.Value == null)
                throw new ArgumentNullException(nameof(assetType), "Property is not nullable for class GetAssetResponse.");

            if (imageUrl.IsSet && imageUrl.Value == null)
                throw new ArgumentNullException(nameof(imageUrl), "Property is not nullable for class GetAssetResponse.");
            ...
            if (supply.IsSet && supply.Value == null)
                throw new ArgumentNullException(nameof(supply), "Property is not nullable for class GetAssetResponse.");

            if (chainId.IsSet && chainId.Value == null)
                throw new ArgumentNullException(nameof(chainId), "Property is not nullable for class GetAssetResponse.");

            return new GetAssetResponse(assetAddress.Value!, assetId.Value!, assetType.Value!, imageUrl.Value!, name.Value!, supply.Value!.Value!, attributes, chainId, owners.Value!, rarity, rarityScore);
        }
        ...
        {
            if (getAssetResponse.AssetAddress == null)
                throw new ArgumentNullException(nameof(getAssetResponse.AssetAddress), "Property is required for class GetAssetResponse.");

            if (getAssetResponse.AssetId == null)
                throw new ArgumentNullException(nameof(getAssetResponse.AssetId), "Property is required for class GetAssetResponse.");

            if (getAssetResponse.AssetType == null)
                throw new ArgumentNullException(nameof(getAssetResponse.AssetType), "Property is required for class GetAssetResponse.");

            if (getAssetResponse.ImageUrl == null)
                throw new ArgumentNullException(nameof(getAssetResponse.ImageUrl), "Property is required for class GetAssetResponse.");
            ...
            writer.WriteString("assetAddress", getAssetResponse.AssetAddress);

            writer.WriteString("assetId", getAssetResponse.AssetId);

            writer.WriteString("assetType", getAssetResponse.AssetType);

            writer.WriteString("imageUrl", getAssetResponse.ImageUrl);

            writer.WriteString("name", getAssetResponse.Name);

            writer.WriteNumber("supply", getAssetResponse.Supply);
            ...
            if (getAssetResponse.ChainIdOption.IsSet)
                writer.WriteNumber("chainId", getAssetResponse.ChainIdOption.Value!.Value);

            if (getAssetResponse.Owners != null)
            {
                writer.WritePropertyName("owners");
                JsonSerializer.Serialize(writer, getAssetResponse.Owners, jsonSerializerOptions);
            }
            else
