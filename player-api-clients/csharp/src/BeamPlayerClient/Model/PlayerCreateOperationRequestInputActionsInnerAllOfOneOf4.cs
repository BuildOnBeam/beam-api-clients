...
namespace BeamPlayerClient.Model
{
    ...
    public partial class PlayerCreateOperationRequestInputActionsInnerAllOfOneOf4 : IValidatableObject
    {
        ...
        [JsonConstructor]
        public PlayerCreateOperationRequestInputActionsInnerAllOfOneOf4(PlayerCommonOperationResponseActionsInnerAllOfOneOf3Context context, PlayerCreateOperationRequestInputActionsInnerAllOfOneOfSignature signature, PlayerCreateOperationRequestInputActionsInnerAllOfOneOfTransaction transaction, TypeEnum type)
        {
            Context = context;
            Signature = signature;
    ...
    public class PlayerCreateOperationRequestInputActionsInnerAllOfOneOf4JsonConverter : JsonConverter<PlayerCreateOperationRequestInputActionsInnerAllOfOneOf4>
    {
        ...
        public override PlayerCreateOperationRequestInputActionsInnerAllOfOneOf4 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!context.IsSet)
                throw new ArgumentException("Property is required for class PlayerCreateOperationRequestInputActionsInnerAllOfOneOf4.", nameof(context));
            ...
            if (context.IsSet && context.Value == null)
                throw new ArgumentNullException(nameof(context), "Property is not nullable for class PlayerCreateOperationRequestInputActionsInnerAllOfOneOf4.");
            ...
            return new PlayerCreateOperationRequestInputActionsInnerAllOfOneOf4(context.Value!, signature.Value!, transaction.Value!, type.Value!.Value!);
        }
        ...
        {
            if (playerCreateOperationRequestInputActionsInnerAllOfOneOf4.Context == null)
                throw new ArgumentNullException(nameof(playerCreateOperationRequestInputActionsInnerAllOfOneOf4.Context), "Property is required for class PlayerCreateOperationRequestInputActionsInnerAllOfOneOf4.");
            ...
            JsonSerializer.Serialize(writer, playerCreateOperationRequestInputActionsInnerAllOfOneOf4.Context, jsonSerializerOptions);
