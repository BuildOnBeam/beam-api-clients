...
namespace BeamPlayerClient.Model
{
    ...
    public class TransferTokenRequestInputJsonConverter : JsonConverter<TransferTokenRequestInput>
    {
        ...
        public override TransferTokenRequestInput Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<TransferTokenRequestInput.OperationProcessingEnum?> operationProcessing = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "operationProcessing":
                            ...
                            if (operationProcessingRawValue != null)
                                operationProcessing = new Option<TransferTokenRequestInput.OperationProcessingEnum?>(TransferTokenRequestInput.OperationProcessingEnumFromStringOrDefault(operationProcessingRawValue));
                            break;
                        case "optimistic":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
            ...
            if (operationProcessing.IsSet && operationProcessing.Value == null)
                throw new ArgumentNullException(nameof(operationProcessing), "Property is not nullable for class TransferTokenRequestInput.");
            ...
            return new TransferTokenRequestInput(amountToTransfer.Value!, assetAddress.Value!, chainId, operationId, operationProcessing, optimistic, policyId, receiverEntityId, receiverWalletAddress, sponsor);
        }
        ...
        public void WriteProperties(ref Utf8JsonWriter writer, TransferTokenRequestInput transferTokenRequestInput, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var operationProcessingRawValue = TransferTokenRequestInput.OperationProcessingEnumToJsonValue(transferTokenRequestInput.OperationProcessingOption.Value!.Value);
