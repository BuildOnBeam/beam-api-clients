...
namespace BeamPlayerClient.Model
{
    ...
    public partial class PlayerGetAssetsForUserBodyInput : IValidatableObject
    {
        ...
        [JsonConstructor]
        public PlayerGetAssetsForUserBodyInput(Option<SortDirectionEnum?> sortDirection = default, Option<SortByEnum?> sortBy = default, Option<string> contract = default, Option<bool?> includeAttributes = default, Option<string> continuation = default, Option<long?> chainId = default, Option<decimal?> limit = default)
        {
    ...
    public class PlayerGetAssetsForUserBodyInputJsonConverter : JsonConverter<PlayerGetAssetsForUserBodyInput>
    {
        ...
        public override PlayerGetAssetsForUserBodyInput Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new PlayerGetAssetsForUserBodyInput(sortDirection, sortBy, contract, includeAttributes, continuation, chainId, limit);
        }
        ...
        public override void Write(Utf8JsonWriter writer, PlayerGetAssetsForUserBodyInput playerGetAssetsForUserBodyInput, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, playerGetAssetsForUserBodyInput, jsonSerializerOptions);
        ...
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, PlayerGetAssetsForUserBodyInput playerGetAssetsForUserBodyInput, JsonSerializerOptions jsonSerializerOptions)
        {
            var sortDirectionRawValue = PlayerGetAssetsForUserBodyInput.SortDirectionEnumToJsonValue(playerGetAssetsForUserBodyInput.SortDirectionOption.Value);
            if (sortDirectionRawValue != null)
                writer.WriteString("sortDirection", sortDirectionRawValue);
            var sortByRawValue = PlayerGetAssetsForUserBodyInput.SortByEnumToJsonValue(playerGetAssetsForUserBodyInput.SortByOption.Value);
            if (sortByRawValue != null)
