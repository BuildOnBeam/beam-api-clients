...
namespace BeamPlayerClient.Model
{
    ...
    public partial class PlayerGetAssetsForUserBodyInput : IValidatableObject
    {
        ...
        [JsonConstructor]
        public PlayerGetAssetsForUserBodyInput(Option<long?> chainId = default, Option<string?> continuation = default, Option<string?> contract = default, Option<bool?> includeAttributes = default, Option<decimal?> limit = default, Option<SortByEnum?> sortBy = default, Option<SortDirectionEnum?> sortDirection = default)
        {
