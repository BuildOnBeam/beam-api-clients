...
namespace BeamPlayerClient.Model
{
    ...
    public class PlayerGetAssetsForContractBodyInputJsonConverter : JsonConverter<PlayerGetAssetsForContractBodyInput>
    {
        ...
        public override PlayerGetAssetsForContractBodyInput Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new PlayerGetAssetsForContractBodyInput(attributes, chainId, continuation, includeAttributes, limit, maxFloorAskPrice, maxRarityRank, minFloorAskPrice, minRarityRank, sortBy, sortDirection);
        }
        ...
        public override void Write(Utf8JsonWriter writer, PlayerGetAssetsForContractBodyInput playerGetAssetsForContractBodyInput, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(ref writer, playerGetAssetsForContractBodyInput, jsonSerializerOptions);
        ...
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(ref Utf8JsonWriter writer, PlayerGetAssetsForContractBodyInput playerGetAssetsForContractBodyInput, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var sortByRawValue = PlayerGetAssetsForContractBodyInput.SortByEnumToJsonValue(playerGetAssetsForContractBodyInput.SortByOption.Value!.Value);
            writer.WriteString("sortBy", sortByRawValue);
            var sortDirectionRawValue = PlayerGetAssetsForContractBodyInput.SortDirectionEnumToJsonValue(playerGetAssetsForContractBodyInput.SortDirectionOption.Value!.Value);
