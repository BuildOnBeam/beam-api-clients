...
namespace BeamPlayerClient.Model
{
    ...
    public partial class PlayerGetOwnerAssetsBodyInput : IValidatableObject
    {
        ...
        [JsonConstructor]
        public PlayerGetOwnerAssetsBodyInput(Option<long?> chainId = default, Option<string?> continuation = default, Option<bool?> includeAttributes = default, Option<decimal?> limit = default, Option<SortByEnum?> sortBy = default, Option<SortDirectionEnum?> sortDirection = default)
        {
