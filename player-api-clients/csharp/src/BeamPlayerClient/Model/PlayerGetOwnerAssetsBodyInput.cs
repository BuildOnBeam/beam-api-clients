...
namespace BeamPlayerClient.Model
{
    ...
    public partial class PlayerGetOwnerAssetsBodyInput : IValidatableObject
    {
        ...
        [JsonConstructor]
        public PlayerGetOwnerAssetsBodyInput(Option<decimal?> chainId = default, Option<string?> continuation = default, Option<bool?> includeAttributes = default, Option<decimal?> limit = default, Option<SortByEnum?> sortBy = default, Option<SortDirectionEnum?> sortDirection = default)
        {
    ...
    public class PlayerGetOwnerAssetsBodyInputJsonConverter : JsonConverter<PlayerGetOwnerAssetsBodyInput>
    {
        ...
        public override PlayerGetOwnerAssetsBodyInput Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new PlayerGetOwnerAssetsBodyInput(chainId, continuation, includeAttributes, limit, sortBy, sortDirection);
        }
        ...
        public override void Write(Utf8JsonWriter writer, PlayerGetOwnerAssetsBodyInput playerGetOwnerAssetsBodyInput, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(ref writer, playerGetOwnerAssetsBodyInput, jsonSerializerOptions);
        ...
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(ref Utf8JsonWriter writer, PlayerGetOwnerAssetsBodyInput playerGetOwnerAssetsBodyInput, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var sortByRawValue = PlayerGetOwnerAssetsBodyInput.SortByEnumToJsonValue(playerGetOwnerAssetsBodyInput.SortByOption.Value!.Value);
            writer.WriteString("sortBy", sortByRawValue);
            var sortDirectionRawValue = PlayerGetOwnerAssetsBodyInput.SortDirectionEnumToJsonValue(playerGetOwnerAssetsBodyInput.SortDirectionOption.Value!.Value);
