...
namespace BeamPlayerClient.Model
{
    ...
    public class PlayerTransferTokenRequestInputJsonConverter : JsonConverter<PlayerTransferTokenRequestInput>
    {
        ...
        public override PlayerTransferTokenRequestInput Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<PlayerTransferTokenRequestInput.AuthProviderEnum?> authProvider = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "authProvider":
                            ...
                            if (authProviderRawValue != null)
                                authProvider = new Option<PlayerTransferTokenRequestInput.AuthProviderEnum?>(PlayerTransferTokenRequestInput.AuthProviderEnumFromStringOrDefault(authProviderRawValue));
                            break;
                        default:
                            break;
                    }
            ...
            return new PlayerTransferTokenRequestInput(assetAddress.Value, amountToTransfer.Value, receiverEntityId, receiverWalletAddress, optimistic, sponsor, policyId, chainId, operationProcessing, authProvider);
        }
        ...
        public override void Write(Utf8JsonWriter writer, PlayerTransferTokenRequestInput playerTransferTokenRequestInput, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, playerTransferTokenRequestInput, jsonSerializerOptions);
        ...
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, PlayerTransferTokenRequestInput playerTransferTokenRequestInput, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var operationProcessingRawValue = PlayerTransferTokenRequestInput.OperationProcessingEnumToJsonValue(playerTransferTokenRequestInput.OperationProcessingOption.Value);
            if (operationProcessingRawValue != null)
                writer.WriteString("operationProcessing", operationProcessingRawValue);
            var authProviderRawValue = PlayerTransferTokenRequestInput.AuthProviderEnumToJsonValue(playerTransferTokenRequestInput.AuthProviderOption.Value.Value);
            if (authProviderRawValue != null)
