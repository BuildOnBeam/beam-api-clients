...
namespace BeamPlayerClient.Model
{
    ...
    public class PlayerTransferTokenRequestInputJsonConverter : JsonConverter<PlayerTransferTokenRequestInput>
    {
        ...
        public override PlayerTransferTokenRequestInput Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new PlayerTransferTokenRequestInput(amountToTransfer.Value!, assetAddress.Value!, authProvider, chainId, operationProcessing, optimistic, policyId, receiverEntityId, receiverWalletAddress, sponsor);
        }
