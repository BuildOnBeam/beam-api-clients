...
namespace BeamPlayerClient.Model
{
    ...
    public partial class Check503Response : IValidatableObject
    {
        ...
        [JsonConstructor]
        public Check503Response(Option<Dictionary<string, Check200ResponseInfoValue>?> details = default, Option<Dictionary<string, Check200ResponseInfoValue>?> error = default, Option<Dictionary<string, Check200ResponseInfoValue>?> info = default, Option<string?> status = default)
        {
    ...
    public class Check503ResponseJsonConverter : JsonConverter<Check503Response>
    {
        ...
        public override Check503Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new Check503Response(details, error, info, status);
        }
