...
namespace BeamPlayerClient.Model
{
    ...
    public class CreateTransactionRequestInputJsonConverter : JsonConverter<CreateTransactionRequestInput>
    {
        ...
        public override CreateTransactionRequestInput Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<CreateTransactionRequestInput.OperationProcessingEnum?> operationProcessing = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "operationProcessing":
                            ...
                            if (operationProcessingRawValue != null)
                                operationProcessing = new Option<CreateTransactionRequestInput.OperationProcessingEnum?>(CreateTransactionRequestInput.OperationProcessingEnumFromStringOrDefault(operationProcessingRawValue));
                            break;
                        case "optimistic":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
            ...
            if (operationProcessing.IsSet && operationProcessing.Value == null)
                throw new ArgumentNullException(nameof(operationProcessing), "Property is not nullable for class CreateTransactionRequestInput.");
            ...
            return new CreateTransactionRequestInput(interactions.Value!, chainId, operationId, operationProcessing, optimistic, policyId, sponsor);
        }
        ...
        public void WriteProperties(ref Utf8JsonWriter writer, CreateTransactionRequestInput createTransactionRequestInput, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (createTransactionRequestInput.OperationIdOption.IsSet)
                if (createTransactionRequestInput.OperationIdOption.Value != null)
                    writer.WriteString("operationId", createTransactionRequestInput.OperationId);
                else
                    writer.WriteNull("operationId");

            var operationProcessingRawValue = CreateTransactionRequestInput.OperationProcessingEnumToJsonValue(createTransactionRequestInput.OperationProcessingOption.Value!.Value);
