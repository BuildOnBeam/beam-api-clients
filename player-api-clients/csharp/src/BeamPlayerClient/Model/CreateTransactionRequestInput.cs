...
namespace BeamPlayerClient.Model
{
    ...
    public partial class CreateTransactionRequestInput : IValidatableObject
    {
        ...
        [JsonConstructor]
        public CreateTransactionRequestInput(List<CreateTransactionRequestInputInteractionsInner> interactions, Option<decimal?> chainId = default, Option<string?> operationId = default, Option<bool?> optimistic = default, Option<string?> policyId = default, Option<bool?> sponsor = default)
        {
    ...
    public class CreateTransactionRequestInputJsonConverter : JsonConverter<CreateTransactionRequestInput>
    {
        ...
        public override CreateTransactionRequestInput Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new CreateTransactionRequestInput(interactions.Value!, chainId, operationId, optimistic, policyId, sponsor);
        }
