...
namespace BeamPlayerClient.Model
{
    ...
    public partial class PlayerAcceptAssetOfferRequestInput : IValidatableObject
    {
        ...
        [JsonConstructor]
        public PlayerAcceptAssetOfferRequestInput(decimal quantity, Option<decimal?> chainId = default, Option<string?> operationId = default, Option<OperationProcessingEnum?> operationProcessing = default, Option<bool?> optimistic = default, Option<string?> policyId = default, Option<bool?> sponsor = default)
        {
            Quantity = quantity;
    ...
    public class PlayerAcceptAssetOfferRequestInputJsonConverter : JsonConverter<PlayerAcceptAssetOfferRequestInput>
    {
        ...
        public override PlayerAcceptAssetOfferRequestInput Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new PlayerAcceptAssetOfferRequestInput(quantity.Value!.Value!, chainId, operationId, operationProcessing, optimistic, policyId, sponsor);
        }
        ...
        public void WriteProperties(ref Utf8JsonWriter writer, PlayerAcceptAssetOfferRequestInput playerAcceptAssetOfferRequestInput, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (playerAcceptAssetOfferRequestInput.OperationIdOption.IsSet)
                if (playerAcceptAssetOfferRequestInput.OperationIdOption.Value != null)
                    writer.WriteString("operationId", playerAcceptAssetOfferRequestInput.OperationId);
                else
