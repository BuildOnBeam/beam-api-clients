...
{
    /// <summary>
    /// PlayerTransferMultipleNativeTokensRequestInput
    /// </summary>
    public partial class PlayerTransferMultipleNativeTokensRequestInput : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PlayerTransferMultipleNativeTokensRequestInput" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public PlayerTransferMultipleNativeTokensRequestInput(List<PlayerTransferMultipleNativeTokensRequestInputTransfersInner> transfers, Option<bool?> optimistic = default, Option<bool?> sponsor = default, Option<string> policyId = default, Option<long?> chainId = default, Option<OperationProcessingEnum?> operationProcessing = default, Option<AuthProviderEnum?> authProvider = default)
        {
            Transfers = transfers;
        ...
        public List<PlayerTransferMultipleNativeTokensRequestInputTransfersInner> Transfers { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PlayerTransferMultipleNativeTokensRequestInput {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="PlayerTransferMultipleNativeTokensRequestInput" />
    /// </summary>
    public class PlayerTransferMultipleNativeTokensRequestInputJsonConverter : JsonConverter<PlayerTransferMultipleNativeTokensRequestInput>
    {
        /// <summary>
        /// Deserializes json to <see cref="PlayerTransferMultipleNativeTokensRequestInput" />
        /// </summary>
        ...
        public override PlayerTransferMultipleNativeTokensRequestInput Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<PlayerTransferMultipleNativeTokensRequestInputTransfersInner>> transfers = default;
            Option<bool?> optimistic = default;
            Option<bool?> sponsor = default;
            Option<string> policyId = default;
            Option<long?> chainId = default;
            Option<PlayerTransferMultipleNativeTokensRequestInput.OperationProcessingEnum?> operationProcessing = default;
            Option<PlayerTransferMultipleNativeTokensRequestInput.AuthProviderEnum?> authProvider = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "transfers":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                transfers = new Option<List<PlayerTransferMultipleNativeTokensRequestInputTransfersInner>>(JsonSerializer.Deserialize<List<PlayerTransferMultipleNativeTokensRequestInputTransfersInner>>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "optimistic":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                        ...
                        case "operationProcessing":
                            ...
                            if (operationProcessingRawValue != null)
                                operationProcessing = new Option<PlayerTransferMultipleNativeTokensRequestInput.OperationProcessingEnum?>(PlayerTransferMultipleNativeTokensRequestInput.OperationProcessingEnumFromStringOrDefault(operationProcessingRawValue));
                            break;
                        case "authProvider":
                            string authProviderRawValue = utf8JsonReader.GetString();
                            if (authProviderRawValue != null)
                                authProvider = new Option<PlayerTransferMultipleNativeTokensRequestInput.AuthProviderEnum?>(PlayerTransferMultipleNativeTokensRequestInput.AuthProviderEnumFromStringOrDefault(authProviderRawValue));
                            break;
                        default:
                            break;
                    }
            ...
            if (!transfers.IsSet)
                throw new ArgumentException("Property is required for class PlayerTransferMultipleNativeTokensRequestInput.", nameof(transfers));

            if (transfers.IsSet && transfers.Value == null)
                throw new ArgumentNullException(nameof(transfers), "Property is not nullable for class PlayerTransferMultipleNativeTokensRequestInput.");

            if (optimistic.IsSet && optimistic.Value == null)
                throw new ArgumentNullException(nameof(optimistic), "Property is not nullable for class PlayerTransferMultipleNativeTokensRequestInput.");

            if (sponsor.IsSet && sponsor.Value == null)
                throw new ArgumentNullException(nameof(sponsor), "Property is not nullable for class PlayerTransferMultipleNativeTokensRequestInput.");

            if (chainId.IsSet && chainId.Value == null)
                throw new ArgumentNullException(nameof(chainId), "Property is not nullable for class PlayerTransferMultipleNativeTokensRequestInput.");

            if (operationProcessing.IsSet && operationProcessing.Value == null)
                throw new ArgumentNullException(nameof(operationProcessing), "Property is not nullable for class PlayerTransferMultipleNativeTokensRequestInput.");

            return new PlayerTransferMultipleNativeTokensRequestInput(transfers.Value, optimistic, sponsor, policyId, chainId, operationProcessing, authProvider);
        }

        /// <summary>
        /// Serializes a <see cref="PlayerTransferMultipleNativeTokensRequestInput" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="playerTransferMultipleNativeTokensRequestInput"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, PlayerTransferMultipleNativeTokensRequestInput playerTransferMultipleNativeTokensRequestInput, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, playerTransferMultipleNativeTokensRequestInput, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="PlayerTransferMultipleNativeTokensRequestInput" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="playerTransferMultipleNativeTokensRequestInput"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, PlayerTransferMultipleNativeTokensRequestInput playerTransferMultipleNativeTokensRequestInput, JsonSerializerOptions jsonSerializerOptions)
        {
            if (playerTransferMultipleNativeTokensRequestInput.Transfers == null)
                throw new ArgumentNullException(nameof(playerTransferMultipleNativeTokensRequestInput.Transfers), "Property is required for class PlayerTransferMultipleNativeTokensRequestInput.");

            writer.WritePropertyName("transfers");
            JsonSerializer.Serialize(writer, playerTransferMultipleNativeTokensRequestInput.Transfers, jsonSerializerOptions);
            if (playerTransferMultipleNativeTokensRequestInput.OptimisticOption.IsSet)
            {
                writer.WriteBoolean("optimistic", playerTransferMultipleNativeTokensRequestInput.OptimisticOption.Value.Value);
            }

            if (playerTransferMultipleNativeTokensRequestInput.SponsorOption.IsSet)
            {
                writer.WriteBoolean("sponsor", playerTransferMultipleNativeTokensRequestInput.SponsorOption.Value.Value);
            }

            if (playerTransferMultipleNativeTokensRequestInput.PolicyIdOption.IsSet)
            {
                if (playerTransferMultipleNativeTokensRequestInput.PolicyIdOption.Value != null)
                {
                    writer.WriteString("policyId", playerTransferMultipleNativeTokensRequestInput.PolicyId);
                }
                else
                {
            ...
            if (playerTransferMultipleNativeTokensRequestInput.ChainIdOption.IsSet)
            {
                writer.WriteNumber("chainId", playerTransferMultipleNativeTokensRequestInput.ChainIdOption.Value.Value);
            }

            var operationProcessingRawValue = PlayerTransferMultipleNativeTokensRequestInput.OperationProcessingEnumToJsonValue(playerTransferMultipleNativeTokensRequestInput.OperationProcessingOption.Value);
            if (operationProcessingRawValue != null)
                writer.WriteString("operationProcessing", operationProcessingRawValue);
            var authProviderRawValue = PlayerTransferMultipleNativeTokensRequestInput.AuthProviderEnumToJsonValue(playerTransferMultipleNativeTokensRequestInput.AuthProviderOption.Value.Value);
            if (authProviderRawValue != null)
