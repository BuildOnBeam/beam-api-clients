...
namespace BeamPlayerClient.Model
{
    ...
    public partial class PlayerSellAssetRequestInput : IValidatableObject
    {
        ...
        [JsonConstructor]
        public PlayerSellAssetRequestInput(string assetAddress, string assetId, decimal quantity, string price, SellTypeEnum sellType, Option<DateTime?> startTime = default, Option<DateTime?> endTime = default, Option<CurrencyEnum?> currency = default, Option<bool?> sponsor = default, Option<string> policyId = default, Option<long?> chainId = default, Option<OperationProcessingEnum?> operationProcessing = default, Option<AuthProviderEnum?> authProvider = default)
        {
    ...
    public class PlayerSellAssetRequestInputJsonConverter : JsonConverter<PlayerSellAssetRequestInput>
    {
        ...
        public override PlayerSellAssetRequestInput Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new PlayerSellAssetRequestInput(assetAddress.Value, assetId.Value, quantity.Value.Value, price.Value, sellType.Value.Value, startTime, endTime, currency, sponsor, policyId, chainId, operationProcessing, authProvider);
        }
        ...
        public override void Write(Utf8JsonWriter writer, PlayerSellAssetRequestInput playerSellAssetRequestInput, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, playerSellAssetRequestInput, jsonSerializerOptions);
        ...
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, PlayerSellAssetRequestInput playerSellAssetRequestInput, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var currencyRawValue = PlayerSellAssetRequestInput.CurrencyEnumToJsonValue(playerSellAssetRequestInput.CurrencyOption.Value);
            if (currencyRawValue != null)
            ...
            var operationProcessingRawValue = PlayerSellAssetRequestInput.OperationProcessingEnumToJsonValue(playerSellAssetRequestInput.OperationProcessingOption.Value);
            if (operationProcessingRawValue != null)
