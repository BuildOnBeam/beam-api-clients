...
namespace BeamPlayerClient.Model
{
    ...
    public partial class PlayerPlayerOperationResponseTransactionsInner : IValidatableObject
    {
        ...
        [JsonConstructor]
        public PlayerPlayerOperationResponseTransactionsInner(StatusEnum status, string id, bool sponsored, string openfortId = default, string actionId = default, Option<string> hash = default, TypeEnum? type = default, string externalId = default, string signature = default, string transactionHash = default, string operationId = default, Option<Object> data = default)
        {
            Status = status;
            Id = id;
            Sponsored = sponsored;
    ...
    public class PlayerPlayerOperationResponseTransactionsInnerJsonConverter : JsonConverter<PlayerPlayerOperationResponseTransactionsInner>
    {
        ...
        public override PlayerPlayerOperationResponseTransactionsInner Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new PlayerPlayerOperationResponseTransactionsInner(status.Value.Value, id.Value, sponsored.Value.Value, openfortId.Value, actionId.Value, hash, type.Value, externalId.Value, signature.Value, transactionHash.Value, operationId.Value, data);
        }
        ...
        public override void Write(Utf8JsonWriter writer, PlayerPlayerOperationResponseTransactionsInner playerPlayerOperationResponseTransactionsInner, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, playerPlayerOperationResponseTransactionsInner, jsonSerializerOptions);
        ...
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, PlayerPlayerOperationResponseTransactionsInner playerPlayerOperationResponseTransactionsInner, JsonSerializerOptions jsonSerializerOptions)
        {
