...
namespace BeamPlayerClient.Model
{
    ...
    public partial class PlayerGetAssetsForContractResponseDataInner : IValidatableObject
    {
        ...
        [JsonConstructor]
        public PlayerGetAssetsForContractResponseDataInner(string name, string imageUrl, string assetType, string assetAddress, string assetId, decimal supply, Option<RarityEnum?> rarity = default, Option<decimal?> rarityScore = default, Option<DateTime?> updatedAt = default, Option<DateTime?> mintedAt = default, Option<List<PlayerGetAssetsForUserResponseDataInnerAttributesInner>> attributes = default, Option<long?> chainId = default)
        {
            Name = name;
            ImageUrl = imageUrl;
            AssetType = assetType;
    ...
    public class PlayerGetAssetsForContractResponseDataInnerJsonConverter : JsonConverter<PlayerGetAssetsForContractResponseDataInner>
    {
        ...
        public override PlayerGetAssetsForContractResponseDataInner Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new PlayerGetAssetsForContractResponseDataInner(name.Value, imageUrl.Value, assetType.Value, assetAddress.Value, assetId.Value, supply.Value.Value, rarity, rarityScore, updatedAt, mintedAt, attributes, chainId);
        }
        ...
        public override void Write(Utf8JsonWriter writer, PlayerGetAssetsForContractResponseDataInner playerGetAssetsForContractResponseDataInner, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, playerGetAssetsForContractResponseDataInner, jsonSerializerOptions);
        ...
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, PlayerGetAssetsForContractResponseDataInner playerGetAssetsForContractResponseDataInner, JsonSerializerOptions jsonSerializerOptions)
        {
