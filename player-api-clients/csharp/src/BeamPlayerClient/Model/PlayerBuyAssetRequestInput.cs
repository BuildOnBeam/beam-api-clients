...
namespace BeamPlayerClient.Model
{
    ...
    public partial class PlayerBuyAssetRequestInput : IValidatableObject
    {
        ...
        [JsonConstructor]
        public PlayerBuyAssetRequestInput(decimal quantity, Option<AuthProviderEnum?> authProvider = default, Option<long?> chainId = default, Option<OperationProcessingEnum?> operationProcessing = default, Option<bool?> optimistic = default, Option<string?> policyId = default, Option<bool?> sponsor = default)
        {
            Quantity = quantity;
    ...
    public class PlayerBuyAssetRequestInputJsonConverter : JsonConverter<PlayerBuyAssetRequestInput>
    {
        ...
        public override PlayerBuyAssetRequestInput Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new PlayerBuyAssetRequestInput(quantity.Value!.Value!, authProvider, chainId, operationProcessing, optimistic, policyId, sponsor);
        }
