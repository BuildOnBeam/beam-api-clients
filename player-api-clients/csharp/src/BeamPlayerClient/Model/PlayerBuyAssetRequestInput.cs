...
namespace BeamPlayerClient.Model
{
    ...
    public partial class PlayerBuyAssetRequestInput : IValidatableObject
    {
        ...
        [JsonConstructor]
        public PlayerBuyAssetRequestInput(decimal quantity, Option<bool?> optimistic = default, Option<bool?> sponsor = default, Option<string> policyId = default, Option<long?> chainId = default, Option<OperationProcessingEnum?> operationProcessing = default, Option<AuthProviderEnum?> authProvider = default)
        {
            Quantity = quantity;
    ...
    public class PlayerBuyAssetRequestInputJsonConverter : JsonConverter<PlayerBuyAssetRequestInput>
    {
        ...
        public override PlayerBuyAssetRequestInput Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<PlayerBuyAssetRequestInput.AuthProviderEnum?> authProvider = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "authProvider":
                            ...
                            if (authProviderRawValue != null)
                                authProvider = new Option<PlayerBuyAssetRequestInput.AuthProviderEnum?>(PlayerBuyAssetRequestInput.AuthProviderEnumFromStringOrDefault(authProviderRawValue));
                            break;
                        default:
                            break;
                    }
            ...
            return new PlayerBuyAssetRequestInput(quantity.Value.Value, optimistic, sponsor, policyId, chainId, operationProcessing, authProvider);
        }
        ...
        public override void Write(Utf8JsonWriter writer, PlayerBuyAssetRequestInput playerBuyAssetRequestInput, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, playerBuyAssetRequestInput, jsonSerializerOptions);
        ...
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, PlayerBuyAssetRequestInput playerBuyAssetRequestInput, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var operationProcessingRawValue = PlayerBuyAssetRequestInput.OperationProcessingEnumToJsonValue(playerBuyAssetRequestInput.OperationProcessingOption.Value);
            if (operationProcessingRawValue != null)
                writer.WriteString("operationProcessing", operationProcessingRawValue);
            var authProviderRawValue = PlayerBuyAssetRequestInput.AuthProviderEnumToJsonValue(playerBuyAssetRequestInput.AuthProviderOption.Value.Value);
            if (authProviderRawValue != null)
