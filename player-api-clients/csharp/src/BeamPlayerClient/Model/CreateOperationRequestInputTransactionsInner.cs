...
namespace BeamPlayerClient.Model
{
    ...
    /// </summary>
    public partial class CreateOperationRequestInputTransactionsInner : IValidatableObject
    {
        /// <summary>
    ...
    /// <summary>
    /// A Json converter for type <see cref="CreateOperationRequestInputTransactionsInner" />
    /// </summary>
    public class CreateOperationRequestInputTransactionsInnerJsonConverter : JsonConverter<CreateOperationRequestInputTransactionsInner>
    {
        /// <summary>
        /// Deserializes json to <see cref="CreateOperationRequestInputTransactionsInner" />
        /// </summary>
        ...
        public override CreateOperationRequestInputTransactionsInner Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<CreateOperationRequestInputTransactionsInner.TypeEnum?> type = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "type":
                            ...
                            if (typeRawValue != null)
                                type = new Option<CreateOperationRequestInputTransactionsInner.TypeEnum?>(CreateOperationRequestInputTransactionsInner.TypeEnumFromStringOrDefault(typeRawValue));
                            break;
                        case "data":
        ...
        /// <summary>
        /// Serializes a <see cref="CreateOperationRequestInputTransactionsInner" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="createOperationRequestInputTransactionsInner"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, CreateOperationRequestInputTransactionsInner createOperationRequestInputTransactionsInner, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(ref writer, createOperationRequestInputTransactionsInner, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="CreateOperationRequestInputTransactionsInner" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="createOperationRequestInputTransactionsInner"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(ref Utf8JsonWriter writer, CreateOperationRequestInputTransactionsInner createOperationRequestInputTransactionsInner, JsonSerializerOptions jsonSerializerOptions)
        {
