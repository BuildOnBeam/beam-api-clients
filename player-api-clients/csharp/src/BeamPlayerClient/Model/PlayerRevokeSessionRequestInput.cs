...
namespace BeamPlayerClient.Model
{
    ...
    public partial class PlayerRevokeSessionRequestInput : IValidatableObject
    {
        ...
        [JsonConstructor]
        public PlayerRevokeSessionRequestInput(string address, Option<bool?> sponsor = default, Option<string> policyId = default, Option<long?> chainId = default, Option<OperationProcessingEnum?> operationProcessing = default, Option<AuthProviderEnum?> authProvider = default)
        {
            Address = address;
    ...
    public class PlayerRevokeSessionRequestInputJsonConverter : JsonConverter<PlayerRevokeSessionRequestInput>
    {
        ...
        public override PlayerRevokeSessionRequestInput Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<PlayerRevokeSessionRequestInput.AuthProviderEnum?> authProvider = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "authProvider":
                            ...
                            if (authProviderRawValue != null)
                                authProvider = new Option<PlayerRevokeSessionRequestInput.AuthProviderEnum?>(PlayerRevokeSessionRequestInput.AuthProviderEnumFromStringOrDefault(authProviderRawValue));
                            break;
                        default:
                            break;
                    }
            ...
            return new PlayerRevokeSessionRequestInput(address.Value, sponsor, policyId, chainId, operationProcessing, authProvider);
        }
        ...
        public override void Write(Utf8JsonWriter writer, PlayerRevokeSessionRequestInput playerRevokeSessionRequestInput, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, playerRevokeSessionRequestInput, jsonSerializerOptions);
        ...
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, PlayerRevokeSessionRequestInput playerRevokeSessionRequestInput, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var operationProcessingRawValue = PlayerRevokeSessionRequestInput.OperationProcessingEnumToJsonValue(playerRevokeSessionRequestInput.OperationProcessingOption.Value);
            if (operationProcessingRawValue != null)
                writer.WriteString("operationProcessing", operationProcessingRawValue);
            var authProviderRawValue = PlayerRevokeSessionRequestInput.AuthProviderEnumToJsonValue(playerRevokeSessionRequestInput.AuthProviderOption.Value.Value);
            if (authProviderRawValue != null)
