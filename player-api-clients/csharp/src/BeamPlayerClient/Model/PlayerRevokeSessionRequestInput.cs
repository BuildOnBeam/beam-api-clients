...
namespace BeamPlayerClient.Model
{
    ...
    public partial class PlayerRevokeSessionRequestInput : IValidatableObject
    {
        ...
        [JsonConstructor]
        public PlayerRevokeSessionRequestInput(string address, Option<AuthProviderEnum?> authProvider = default, Option<long?> chainId = default, Option<OperationProcessingEnum?> operationProcessing = default, Option<string?> policyId = default, Option<bool?> sponsor = default)
        {
            Address = address;
    ...
    public class PlayerRevokeSessionRequestInputJsonConverter : JsonConverter<PlayerRevokeSessionRequestInput>
    {
        ...
        public override PlayerRevokeSessionRequestInput Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new PlayerRevokeSessionRequestInput(address.Value!, authProvider, chainId, operationProcessing, policyId, sponsor);
        }
