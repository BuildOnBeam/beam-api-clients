...
{
    /// <summary>
    /// PlayerGetAssetsForUserResponseDataInner
    /// </summary>
    public partial class PlayerGetAssetsForUserResponseDataInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PlayerGetAssetsForUserResponseDataInner" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public PlayerGetAssetsForUserResponseDataInner(string name, string imageUrl, string assetType, string assetAddress, string assetId, decimal supply, decimal ownedQuantity, Option<RarityEnum?> rarity = default, Option<decimal?> rarityScore = default, Option<DateTime?> updatedAt = default, Option<DateTime?> mintedAt = default, Option<List<PlayerGetAssetsForUserResponseDataInnerAttributesInner>> attributes = default, Option<long?> chainId = default)
        {
            Name = name;
            ImageUrl = imageUrl;
            AssetType = assetType;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PlayerGetAssetsForUserResponseDataInner {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="PlayerGetAssetsForUserResponseDataInner" />
    /// </summary>
    public class PlayerGetAssetsForUserResponseDataInnerJsonConverter : JsonConverter<PlayerGetAssetsForUserResponseDataInner>
    {
        ...
        public override PlayerGetAssetsForUserResponseDataInner Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "rarity":
                            ...
                            if (rarityRawValue != null)
                                rarity = new Option<PlayerGetAssetsForUserResponseDataInner.RarityEnum?>(PlayerGetAssetsForUserResponseDataInner.RarityEnumFromStringOrDefault(rarityRawValue));
                            break;
                        case "rarityScore":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
            ...
            if (!name.IsSet)
                throw new ArgumentException("Property is required for class PlayerGetAssetsForUserResponseDataInner.", nameof(name));

            if (!imageUrl.IsSet)
                throw new ArgumentException("Property is required for class PlayerGetAssetsForUserResponseDataInner.", nameof(imageUrl));

            if (!assetType.IsSet)
                throw new ArgumentException("Property is required for class PlayerGetAssetsForUserResponseDataInner.", nameof(assetType));

            if (!assetAddress.IsSet)
                throw new ArgumentException("Property is required for class PlayerGetAssetsForUserResponseDataInner.", nameof(assetAddress));

            if (!assetId.IsSet)
                throw new ArgumentException("Property is required for class PlayerGetAssetsForUserResponseDataInner.", nameof(assetId));

            if (!supply.IsSet)
                throw new ArgumentException("Property is required for class PlayerGetAssetsForUserResponseDataInner.", nameof(supply));

            if (!ownedQuantity.IsSet)
                throw new ArgumentException("Property is required for class PlayerGetAssetsForUserResponseDataInner.", nameof(ownedQuantity));

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class PlayerGetAssetsForUserResponseDataInner.");

            if (imageUrl.IsSet && imageUrl.Value == null)
                throw new ArgumentNullException(nameof(imageUrl), "Property is not nullable for class PlayerGetAssetsForUserResponseDataInner.");

            if (assetType.IsSet && assetType.Value == null)
                throw new ArgumentNullException(nameof(assetType), "Property is not nullable for class PlayerGetAssetsForUserResponseDataInner.");

            if (assetAddress.IsSet && assetAddress.Value == null)
                throw new ArgumentNullException(nameof(assetAddress), "Property is not nullable for class PlayerGetAssetsForUserResponseDataInner.");

            if (assetId.IsSet && assetId.Value == null)
                throw new ArgumentNullException(nameof(assetId), "Property is not nullable for class PlayerGetAssetsForUserResponseDataInner.");

            if (supply.IsSet && supply.Value == null)
                throw new ArgumentNullException(nameof(supply), "Property is not nullable for class PlayerGetAssetsForUserResponseDataInner.");

            if (ownedQuantity.IsSet && ownedQuantity.Value == null)
                throw new ArgumentNullException(nameof(ownedQuantity), "Property is not nullable for class PlayerGetAssetsForUserResponseDataInner.");
            ...
            return new PlayerGetAssetsForUserResponseDataInner(name.Value, imageUrl.Value, assetType.Value, assetAddress.Value, assetId.Value, supply.Value.Value, ownedQuantity.Value.Value, rarity, rarityScore, updatedAt, mintedAt, attributes, chainId);
        }

        /// <summary>
        /// Serializes a <see cref="PlayerGetAssetsForUserResponseDataInner" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="playerGetAssetsForUserResponseDataInner"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, PlayerGetAssetsForUserResponseDataInner playerGetAssetsForUserResponseDataInner, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, playerGetAssetsForUserResponseDataInner, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="PlayerGetAssetsForUserResponseDataInner" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="playerGetAssetsForUserResponseDataInner"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, PlayerGetAssetsForUserResponseDataInner playerGetAssetsForUserResponseDataInner, JsonSerializerOptions jsonSerializerOptions)
        {
            if (playerGetAssetsForUserResponseDataInner.Name == null)
                throw new ArgumentNullException(nameof(playerGetAssetsForUserResponseDataInner.Name), "Property is required for class PlayerGetAssetsForUserResponseDataInner.");

            if (playerGetAssetsForUserResponseDataInner.ImageUrl == null)
                throw new ArgumentNullException(nameof(playerGetAssetsForUserResponseDataInner.ImageUrl), "Property is required for class PlayerGetAssetsForUserResponseDataInner.");

            if (playerGetAssetsForUserResponseDataInner.AssetType == null)
                throw new ArgumentNullException(nameof(playerGetAssetsForUserResponseDataInner.AssetType), "Property is required for class PlayerGetAssetsForUserResponseDataInner.");

            if (playerGetAssetsForUserResponseDataInner.AssetAddress == null)
                throw new ArgumentNullException(nameof(playerGetAssetsForUserResponseDataInner.AssetAddress), "Property is required for class PlayerGetAssetsForUserResponseDataInner.");

            if (playerGetAssetsForUserResponseDataInner.AssetId == null)
                throw new ArgumentNullException(nameof(playerGetAssetsForUserResponseDataInner.AssetId), "Property is required for class PlayerGetAssetsForUserResponseDataInner.");

            writer.WriteString("name", playerGetAssetsForUserResponseDataInner.Name);

            writer.WriteString("imageUrl", playerGetAssetsForUserResponseDataInner.ImageUrl);

            writer.WriteString("assetType", playerGetAssetsForUserResponseDataInner.AssetType);

            writer.WriteString("assetAddress", playerGetAssetsForUserResponseDataInner.AssetAddress);

            writer.WriteString("assetId", playerGetAssetsForUserResponseDataInner.AssetId);

            writer.WriteNumber("supply", playerGetAssetsForUserResponseDataInner.Supply);

            writer.WriteNumber("ownedQuantity", playerGetAssetsForUserResponseDataInner.OwnedQuantity);
            ...
            if (playerGetAssetsForUserResponseDataInner.RarityScoreOption.IsSet)
            {
                if (playerGetAssetsForUserResponseDataInner.RarityScoreOption.Value != null)
                {
            ...
            if (playerGetAssetsForUserResponseDataInner.AttributesOption.IsSet)
                if (playerGetAssetsForUserResponseDataInner.AttributesOption.Value != null)
                {
                    writer.WritePropertyName("attributes");
                    JsonSerializer.Serialize(writer, playerGetAssetsForUserResponseDataInner.Attributes, jsonSerializerOptions);
                }
                else
