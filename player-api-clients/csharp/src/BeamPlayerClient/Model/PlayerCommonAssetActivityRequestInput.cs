...
namespace BeamPlayerClient.Model
{
    ...
    public partial class PlayerCommonAssetActivityRequestInput : IValidatableObject
    {
        ...
        [JsonConstructor]
        public PlayerCommonAssetActivityRequestInput(Option<decimal?> chainId = default, Option<decimal?> limit = default, Option<List<PlayerCommonAssetActivityRequestInput.TypesEnum>?> types = default)
        {
    ...
    public class PlayerCommonAssetActivityRequestInputJsonConverter : JsonConverter<PlayerCommonAssetActivityRequestInput>
    {
        ...
        public override PlayerCommonAssetActivityRequestInput Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new PlayerCommonAssetActivityRequestInput(chainId, limit, types);
        }
