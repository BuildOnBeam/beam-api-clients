...
namespace BeamPlayerClient.Model
{
    ...
    public partial class PlayerBeamErrorResponse : IValidatableObject
    {
        ...
        [JsonConstructor]
        public PlayerBeamErrorResponse(string path, int status, DateTime timestamp, Option<string?> error = default, Option<string?> message = default, Option<string?> traceId = default, Option<string?> type = default, Option<List<Object>?> validation = default)
        {
            Path = path;
            Status = status;
            Timestamp = timestamp;
    ...
    public class PlayerBeamErrorResponseJsonConverter : JsonConverter<PlayerBeamErrorResponse>
    {
        ...
        public override PlayerBeamErrorResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new PlayerBeamErrorResponse(path.Value!, status.Value!.Value!, timestamp.Value!.Value!, error, message, traceId, type, validation);
        }
        ...
        public override void Write(Utf8JsonWriter writer, PlayerBeamErrorResponse playerBeamErrorResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(ref writer, playerBeamErrorResponse, jsonSerializerOptions);
        ...
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(ref Utf8JsonWriter writer, PlayerBeamErrorResponse playerBeamErrorResponse, JsonSerializerOptions jsonSerializerOptions)
        {
