...
namespace BeamPlayerClient.Model
{
    ...
    public partial class PlayerCancelAssetOfferRequestInput : IValidatableObject
    {
        ...
        [JsonConstructor]
        public PlayerCancelAssetOfferRequestInput(Option<bool?> optimistic = default, Option<bool?> sponsor = default, Option<string> policyId = default, Option<OperationProcessingEnum?> operationProcessing = default, Option<AuthProviderEnum?> authProvider = default, Option<long?> chainId = default)
        {
    ...
    public class PlayerCancelAssetOfferRequestInputJsonConverter : JsonConverter<PlayerCancelAssetOfferRequestInput>
    {
        ...
        public override PlayerCancelAssetOfferRequestInput Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new PlayerCancelAssetOfferRequestInput(optimistic, sponsor, policyId, operationProcessing, authProvider, chainId);
        }
        ...
        public override void Write(Utf8JsonWriter writer, PlayerCancelAssetOfferRequestInput playerCancelAssetOfferRequestInput, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, playerCancelAssetOfferRequestInput, jsonSerializerOptions);
        ...
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, PlayerCancelAssetOfferRequestInput playerCancelAssetOfferRequestInput, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var operationProcessingRawValue = PlayerCancelAssetOfferRequestInput.OperationProcessingEnumToJsonValue(playerCancelAssetOfferRequestInput.OperationProcessingOption.Value);
            if (operationProcessingRawValue != null)
