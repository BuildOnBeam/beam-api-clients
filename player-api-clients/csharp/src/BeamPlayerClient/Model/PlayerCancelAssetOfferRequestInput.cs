...
namespace BeamPlayerClient.Model
{
    ...
    public partial class PlayerCancelAssetOfferRequestInput : IValidatableObject
    {
        ...
        [JsonConstructor]
        public PlayerCancelAssetOfferRequestInput(Option<decimal?> chainId = default, Option<string?> operationId = default, Option<OperationProcessingEnum?> operationProcessing = default, Option<bool?> optimistic = default, Option<string?> policyId = default, Option<bool?> sponsor = default)
        {
    ...
    public class PlayerCancelAssetOfferRequestInputJsonConverter : JsonConverter<PlayerCancelAssetOfferRequestInput>
    {
        ...
        public override PlayerCancelAssetOfferRequestInput Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new PlayerCancelAssetOfferRequestInput(chainId, operationId, operationProcessing, optimistic, policyId, sponsor);
        }
        ...
        public void WriteProperties(ref Utf8JsonWriter writer, PlayerCancelAssetOfferRequestInput playerCancelAssetOfferRequestInput, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (playerCancelAssetOfferRequestInput.OperationIdOption.IsSet)
                if (playerCancelAssetOfferRequestInput.OperationIdOption.Value != null)
                    writer.WriteString("operationId", playerCancelAssetOfferRequestInput.OperationId);
                else
