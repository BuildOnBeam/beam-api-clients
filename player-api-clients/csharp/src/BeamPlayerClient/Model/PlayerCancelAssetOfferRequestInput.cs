...
namespace BeamPlayerClient.Model
{
    ...
    /// </summary>
    public partial class PlayerCancelAssetOfferRequestInput : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PlayerCancelAssetOfferRequestInput" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public PlayerCancelAssetOfferRequestInput(Option<AuthProviderEnum?> authProvider = default, Option<long?> chainId = default, Option<OperationProcessingEnum?> operationProcessing = default, Option<bool?> optimistic = default, Option<string?> policyId = default, Option<bool?> sponsor = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PlayerCancelAssetOfferRequestInput {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="PlayerCancelAssetOfferRequestInput" />
    /// </summary>
    public class PlayerCancelAssetOfferRequestInputJsonConverter : JsonConverter<PlayerCancelAssetOfferRequestInput>
    {
        /// <summary>
        /// Deserializes json to <see cref="PlayerCancelAssetOfferRequestInput" />
        /// </summary>
        ...
        public override PlayerCancelAssetOfferRequestInput Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<PlayerCancelAssetOfferRequestInput.AuthProviderEnum?> authProvider = default;
            Option<long?> chainId = default;
            Option<PlayerCancelAssetOfferRequestInput.OperationProcessingEnum?> operationProcessing = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "authProvider":
                            ...
                            if (authProviderRawValue != null)
                                authProvider = new Option<PlayerCancelAssetOfferRequestInput.AuthProviderEnum?>(PlayerCancelAssetOfferRequestInput.AuthProviderEnumFromStringOrDefault(authProviderRawValue));
                            break;
                        case "chainId":
                        ...
                        case "operationProcessing":
                            ...
                            if (operationProcessingRawValue != null)
                                operationProcessing = new Option<PlayerCancelAssetOfferRequestInput.OperationProcessingEnum?>(PlayerCancelAssetOfferRequestInput.OperationProcessingEnumFromStringOrDefault(operationProcessingRawValue));
                            break;
                        case "optimistic":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
            ...
            if (chainId.IsSet && chainId.Value == null)
                throw new ArgumentNullException(nameof(chainId), "Property is not nullable for class PlayerCancelAssetOfferRequestInput.");

            if (operationProcessing.IsSet && operationProcessing.Value == null)
                throw new ArgumentNullException(nameof(operationProcessing), "Property is not nullable for class PlayerCancelAssetOfferRequestInput.");

            if (optimistic.IsSet && optimistic.Value == null)
                throw new ArgumentNullException(nameof(optimistic), "Property is not nullable for class PlayerCancelAssetOfferRequestInput.");

            if (sponsor.IsSet && sponsor.Value == null)
                throw new ArgumentNullException(nameof(sponsor), "Property is not nullable for class PlayerCancelAssetOfferRequestInput.");

            return new PlayerCancelAssetOfferRequestInput(authProvider, chainId, operationProcessing, optimistic, policyId, sponsor);
        }

        /// <summary>
        /// Serializes a <see cref="PlayerCancelAssetOfferRequestInput" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="playerCancelAssetOfferRequestInput"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, PlayerCancelAssetOfferRequestInput playerCancelAssetOfferRequestInput, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(ref writer, playerCancelAssetOfferRequestInput, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="PlayerCancelAssetOfferRequestInput" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="playerCancelAssetOfferRequestInput"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(ref Utf8JsonWriter writer, PlayerCancelAssetOfferRequestInput playerCancelAssetOfferRequestInput, JsonSerializerOptions jsonSerializerOptions)
        {
            var authProviderRawValue = PlayerCancelAssetOfferRequestInput.AuthProviderEnumToJsonValue(playerCancelAssetOfferRequestInput.AuthProviderOption.Value!.Value);
            if (authProviderRawValue != null)
                writer.WriteString("authProvider", authProviderRawValue);
            else
                writer.WriteNull("authProvider");

            if (playerCancelAssetOfferRequestInput.ChainIdOption.IsSet)
                writer.WriteNumber("chainId", playerCancelAssetOfferRequestInput.ChainIdOption.Value!.Value);

            var operationProcessingRawValue = PlayerCancelAssetOfferRequestInput.OperationProcessingEnumToJsonValue(playerCancelAssetOfferRequestInput.OperationProcessingOption.Value!.Value);
            writer.WriteString("operationProcessing", operationProcessingRawValue);
            if (playerCancelAssetOfferRequestInput.OptimisticOption.IsSet)
                writer.WriteBoolean("optimistic", playerCancelAssetOfferRequestInput.OptimisticOption.Value!.Value);

            if (playerCancelAssetOfferRequestInput.PolicyIdOption.IsSet)
                if (playerCancelAssetOfferRequestInput.PolicyIdOption.Value != null)
                    writer.WriteString("policyId", playerCancelAssetOfferRequestInput.PolicyId);
                else
                    writer.WriteNull("policyId");

            if (playerCancelAssetOfferRequestInput.SponsorOption.IsSet)
                writer.WriteBoolean("sponsor", playerCancelAssetOfferRequestInput.SponsorOption.Value!.Value);
        }
    }
}