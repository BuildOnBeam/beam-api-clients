...
namespace BeamPlayerClient.Model
{
    ...
    /// GetOwnersResponse
    /// </summary>
    public partial class GetOwnersResponse : IValidatableObject
    {
        /// <summary>
    ...
    /// <summary>
    /// A Json converter for type <see cref="GetOwnersResponse" />
    /// </summary>
    public class GetOwnersResponseJsonConverter : JsonConverter<GetOwnersResponse>
    {
        /// <summary>
        /// Deserializes json to <see cref="GetOwnersResponse" />
        /// </summary>
        ...
        public override GetOwnersResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
        ...
        /// <summary>
        /// Serializes a <see cref="GetOwnersResponse" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getOwnersResponse"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GetOwnersResponse getOwnersResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(ref writer, getOwnersResponse, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GetOwnersResponse" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getOwnersResponse"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(ref Utf8JsonWriter writer, GetOwnersResponse getOwnersResponse, JsonSerializerOptions jsonSerializerOptions)
        {
