...
namespace BeamPlayerClient.Model
{
    ...
    /// </summary>
    public partial class GetOwnerAssetsBodyInput : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public GetOwnerAssetsBodyInput(Option<decimal?> chainId = default, Option<string?> continuation = default, Option<bool?> includeAttributes = default, Option<decimal?> limit = default, Option<SortByEnum?> sortBy = default, Option<SortDirectionEnum?> sortDirection = default)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="GetOwnerAssetsBodyInput" />
    /// </summary>
    public class GetOwnerAssetsBodyInputJsonConverter : JsonConverter<GetOwnerAssetsBodyInput>
    {
        /// <summary>
        /// Deserializes json to <see cref="GetOwnerAssetsBodyInput" />
        /// </summary>
        ...
        public override GetOwnerAssetsBodyInput Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<GetOwnerAssetsBodyInput.SortByEnum?> sortBy = default;
            Option<GetOwnerAssetsBodyInput.SortDirectionEnum?> sortDirection = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "sortBy":
                            ...
                            if (sortByRawValue != null)
                                sortBy = new Option<GetOwnerAssetsBodyInput.SortByEnum?>(GetOwnerAssetsBodyInput.SortByEnumFromStringOrDefault(sortByRawValue));
                            break;
                        case "sortDirection":
                            string? sortDirectionRawValue = utf8JsonReader.GetString();
                            if (sortDirectionRawValue != null)
                                sortDirection = new Option<GetOwnerAssetsBodyInput.SortDirectionEnum?>(GetOwnerAssetsBodyInput.SortDirectionEnumFromStringOrDefault(sortDirectionRawValue));
                            break;
                        default:
                            break;
                    }
            ...
            if (chainId.IsSet && chainId.Value == null)
                throw new ArgumentNullException(nameof(chainId), "Property is not nullable for class GetOwnerAssetsBodyInput.");

            if (limit.IsSet && limit.Value == null)
                throw new ArgumentNullException(nameof(limit), "Property is not nullable for class GetOwnerAssetsBodyInput.");

            if (sortBy.IsSet && sortBy.Value == null)
                throw new ArgumentNullException(nameof(sortBy), "Property is not nullable for class GetOwnerAssetsBodyInput.");

            if (sortDirection.IsSet && sortDirection.Value == null)
                throw new ArgumentNullException(nameof(sortDirection), "Property is not nullable for class GetOwnerAssetsBodyInput.");

            return new GetOwnerAssetsBodyInput(chainId, continuation, includeAttributes, limit, sortBy, sortDirection);
        }

        /// <summary>
        /// Serializes a <see cref="GetOwnerAssetsBodyInput" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getOwnerAssetsBodyInput"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GetOwnerAssetsBodyInput getOwnerAssetsBodyInput, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(ref writer, getOwnerAssetsBodyInput, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GetOwnerAssetsBodyInput" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getOwnerAssetsBodyInput"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(ref Utf8JsonWriter writer, GetOwnerAssetsBodyInput getOwnerAssetsBodyInput, JsonSerializerOptions jsonSerializerOptions)
        {
            if (getOwnerAssetsBodyInput.ChainIdOption.IsSet)
                writer.WriteNumber("chainId", getOwnerAssetsBodyInput.ChainIdOption.Value!.Value);

            if (getOwnerAssetsBodyInput.ContinuationOption.IsSet)
                if (getOwnerAssetsBodyInput.ContinuationOption.Value != null)
                    writer.WriteString("continuation", getOwnerAssetsBodyInput.Continuation);
                else
                    writer.WriteNull("continuation");

            if (getOwnerAssetsBodyInput.IncludeAttributesOption.IsSet)
                if (getOwnerAssetsBodyInput.IncludeAttributesOption.Value != null)
                    writer.WriteBoolean("includeAttributes", getOwnerAssetsBodyInput.IncludeAttributesOption.Value!.Value);
                else
                    writer.WriteNull("includeAttributes");

            if (getOwnerAssetsBodyInput.LimitOption.IsSet)
                writer.WriteNumber("limit", getOwnerAssetsBodyInput.LimitOption.Value!.Value);

            var sortByRawValue = GetOwnerAssetsBodyInput.SortByEnumToJsonValue(getOwnerAssetsBodyInput.SortByOption.Value!.Value);
            writer.WriteString("sortBy", sortByRawValue);
            var sortDirectionRawValue = GetOwnerAssetsBodyInput.SortDirectionEnumToJsonValue(getOwnerAssetsBodyInput.SortDirectionOption.Value!.Value);
