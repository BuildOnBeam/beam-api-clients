...
{
    /// <summary>
    /// PlayerCreateOperationRequestInputActionsInnerAllOfOneOf2
    /// </summary>
    public partial class PlayerCreateOperationRequestInputActionsInnerAllOfOneOf2 : IValidatableObject
    {
        /// <summary>
    ...
    /// <summary>
    /// A Json converter for type <see cref="PlayerCreateOperationRequestInputActionsInnerAllOfOneOf2" />
    /// </summary>
    public class PlayerCreateOperationRequestInputActionsInnerAllOfOneOf2JsonConverter : JsonConverter<PlayerCreateOperationRequestInputActionsInnerAllOfOneOf2>
    {
        /// <summary>
        /// Deserializes json to <see cref="PlayerCreateOperationRequestInputActionsInnerAllOfOneOf2" />
        /// </summary>
        ...
        public override PlayerCreateOperationRequestInputActionsInnerAllOfOneOf2 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "type":
                            ...
                            if (typeRawValue != null)
                                type = new Option<PlayerCreateOperationRequestInputActionsInnerAllOfOneOf2.TypeEnum?>(PlayerCreateOperationRequestInputActionsInnerAllOfOneOf2.TypeEnumFromStringOrDefault(typeRawValue));
                            break;
                        default:
                            break;
                    }
        ...
        /// <summary>
        /// Serializes a <see cref="PlayerCreateOperationRequestInputActionsInnerAllOfOneOf2" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="playerCreateOperationRequestInputActionsInnerAllOfOneOf2"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, PlayerCreateOperationRequestInputActionsInnerAllOfOneOf2 playerCreateOperationRequestInputActionsInnerAllOfOneOf2, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(ref writer, playerCreateOperationRequestInputActionsInnerAllOfOneOf2, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="PlayerCreateOperationRequestInputActionsInnerAllOfOneOf2" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="playerCreateOperationRequestInputActionsInnerAllOfOneOf2"></param>
        /// <param name="jsonSerializerOptions"></param>
