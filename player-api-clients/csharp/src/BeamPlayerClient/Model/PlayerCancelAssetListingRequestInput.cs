...
namespace BeamPlayerClient.Model
{
    ...
    public partial class PlayerCancelAssetListingRequestInput : IValidatableObject
    {
        ...
        [JsonConstructor]
        public PlayerCancelAssetListingRequestInput(Option<bool?> optimistic = default, Option<bool?> sponsor = default, Option<string> policyId = default, Option<OperationProcessingEnum?> operationProcessing = default, Option<AuthProviderEnum?> authProvider = default)
        {
    ...
    public class PlayerCancelAssetListingRequestInputJsonConverter : JsonConverter<PlayerCancelAssetListingRequestInput>
    {
        ...
        public override PlayerCancelAssetListingRequestInput Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<PlayerCancelAssetListingRequestInput.AuthProviderEnum?> authProvider = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "authProvider":
                            ...
                            if (authProviderRawValue != null)
                                authProvider = new Option<PlayerCancelAssetListingRequestInput.AuthProviderEnum?>(PlayerCancelAssetListingRequestInput.AuthProviderEnumFromStringOrDefault(authProviderRawValue));
                            break;
                        default:
                            break;
                    }
            ...
            return new PlayerCancelAssetListingRequestInput(optimistic, sponsor, policyId, operationProcessing, authProvider);
        }
        ...
        public override void Write(Utf8JsonWriter writer, PlayerCancelAssetListingRequestInput playerCancelAssetListingRequestInput, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, playerCancelAssetListingRequestInput, jsonSerializerOptions);
        ...
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, PlayerCancelAssetListingRequestInput playerCancelAssetListingRequestInput, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var operationProcessingRawValue = PlayerCancelAssetListingRequestInput.OperationProcessingEnumToJsonValue(playerCancelAssetListingRequestInput.OperationProcessingOption.Value);
            if (operationProcessingRawValue != null)
                writer.WriteString("operationProcessing", operationProcessingRawValue);
            var authProviderRawValue = PlayerCancelAssetListingRequestInput.AuthProviderEnumToJsonValue(playerCancelAssetListingRequestInput.AuthProviderOption.Value.Value);
            if (authProviderRawValue != null)
