...
namespace BeamPlayerClient.Model
{
    ...
    public partial class PlayerGetQuoteResponse : IValidatableObject
    {
        ...
        [JsonConstructor]
        public PlayerGetQuoteResponse(string amountIn, string amountOut, string tokenIn, string tokenOut)
        {
            AmountIn = amountIn;
            AmountOut = amountOut;
            TokenIn = tokenIn;
    ...
    public class PlayerGetQuoteResponseJsonConverter : JsonConverter<PlayerGetQuoteResponse>
    {
        ...
        public override PlayerGetQuoteResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new PlayerGetQuoteResponse(amountIn.Value!, amountOut.Value!, tokenIn.Value!, tokenOut.Value!);
        }
        ...
        public override void Write(Utf8JsonWriter writer, PlayerGetQuoteResponse playerGetQuoteResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(ref writer, playerGetQuoteResponse, jsonSerializerOptions);
        ...
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(ref Utf8JsonWriter writer, PlayerGetQuoteResponse playerGetQuoteResponse, JsonSerializerOptions jsonSerializerOptions)
        {
