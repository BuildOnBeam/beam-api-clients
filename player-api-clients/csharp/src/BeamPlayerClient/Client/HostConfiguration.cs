...
namespace BeamPlayerClient.Client
{
    ...
    public class PlayerHostConfiguration
    {
        ...
        public PlayerHostConfiguration(IServiceCollection services)
        {
            ...
            _jsonOptions.Converters.Add(new PlayerGetOnRampQuoteResponseJsonConverter());
            _jsonOptions.Converters.Add(new PlayerGetOnRampQuoteResponseQuoteJsonConverter());
            _jsonOptions.Converters.Add(new PlayerGetOnRampQuoteResponseQuoteInputJsonConverter());
            _jsonOptions.Converters.Add(new PlayerGetOnRampQuoteResponseQuoteOutputJsonConverter());
            ...
            _jsonOptions.Converters.Add(new PlayerOperationActionJsonConverter());
            ...
            _jsonOptions.Converters.Add(new PlayerTransferMultipleNativeTokensRequestInputJsonConverter());
            _jsonOptions.Converters.Add(new PlayerTransferMultipleNativeTokensRequestInputTransfersInnerJsonConverter());
