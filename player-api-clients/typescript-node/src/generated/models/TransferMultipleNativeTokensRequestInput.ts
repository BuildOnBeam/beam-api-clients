...
/* tslint:disable */
/* eslint-disable */
export type TransferMultipleNativeTokensRequestInput = {
  transfers: Array<{
   ...
   */
  operationProcessing?: TransferMultipleNativeTokensRequestInput.operationProcessing;
  /**
   ...
   */
  authProvider?: TransferMultipleNativeTokensRequestInput.authProvider | null;
};
export namespace TransferMultipleNativeTokensRequestInput {
  /**
   * Operation processing type. If Execute is used, Operation will be executed automatically right after User signs it. If you prefer to have more control, use SignOnly then Process it using ProcessOperation.
   */
