...
namespace BeamSelfCustody.Api
{
    ...
    /// </summary>
    public interface IGetQuoteForInputApiResponse : BeamSelfCustody.Client.IApiResponse, IOk<BeamSelfCustody.Model.GetQuoteResponse?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IGetQuoteForOutputApiResponse : BeamSelfCustody.Client.IApiResponse, IOk<BeamSelfCustody.Model.GetQuoteResponse?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    public sealed partial class ExchangeApi : IExchangeApi
    {
        ...
        public async Task<IConvertInputApiResponse> ConvertInputAsync(ConvertTokenRequestInput convertTokenRequestInput, string entityId, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    uriBuilderLocalVar.Path = ClientUtils.CONTEXT_PATH + "/v1/self-custody/exchange/users/{entityId}/convert/input";
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        ConvertInputApiResponse apiResponseLocalVar = new(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/v1/self-custody/exchange/users/{entityId}/convert/input", requestedAtLocalVar, _jsonSerializerOptions);
            ...
            {
                OnErrorConvertInputDefaultImplementation(e, "/v1/self-custody/exchange/users/{entityId}/convert/input", uriBuilderLocalVar.Path, convertTokenRequestInput, entityId);
        ...
        /// </summary>
        public partial class ConvertInputApiResponse : BeamSelfCustody.Client.ApiResponse, IConvertInputApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        public async Task<IConvertToOutputApiResponse> ConvertToOutputAsync(ConvertTokenRequestInput convertTokenRequestInput, string entityId, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    uriBuilderLocalVar.Port = HttpClient.BaseAddress.Port;
                    uriBuilderLocalVar.Scheme = HttpClient.BaseAddress.Scheme;
                    uriBuilderLocalVar.Path = ClientUtils.CONTEXT_PATH + "/v1/self-custody/exchange/users/{entityId}/convert/output";
                    uriBuilderLocalVar.Path = uriBuilderLocalVar.Path.Replace("%7BentityId%7D", Uri.EscapeDataString(entityId.ToString()));
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        ConvertToOutputApiResponse apiResponseLocalVar = new(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/v1/self-custody/exchange/users/{entityId}/convert/output", requestedAtLocalVar, _jsonSerializerOptions);
            ...
            {
                OnErrorConvertToOutputDefaultImplementation(e, "/v1/self-custody/exchange/users/{entityId}/convert/output", uriBuilderLocalVar.Path, convertTokenRequestInput, entityId);
        ...
        /// </summary>
        public partial class ConvertToOutputApiResponse : BeamSelfCustody.Client.ApiResponse, IConvertToOutputApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        public async Task<IGetQuoteForInputApiResponse> GetQuoteForInputAsync(string tokenIn, string tokenOut, string amountOut, Option<decimal> chainId = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    uriBuilderLocalVar.Port = HttpClient.BaseAddress.Port;
                    uriBuilderLocalVar.Scheme = HttpClient.BaseAddress.Scheme;
                    uriBuilderLocalVar.Path = ClientUtils.CONTEXT_PATH + "/v1/self-custody/exchange/quote/input";
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        GetQuoteForInputApiResponse apiResponseLocalVar = new(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/v1/self-custody/exchange/quote/input", requestedAtLocalVar, _jsonSerializerOptions);
            ...
            {
                OnErrorGetQuoteForInputDefaultImplementation(e, "/v1/self-custody/exchange/quote/input", uriBuilderLocalVar.Path, tokenIn, tokenOut, amountOut, chainId);
        ...
        /// </summary>
        public partial class GetQuoteForInputApiResponse : BeamSelfCustody.Client.ApiResponse, IGetQuoteForInputApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public BeamSelfCustody.Model.GetQuoteResponse? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<BeamSelfCustody.Model.GetQuoteResponse>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out BeamSelfCustody.Model.GetQuoteResponse? result)
            {
                result = null;
        ...
        public async Task<IGetQuoteForOutputApiResponse> GetQuoteForOutputAsync(string tokenIn, string tokenOut, string amountIn, Option<decimal> chainId = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    uriBuilderLocalVar.Port = HttpClient.BaseAddress.Port;
                    uriBuilderLocalVar.Scheme = HttpClient.BaseAddress.Scheme;
                    uriBuilderLocalVar.Path = ClientUtils.CONTEXT_PATH + "/v1/self-custody/exchange/quote/output";
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        GetQuoteForOutputApiResponse apiResponseLocalVar = new(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/v1/self-custody/exchange/quote/output", requestedAtLocalVar, _jsonSerializerOptions);
            ...
            {
                OnErrorGetQuoteForOutputDefaultImplementation(e, "/v1/self-custody/exchange/quote/output", uriBuilderLocalVar.Path, tokenIn, tokenOut, amountIn, chainId);
        ...
        /// </summary>
        public partial class GetQuoteForOutputApiResponse : BeamSelfCustody.Client.ApiResponse, IGetQuoteForOutputApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
