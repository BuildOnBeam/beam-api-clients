...
namespace BeamSelfCustody.Api
{
    ...
    /// </summary>
    public interface IGetTransactionApiResponse : BeamSelfCustody.Client.IApiResponse, IOk<BeamSelfCustody.Model.GetTransactionResponse?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IGetTransactionsApiResponse : BeamSelfCustody.Client.IApiResponse, IOk<BeamSelfCustody.Model.GetTransactionsResponse?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IGetUserTransactionsApiResponse : BeamSelfCustody.Client.IApiResponse, IOk<BeamSelfCustody.Model.GetTransactionsResponse?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    public sealed partial class TransactionsApi : ITransactionsApi
    {
        ...
        public async Task<ICreateUserTransactionApiResponse> CreateUserTransactionAsync(CreateTransactionRequestInput createTransactionRequestInput, string entityId, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    uriBuilderLocalVar.Path = ClientUtils.CONTEXT_PATH + "/v1/self-custody/transactions/users/{entityId}";
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        CreateUserTransactionApiResponse apiResponseLocalVar = new(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/v1/self-custody/transactions/users/{entityId}", requestedAtLocalVar, _jsonSerializerOptions);
            ...
            {
                OnErrorCreateUserTransactionDefaultImplementation(e, "/v1/self-custody/transactions/users/{entityId}", uriBuilderLocalVar.Path, createTransactionRequestInput, entityId);
        ...
        /// </summary>
        public partial class CreateUserTransactionApiResponse : BeamSelfCustody.Client.ApiResponse, ICreateUserTransactionApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        public async Task<IGetTransactionApiResponse> GetTransactionAsync(string transactionId, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    uriBuilderLocalVar.Port = HttpClient.BaseAddress.Port;
                    uriBuilderLocalVar.Scheme = HttpClient.BaseAddress.Scheme;
                    uriBuilderLocalVar.Path = ClientUtils.CONTEXT_PATH + "/v1/self-custody/transactions/{transactionId}";
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        GetTransactionApiResponse apiResponseLocalVar = new(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/v1/self-custody/transactions/{transactionId}", requestedAtLocalVar, _jsonSerializerOptions);
            ...
            {
                OnErrorGetTransactionDefaultImplementation(e, "/v1/self-custody/transactions/{transactionId}", uriBuilderLocalVar.Path, transactionId);
        ...
        /// </summary>
        public partial class GetTransactionApiResponse : BeamSelfCustody.Client.ApiResponse, IGetTransactionApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public BeamSelfCustody.Model.GetTransactionResponse? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<BeamSelfCustody.Model.GetTransactionResponse>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out BeamSelfCustody.Model.GetTransactionResponse? result)
            {
                result = null;
        ...
        public async Task<IGetTransactionsApiResponse> GetTransactionsAsync(Option<decimal> limit = default, Option<decimal> offset = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    uriBuilderLocalVar.Port = HttpClient.BaseAddress.Port;
                    uriBuilderLocalVar.Scheme = HttpClient.BaseAddress.Scheme;
                    uriBuilderLocalVar.Path = ClientUtils.CONTEXT_PATH + "/v1/self-custody/transactions";
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        GetTransactionsApiResponse apiResponseLocalVar = new(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/v1/self-custody/transactions", requestedAtLocalVar, _jsonSerializerOptions);
            ...
            {
                OnErrorGetTransactionsDefaultImplementation(e, "/v1/self-custody/transactions", uriBuilderLocalVar.Path, limit, offset);
        ...
        /// </summary>
        public partial class GetTransactionsApiResponse : BeamSelfCustody.Client.ApiResponse, IGetTransactionsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public BeamSelfCustody.Model.GetTransactionsResponse? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<BeamSelfCustody.Model.GetTransactionsResponse>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out BeamSelfCustody.Model.GetTransactionsResponse? result)
            {
                result = null;
        ...
        public async Task<IGetUserTransactionsApiResponse> GetUserTransactionsAsync(string entityId, Option<decimal> limit = default, Option<decimal> offset = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        GetUserTransactionsApiResponse apiResponseLocalVar = new(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/v1/self-custody/transactions/users/{entityId}", requestedAtLocalVar, _jsonSerializerOptions);
            ...
            {
                OnErrorGetUserTransactionsDefaultImplementation(e, "/v1/self-custody/transactions/users/{entityId}", uriBuilderLocalVar.Path, entityId, limit, offset);
        ...
        /// </summary>
        public partial class GetUserTransactionsApiResponse : BeamSelfCustody.Client.ApiResponse, IGetUserTransactionsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
