...
{
    /// <summary>
    /// GetAssetsForContractBodyInputV3
    /// </summary>
    public partial class GetAssetsForContractBodyInputV3 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAssetsForContractBodyInputV3" /> class.
        /// </summary>
        ...
        [JsonIgnore]
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<GetAssetsForContractBodyInputV3AttributesInner>?> AttributesOption { get; private set; }

        /// <summary>
        /// Gets or Sets Attributes
        /// </summary>
        [JsonPropertyName("attributes")]
        public List<GetAssetsForContractBodyInputV3AttributesInner>? Attributes { get { return this. AttributesOption; } set { this.AttributesOption = new(value); } }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetAssetsForContractBodyInputV3 {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="GetAssetsForContractBodyInputV3" />
    /// </summary>
    public class GetAssetsForContractBodyInputV3JsonConverter : JsonConverter<GetAssetsForContractBodyInputV3>
    {
        /// <summary>
        /// Deserializes json to <see cref="GetAssetsForContractBodyInputV3" />
        /// </summary>
        ...
        public override GetAssetsForContractBodyInputV3 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<GetAssetsForContractBodyInputV3AttributesInner>?> attributes = default;
            ...
            Option<GetAssetsForContractBodyInputV3.SortByEnum?> sortBy = default;
            Option<GetAssetsForContractBodyInputV3.SortDirectionEnum?> sortDirection = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "attributes":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                attributes = new Option<List<GetAssetsForContractBodyInputV3AttributesInner>?>(JsonSerializer.Deserialize<List<GetAssetsForContractBodyInputV3AttributesInner>>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "chainId":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                        ...
                        case "sortBy":
                            ...
                            if (sortByRawValue != null)
                                sortBy = new Option<GetAssetsForContractBodyInputV3.SortByEnum?>(GetAssetsForContractBodyInputV3.SortByEnumFromStringOrDefault(sortByRawValue));
                            break;
                        case "sortDirection":
                            string? sortDirectionRawValue = utf8JsonReader.GetString();
                            if (sortDirectionRawValue != null)
                                sortDirection = new Option<GetAssetsForContractBodyInputV3.SortDirectionEnum?>(GetAssetsForContractBodyInputV3.SortDirectionEnumFromStringOrDefault(sortDirectionRawValue));
                            break;
                        default:
                            break;
                    }
            ...
            if (chainId.IsSet && chainId.Value == null)
                throw new ArgumentNullException(nameof(chainId), "Property is not nullable for class GetAssetsForContractBodyInputV3.");

            if (limit.IsSet && limit.Value == null)
                throw new ArgumentNullException(nameof(limit), "Property is not nullable for class GetAssetsForContractBodyInputV3.");

            if (sortBy.IsSet && sortBy.Value == null)
                throw new ArgumentNullException(nameof(sortBy), "Property is not nullable for class GetAssetsForContractBodyInputV3.");

            if (sortDirection.IsSet && sortDirection.Value == null)
                throw new ArgumentNullException(nameof(sortDirection), "Property is not nullable for class GetAssetsForContractBodyInputV3.");

            return new GetAssetsForContractBodyInputV3(attributes, chainId, continuation, includeAttributes, limit, maxFloorAskPrice, maxRarityRank, minFloorAskPrice, minRarityRank, sortBy, sortDirection);
        }

        /// <summary>
        /// Serializes a <see cref="GetAssetsForContractBodyInputV3" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getAssetsForContractBodyInputV3"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GetAssetsForContractBodyInputV3 getAssetsForContractBodyInputV3, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(ref writer, getAssetsForContractBodyInputV3, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GetAssetsForContractBodyInputV3" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getAssetsForContractBodyInputV3"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(ref Utf8JsonWriter writer, GetAssetsForContractBodyInputV3 getAssetsForContractBodyInputV3, JsonSerializerOptions jsonSerializerOptions)
        {
            if (getAssetsForContractBodyInputV3.AttributesOption.IsSet)
                if (getAssetsForContractBodyInputV3.AttributesOption.Value != null)
                {
                    writer.WritePropertyName("attributes");
                    JsonSerializer.Serialize(writer, getAssetsForContractBodyInputV3.Attributes, jsonSerializerOptions);
                }
                else
                    writer.WriteNull("attributes");
            if (getAssetsForContractBodyInputV3.ChainIdOption.IsSet)
                writer.WriteNumber("chainId", getAssetsForContractBodyInputV3.ChainIdOption.Value!.Value);

            if (getAssetsForContractBodyInputV3.ContinuationOption.IsSet)
                if (getAssetsForContractBodyInputV3.ContinuationOption.Value != null)
                    writer.WriteString("continuation", getAssetsForContractBodyInputV3.Continuation);
                else
                    writer.WriteNull("continuation");

            if (getAssetsForContractBodyInputV3.IncludeAttributesOption.IsSet)
                if (getAssetsForContractBodyInputV3.IncludeAttributesOption.Value != null)
                    writer.WriteBoolean("includeAttributes", getAssetsForContractBodyInputV3.IncludeAttributesOption.Value!.Value);
                else
                    writer.WriteNull("includeAttributes");

            if (getAssetsForContractBodyInputV3.LimitOption.IsSet)
                writer.WriteNumber("limit", getAssetsForContractBodyInputV3.LimitOption.Value!.Value);

            if (getAssetsForContractBodyInputV3.MaxFloorAskPriceOption.IsSet)
                if (getAssetsForContractBodyInputV3.MaxFloorAskPriceOption.Value != null)
                    writer.WriteNumber("maxFloorAskPrice", getAssetsForContractBodyInputV3.MaxFloorAskPriceOption.Value!.Value);
                else
                    writer.WriteNull("maxFloorAskPrice");

            if (getAssetsForContractBodyInputV3.MaxRarityRankOption.IsSet)
                if (getAssetsForContractBodyInputV3.MaxRarityRankOption.Value != null)
                    writer.WriteNumber("maxRarityRank", getAssetsForContractBodyInputV3.MaxRarityRankOption.Value!.Value);
                else
                    writer.WriteNull("maxRarityRank");

            if (getAssetsForContractBodyInputV3.MinFloorAskPriceOption.IsSet)
                if (getAssetsForContractBodyInputV3.MinFloorAskPriceOption.Value != null)
                    writer.WriteNumber("minFloorAskPrice", getAssetsForContractBodyInputV3.MinFloorAskPriceOption.Value!.Value);
                else
                    writer.WriteNull("minFloorAskPrice");

            if (getAssetsForContractBodyInputV3.MinRarityRankOption.IsSet)
                if (getAssetsForContractBodyInputV3.MinRarityRankOption.Value != null)
                    writer.WriteNumber("minRarityRank", getAssetsForContractBodyInputV3.MinRarityRankOption.Value!.Value);
                else
                    writer.WriteNull("minRarityRank");

            var sortByRawValue = GetAssetsForContractBodyInputV3.SortByEnumToJsonValue(getAssetsForContractBodyInputV3.SortByOption.Value!.Value);
            writer.WriteString("sortBy", sortByRawValue);
            var sortDirectionRawValue = GetAssetsForContractBodyInputV3.SortDirectionEnumToJsonValue(getAssetsForContractBodyInputV3.SortDirectionOption.Value!.Value);
