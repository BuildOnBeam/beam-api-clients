...
[assembly: InternalsVisibleTo("BeamSelfCustody.Test")]
...
namespace BeamSelfCustody.Client
{
    ...
    public static class ClientUtils
    {
        ...
        public static string? ParameterToString(object obj, string? format = ISO8601_DATETIME_FORMAT)
        {
            ...
            if (obj is GetAssetResponseV3.RarityEnum getAssetResponseV3RarityEnum)
                return GetAssetResponseV3.RarityEnumToJsonValue(getAssetResponseV3RarityEnum);
            if (obj is GetAssetsForContractBodyInputV3.SortByEnum getAssetsForContractBodyInputV3SortByEnum)
                return GetAssetsForContractBodyInputV3.SortByEnumToJsonValue(getAssetsForContractBodyInputV3SortByEnum);
            if (obj is GetAssetsForContractBodyInputV3.SortDirectionEnum getAssetsForContractBodyInputV3SortDirectionEnum)
                return GetAssetsForContractBodyInputV3.SortDirectionEnumToJsonValue(getAssetsForContractBodyInputV3SortDirectionEnum);
            if (obj is GetAssetsForContractResponseV3DataInner.RarityEnum getAssetsForContractResponseV3DataInnerRarityEnum)
                return GetAssetsForContractResponseV3DataInner.RarityEnumToJsonValue(getAssetsForContractResponseV3DataInnerRarityEnum);
            if (obj is GetAssetsForProfileBodyInputV3.SortByEnum getAssetsForProfileBodyInputV3SortByEnum)
                return GetAssetsForProfileBodyInputV3.SortByEnumToJsonValue(getAssetsForProfileBodyInputV3SortByEnum);
            if (obj is GetAssetsForProfileBodyInputV3.SortDirectionEnum getAssetsForProfileBodyInputV3SortDirectionEnum)
                return GetAssetsForProfileBodyInputV3.SortDirectionEnumToJsonValue(getAssetsForProfileBodyInputV3SortDirectionEnum);
            if (obj is GetAssetsForProfileResponseV3DataInner.RarityEnum getAssetsForProfileResponseV3DataInnerRarityEnum)
                return GetAssetsForProfileResponseV3DataInner.RarityEnumToJsonValue(getAssetsForProfileResponseV3DataInnerRarityEnum);
